...
const JoinSelTemplate: Story<SvgInputModel> = (args) => <JoinSelSvg {...args} />;
const DitoLogoTemplate: Story<SvgInputModel> = (args) => <DitoLogoSvg {...args} />;
const LogoTemplate: Story<SvgInputModel> = (args) => <SwLogoSvg {...args} />;
const MainBackgroundTemplate: Story<SvgInputModel> = (args) => <MainBackgroundSvg {...args} />;
