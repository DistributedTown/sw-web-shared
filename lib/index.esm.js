...
import React__default, { useRef, useEffect, forwardRef, useImperativeHandle, Fragment as Fragment$1, useReducer, useCallback, useMemo, useState, Component } from 'react';
import Box from '@mui/material/Box';
import Container from '@mui/material/Container';
import { styled, createTheme, Drawer, IconButton, SvgIcon, Button, Avatar, Divider as Divider$1, Box as Box$1, Typography, useTheme, Slider, SliderThumb, LinearProgress, linearProgressClasses, Dialog, DialogContent } from '@mui/material';
...
var SwLayout = function (_a) {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        backgroundUrl && React__default.createElement("div", { className: "sw-background " + className, style: {
                display: "flex",
...
var SwSidebar = function (_a) {
    ...
    return (React__default.createElement(Drawer, { anchor: "left", sx: __assign$2(__assign$2({ width: !mobile ? width : '100%', transition: theme.transitions.create("width", {
        ...
        React__default.createElement("div", { className: "sw-sidebar-content " + mode }, children),
...
var SwMenuItems = function (_a) {
    ...
    return (React__default.createElement(List, { className: "sw-sidebar-menu" }, menuItems.map(function (item, id) {
        ...
        if (item.type === "href") {
            return (React__default.createElement(Tooltip, { key: id, title: !open ? item.label : "", placement: "right" },
                React__default.createElement(ListItem, { onClick: mobile ? handleToggle : function () { return null; }, activeClassName: "active-link", component: NavLink, disabled: item.disabled, to: item.href, replace: true, key: id },
...
var SwButton = function (_a) {
    ...
    return (React.createElement(CustomizedButton, __assign$2({}, rest, { variant: variant, color: color, className: "sw-button " + className }),
...
var SwUploadFile = function (_a) {
    ...
    return (React__default.createElement("div", __assign$2({}, getRootProps({ className: 'sw-uploader-wrapper', style: sx })),
        React__default.createElement(Avatar, { alt: "Avatar", src: preview, imgProps: {
            ...
            React__default.createElement(DefaultUploadSvg, null)),
...
var SwAnimatedRoute = function (_a) {
    ...
    return (React__default.createElement(Route, { exact: exact, key: to, path: to }, function (_a) {
        ...
        return (React__default.createElement(CSSTransition$1, { key: to, in: match != null, timeout: { enter: 800, exit: 400 }, classNames: "sw-animated-slide", unmountOnExit: true },
            React__default.createElement("div", { className: "sw-animated-page", style: __assign$2({ height: "100%" }, (sx || {})) },
                React__default.createElement(Component, __assign$2({}, rest)))));
    }));
};
...
var SwDivider = function (_a) {
    ...
    return (React.createElement(Divider$1, __assign$2({ className: "sw-divider", color: "white", sx: styles }, props)));
};
...
var SwQuote = function (_a) {
    ...
    return (React.createElement(Box$1, { className: "sw-box-quote " + className }, mobile ? (React.createElement(React.Fragment, null,
        ...
        React.createElement(Popover, { id: "mouse-over-popover", sx: {
            ...
            React.createElement(Quote, { showBorder: showBorder, children: children })))) : (React.createElement(Quote, { showBorder: showBorder, children: children }))));
};
var Quote = function (_a) {
    var children = _a.children, showBorder = _a.showBorder;
    var theme = useTheme();
    return (React.createElement("div", { className: "quote " + (showBorder ? 'show-border' : ''), style: { boxShadow: showBorder ? theme.shadows[1] : 'none' } },
...
var SwSlider = function (_a) {
    ...
    var _c = React.useState(rest.defaultValue), value = _c[0], setValue = _c[1];
    return (React.createElement(CustomizedSlider, __assign$2({}, rest, { onChange: function (_, v) { return setValue(v); }, components: { Thumb: SwThumbComponent(value) }, className: "sw-slider " + className + " mode-" + mode })));
};
...
var NoBorderLinearProgress = styled(LinearProgress)(function (_a) {
    ...
    return (_b = {
        ...
        _b["&." + linearProgressClasses.colorPrimary] = {
...
var SwProgressBar = function (_a) {
    ...
    return (React__default.createElement("div", { className: "sw-progress-bar" },
...
function SwClipboardCopy(_a) {
    ...
    return (React__default.createElement("div", { className: "copy-wrapper " + mode, onClick: handleCopyClick },
...
function SwShare(props) {
    ...
    return (React__default.createElement(Dialog, { onClose: handleClose, open: open },
        React__default.createElement(DialogContent, { sx: __assign$2({ width: '450px', height: '370px', display: 'flex', flexDirection: 'column', borderWidth: '2px', padding: '35px 30px', bgcolor: mode === 'light' ? 'background.paper' : 'primary.main', borderColor: mode === 'light' ? 'primary.main' : 'background.paper' }, (sx || {})) },
            ...
            React__default.createElement("div", { className: "links", style: {
                ...
                React__default.createElement(LinkedinShareButton$1, { url: url, className: "social-button" },
                    React__default.createElement(LinkedInIcon, { sx: {
                            width: '85px',
                            height: '85px',
                            color: mode === 'light' ? 'primary.main' : 'text.primary'
                        } })),
                React__default.createElement(TelegramShareButton$1, { url: url, className: "social-button" },
                    React__default.createElement(TelegramIcon, { sx: {
                            width: '85px',
                            height: '85px',
                            color: mode === 'light' ? 'primary.main' : 'text.primary'
                        } })),
                React__default.createElement(TwitterShareButton$1, { url: url, className: "social-button", title: title },
