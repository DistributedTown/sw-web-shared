...
var SwSidebar = function (_a) {
    ...
    return (React__default.createElement(Drawer, { anchor: "left", sx: __assign$2(__assign$2({ width: !mobile ? width : '100%', transition: theme.transitions.create("width", {
        ...
        React__default.createElement("div", { className: "sw-sidebar-content ".concat(mode) }, children),
...
var SwButton = function (_a) {
    ...
    return (React.createElement(CustomizedButton, __assign$2({}, rest, { variant: variant, color: color, className: "sw-button ".concat(className) }),
