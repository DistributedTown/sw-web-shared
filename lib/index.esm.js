...
var SwMainLayout = function (_a) {
    ...
    var _g = useState(collapsed), collapse = _g[0], onCollapse = _g[1];
    return (React.createElement(Layout, { className: "sw-main-layout" },
        React.createElement(Sider, { className: "sw-main-sidebar", collapsible: true, collapsed: collapse, onCollapse: function () { return onCollapse(!collapse); } },
