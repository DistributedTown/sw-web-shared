...
import React__default, { useRef, useDebugValue, useContext, createElement, forwardRef, useImperativeHandle, Fragment, useReducer, useCallback, useEffect, useMemo, useState } from 'react';
...
import { IconButton, styled as styled$2, Button, Avatar, Divider as Divider$1, Box as Box$1, Typography } from '@mui/material';
...
var SwSidebar = function (_a) {
    ...
    var _j = React__default.useState(open), opened = _j[0], setOpened = _j[1];
    var handleToggle = function () {
        setOpened(!opened);
    };
    return (React__default.createElement(Drawer, { className: "sw-main-sidebar", variant: variant, open: opened, ModalProps: {
        ...
        React__default.createElement(DrawerFooter, null,
            React__default.createElement(Tooltip, { title: !opened ? 'Open' : "Close", placement: "right" },
                React__default.createElement(IconButton, { color: "secondary", onClick: handleToggle }, !opened ? React__default.createElement(ChevronRightIcon, null) : React__default.createElement(ChevronLeftIcon, null))))));
};
