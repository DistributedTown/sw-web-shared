...
import React__default, { useRef, useEffect, forwardRef, useImperativeHandle, Fragment as Fragment$1, useReducer, useCallback, useMemo, useState } from 'react';
import Box from '@mui/material/Box';
import Container from '@mui/material/Container';
import { styled, createTheme, Drawer, IconButton, SvgIcon, Button, Avatar, Divider as Divider$1, Box as Box$1, Typography, useTheme, Slider, SliderThumb, LinearProgress, linearProgressClasses } from '@mui/material';
...
function DitoCreditsSvg(_a) {
    ...
    return (React__default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: __assign({ height: height, width: width }, (sx || {})), className: className, "data-name": "Group 17", viewBox: "0 0 167.785 114.465" },
