...
function DitoLogoSvg(_a) {
    ...
    return (React__default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 257.19 76.4" },
        React__default.createElement("defs", null,
            React__default.createElement("style", null, ".cls-1{fill:#fff;}.cls-2{isolation:isolate;}")),
        React__default.createElement("g", { id: "Layer_2", "data-name": "Layer 2" },
            React__default.createElement("g", { id: "Layer_1-2", "data-name": "Layer 1" },
                React__default.createElement("g", { id: "Group_1818", "data-name": "Group 1818" },
                    React__default.createElement("g", { id: "Group_12", "data-name": "Group 12" },
                        React__default.createElement("g", { id: "Path_1-2", "data-name": "Path 1-2" },
                            React__default.createElement("path", { id: "Path_22", "data-name": "Path 22", className: "cls-1", d: "M59.69,76h0l-59-8.21a.25.25,0,0,1-.21-.28.26.26,0,0,1,.09-.16L22,50.49v-26L1.38,8.14a.25.25,0,0,1,.24-.42L29.38,18.05l21.3-1.58L59.48.53a.24.24,0,0,1,.2-.12.23.23,0,0,1,.19.07l0,0,10.41,14.6a.29.29,0,0,1,0,.13h0V60.4a.28.28,0,0,1,0,.13h0L59.89,75.88a0,0,0,0,1,0,0h0a.16.16,0,0,1-.08.06h0l-.07,0h0ZM1.26,67.37l58,8.07L51.73,59.61,29.17,58.33h-.05a.2.2,0,0,1-.11-.06h0s0,0,0,0h0a.29.29,0,0,1,0-.13h0l0-6.9-6.68-.33Zm58.68-7.3V75l9.73-14.33Zm-7.65-.43,7.16,15V60Zm7.65-.06,9.4.53-9.4-7.33Zm0-7.42,9.93,7.74V15.53l-9.93.74Zm-7.89,7,7.4.42V52.4l-3.51-2.73L48.65,52ZM29.58,57.86,51.49,59.1l-3.33-7-15-.73Zm-.13-6.66,0,5.92,3.18-5.77ZM56,49.14a.28.28,0,0,1,.15.06l3.31,2.58V16.3L51,16.93l-3.12,5.65.69,29,7.37-2.38H56ZM33.42,50.9l14.64.71-.69-29.08a.28.28,0,0,1,0-.13l3-5.43L29.75,18.51l4.87,8.75a.28.28,0,0,1,0,.12V48.6a.17.17,0,0,1,0,.12Zm-4-.19,3.41.17,1.08-2-4.49.74Zm-4.94-.24,4.45.22v-.95ZM2.89,8.71,22.35,24.22a.26.26,0,0,1,.1.19V50.32L29,49.25l.13-30.78Zm26.7,10.52-.12,29.94,4.7-.78V27.45ZM59.45,1.6,51.27,16.42l8.18-.61Zm.49-.18V15.78l9.72-.73Z" })),
                        React__default.createElement("g", { id: "Path_1-2-2", "data-name": "Path 1-2-2" },
                            React__default.createElement("path", { id: "Path_23", "data-name": "Path 23", className: "cls-1", d: "M.65,67.78a.26.26,0,0,1-.24-.25.24.24,0,0,1,.17-.23L55.75,49.22v-.38H34.41a.25.25,0,0,1-.25-.24v-21l-12-2.93a.25.25,0,0,1-.2-.28.26.26,0,0,1,.29-.2h0l12.17,3L56,26.36a.21.21,0,0,1,.18.07.21.21,0,0,1,.07.17V49.39a.25.25,0,0,1-.16.24L.73,67.76Zm34-19.42H55.74V26.86l-21.09.76Z" })),
                        React__default.createElement("g", { id: "Group_11", "data-name": "Group 11" },
                            React__default.createElement("path", { id: "Path_24", "data-name": "Path 24", className: "cls-1", d: "M56,26.85a.25.25,0,0,1-.15-.44L70,15.08a.24.24,0,0,1,.34,0,.24.24,0,0,1,0,.35h0L56.14,26.79A.2.2,0,0,1,56,26.85Z" }))),
                    React__default.createElement("g", { id: "Group_15", "data-name": "Group 15" },
                        React__default.createElement("g", { id: "Path_1-2-3", "data-name": "Path 1-2-3" },
                            React__default.createElement("path", { id: "Path_25", "data-name": "Path 25", className: "cls-1", d: "M56,27.25a.64.64,0,0,1-.28-.06l-8.22-4L22.25,25.07a.65.65,0,0,1-.7-.58v0a.64.64,0,0,1,.6-.7l25.42-1.89a.63.63,0,0,1,.33.06L56.27,26a.64.64,0,0,1,.3.87.65.65,0,0,1-.58.37Z" })),
                        React__default.createElement("g", { id: "Path_1-2-4", "data-name": "Path 1-2-4" },
                            React__default.createElement("path", { id: "Path_26", "data-name": "Path 26", className: "cls-1", d: "M.65,68.18h0A.65.65,0,0,1,0,67.53H0L.88,7.94h0a.69.69,0,0,1,.17-.41h0a.44.44,0,0,1,.15-.12h0a.62.62,0,0,1,.26-.09L59.61,0a.65.65,0,0,1,.73.57.66.66,0,0,1-.57.73L2.17,8.55l-.87,59A.64.64,0,0,1,.65,68.18Z" })),
                        React__default.createElement("g", { id: "Group_13", "data-name": "Group 13" },
                            React__default.createElement("path", { id: "Path_27", "data-name": "Path 27", className: "cls-1", d: "M48.31,52.53h0L22.17,51.26a.64.64,0,0,1-.62-.65V24.41a.65.65,0,0,1,.65-.65h0a.65.65,0,0,1,.65.65h0V50l25.38,1.22,7.11-2.3V26.6a.65.65,0,0,1,.62-.68.66.66,0,0,1,.68.63V49.39a.64.64,0,0,1-.45.62l-7.68,2.48A.65.65,0,0,1,48.31,52.53Z" })),
                        React__default.createElement("g", { id: "Group_14", "data-name": "Group 14" },
                            React__default.createElement("path", { id: "Path_28", "data-name": "Path 28", className: "cls-1", d: "M59.7,76.4h-.09l-59-8.21a.66.66,0,0,1,.18-1.3L59.38,75,69.46,59.85V15.47L59.16,1A.66.66,0,0,1,60.23.27L70.64,14.89a.64.64,0,0,1,.13.37V60.05a.66.66,0,0,1-.11.36L60.24,76.1A.65.65,0,0,1,59.7,76.4Z" }))),
                    React__default.createElement("g", { id: "DISTRIBUTED_TOWN", "data-name": "DISTRIBUTED TOWN", className: "cls-2" },
                        React__default.createElement("g", { className: "cls-2" },
                            React__default.createElement("path", { className: "cls-1", d: "M96.47,30V10.39h5.41q10.37,0,10.36,9.56a9.61,9.61,0,0,1-2.87,7.29A10.68,10.68,0,0,1,101.66,30Zm2.29-17.53V27.92h2.93a8.28,8.28,0,0,0,6-2.07A7.72,7.72,0,0,0,109.84,20q0-7.53-8-7.53Z" }),
                            React__default.createElement("path", { className: "cls-1", d: "M118.4,30h-2.3V10.39h2.3Z" }),
                            React__default.createElement("path", { className: "cls-1", d: "M122.64,29.2V26.5a5.5,5.5,0,0,0,1.11.74,9.79,9.79,0,0,0,1.37.55,10.77,10.77,0,0,0,1.44.35,8.21,8.21,0,0,0,1.34.12,5.18,5.18,0,0,0,3.16-.79,2.64,2.64,0,0,0,1.05-2.26,2.67,2.67,0,0,0-.35-1.38,3.84,3.84,0,0,0-1-1.07,8.74,8.74,0,0,0-1.46-.93l-1.81-.94c-.68-.35-1.32-.7-1.91-1.05a8.31,8.31,0,0,1-1.55-1.18,4.86,4.86,0,0,1-1-1.45,4.52,4.52,0,0,1-.38-1.91,4.51,4.51,0,0,1,.59-2.33,5.06,5.06,0,0,1,1.55-1.64,7.07,7.07,0,0,1,2.18-.95,9.89,9.89,0,0,1,2.49-.32,9.68,9.68,0,0,1,4.23.7v2.58a7.7,7.7,0,0,0-4.46-1.2,7,7,0,0,0-1.5.16,4,4,0,0,0-1.34.51,2.82,2.82,0,0,0-1,.92,2.39,2.39,0,0,0-.37,1.36,2.74,2.74,0,0,0,.28,1.3,3.1,3.1,0,0,0,.83,1,8.76,8.76,0,0,0,1.33.88c.52.28,1.13.59,1.81.93s1.37.71,2,1.09A9,9,0,0,1,133,21.56a5.6,5.6,0,0,1,1.13,1.55,4.29,4.29,0,0,1,.42,1.94A4.91,4.91,0,0,1,134,27.5a4.72,4.72,0,0,1-1.53,1.64,6.77,6.77,0,0,1-2.22.9,12,12,0,0,1-2.66.29,10.77,10.77,0,0,1-1.14-.08A14,14,0,0,1,125,30a11.1,11.1,0,0,1-1.35-.35A4.15,4.15,0,0,1,122.64,29.2Z" }),
                            React__default.createElement("path", { className: "cls-1", d: "M150,12.47h-5.66V30h-2.3V12.47h-5.64V10.39H150Z" }),
                            React__default.createElement("path", { className: "cls-1", d: "M167.15,30h-2.73l-3.28-5.5a13.81,13.81,0,0,0-.88-1.3,4.61,4.61,0,0,0-.87-.89,3.21,3.21,0,0,0-.95-.5,4.18,4.18,0,0,0-1.16-.15h-1.89V30H153.1V10.39H159a8.49,8.49,0,0,1,2.37.32,5.39,5.39,0,0,1,1.89,1,4.59,4.59,0,0,1,1.25,1.63,5.47,5.47,0,0,1,.45,2.29,5.37,5.37,0,0,1-.31,1.88,5,5,0,0,1-.87,1.53,5.44,5.44,0,0,1-1.37,1.14,6.92,6.92,0,0,1-1.8.73V21a4,4,0,0,1,.86.5,4.25,4.25,0,0,1,.69.66,9.84,9.84,0,0,1,.65.87c.21.32.45.7.71,1.12ZM155.39,12.47v7.11h3.12a4.78,4.78,0,0,0,1.59-.26,3.59,3.59,0,0,0,1.27-.75,3.4,3.4,0,0,0,.83-1.19,3.92,3.92,0,0,0,.3-1.57,3.08,3.08,0,0,0-1-2.46,4.36,4.36,0,0,0-2.94-.88Z" }),
                            React__default.createElement("path", { className: "cls-1", d: "M172.14,30h-2.3V10.39h2.3Z" }),
                            React__default.createElement("path", { className: "cls-1", d: "M177.3,30V10.39h5.57a6.12,6.12,0,0,1,4,1.25,4,4,0,0,1,1.49,3.24,4.7,4.7,0,0,1-.91,2.89A4.83,4.83,0,0,1,185,19.52v.06a4.92,4.92,0,0,1,3.17,1.5,4.61,4.61,0,0,1,1.19,3.28,5.12,5.12,0,0,1-1.81,4.08A6.7,6.7,0,0,1,183,30Zm2.29-17.53V18.8h2.35a4.45,4.45,0,0,0,3-.91A3.17,3.17,0,0,0,186,15.33q0-2.86-3.76-2.86Zm0,8.39v7.06h3.12a4.68,4.68,0,0,0,3.14-1A3.28,3.28,0,0,0,187,24.34c0-2.32-1.57-3.48-4.73-3.48Z" }),
                            React__default.createElement("path", { className: "cls-1", d: "M207.69,22.07q0,8.25-7.45,8.26-7.14,0-7.14-7.95v-12h2.3V22.23q0,6,5.08,6c3.28,0,4.91-1.94,4.91-5.82v-12h2.3Z" }),
                            React__default.createElement("path", { className: "cls-1", d: "M224.18,12.47h-5.66V30h-2.3V12.47h-5.65V10.39h13.61Z" }),
                            React__default.createElement("path", { className: "cls-1", d: "M237.64,30H227.25V10.39h10v2.08h-7.66V19h7.08v2.07h-7.08v6.86h8.09Z" }),
                            React__default.createElement("path", { className: "cls-1", d: "M241.42,30V10.39h5.41q10.36,0,10.36,9.56a9.65,9.65,0,0,1-2.87,7.29A10.68,10.68,0,0,1,246.61,30Zm2.29-17.53V27.92h2.93a8.28,8.28,0,0,0,6-2.07A7.72,7.72,0,0,0,254.79,20q0-7.53-8-7.53Z" })),
                        React__default.createElement("g", { className: "cls-2" },
                            React__default.createElement("path", { className: "cls-1", d: "M108.06,46.47H102.4V64h-2.3V46.47H94.46V44.39h13.6Z" }),
                            React__default.createElement("path", { className: "cls-1", d: "M117.74,64.33a8.61,8.61,0,0,1-6.68-2.75,10.21,10.21,0,0,1-2.51-7.15,10.82,10.82,0,0,1,2.56-7.55,8.91,8.91,0,0,1,7-2.82,8.38,8.38,0,0,1,6.54,2.74A10.19,10.19,0,0,1,127.09,54a10.86,10.86,0,0,1-2.54,7.59A8.78,8.78,0,0,1,117.74,64.33Zm.17-18.19a6.29,6.29,0,0,0-5,2.23A8.62,8.62,0,0,0,111,54.22a8.69,8.69,0,0,0,1.88,5.83,6.14,6.14,0,0,0,4.9,2.21,6.46,6.46,0,0,0,5.09-2.1,8.63,8.63,0,0,0,1.86-5.9,9,9,0,0,0-1.81-6A6.19,6.19,0,0,0,117.91,46.14Z" }),
                            React__default.createElement("path", { className: "cls-1", d: "M153.51,44.39,148,64h-2.69l-4-14.33a9.41,9.41,0,0,1-.31-2h-.06a9.91,9.91,0,0,1-.35,2L136.46,64h-2.67l-5.74-19.61h2.53l4.17,15a10.53,10.53,0,0,1,.33,2h.06a12,12,0,0,1,.43-2l4.33-15h2.2l4.16,15.15a10.39,10.39,0,0,1,.33,1.83h0a11.27,11.27,0,0,1,.37-1.88l4-15.1Z" }),
                            React__default.createElement("path", { className: "cls-1", d: "M172.22,64h-2.81L159.32,48.37a6,6,0,0,1-.63-1.23h-.08a20.69,20.69,0,0,1,.11,2.69V64h-2.3V44.39h3l9.82,15.38c.41.64.67,1.08.79,1.31h.05a21.08,21.08,0,0,1-.13-2.88V44.39h2.29Z" }))))))));
}
...
var SwDivider = function (_a) {
    ...
    return React.createElement(Divider$1, __assign({ color: "white", sx: styles }, props));
};
...
export { CenterWhiteBarSvg, CreateUnselSvg, DitoCreditsSvg, DitoLogoCircleSvg, DitoLogoSvg, FooterMembersSvg, FooterShareSvg, GameTheorySvg, JoinSelSvg, JoinUnselSvg, LayerBlurSvg, LogoffSvg, MainBackgroundSvg, MilestonesCompletedSvg, MilestonesSvg, NetworkDesignSvg, NotificationsSvg, OpenGigsSelSvg, OpenGigsSvg, ParticipationRateSvg, ProjectsCreatedSvg, ProjectsSelSvg, ProjectsSvg, QRCodeSvg, ScoreReachedSvg, SettingsSvg, Shape1Svg, Shape2Svg, Shape3Svg, Shape4Svg, Shape5Svg, Shape6Svg, Shape7Svg, SkillWalletNavSvg, SwAnimatedRoute$1 as SwAnimated, SwButton, SwDivider, SwLayout, SwQuote, SwScrollbar, SwSidebar, TokenomicsSvg, TownhallNavSvg, TreasurySelSvg, TreasurySvg, YourContributionsSvg };
