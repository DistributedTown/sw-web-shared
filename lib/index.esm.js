...
var SwScrollbar = function (_a) {
    ...
    return (React.createElement(Scrollbars, __assign({ autoHeightMin: "100%", autoHeightMax: "100%", className: className, renderView: renderView, renderThumbHorizontal: renderThumb, renderThumbVertical: renderThumb, style: __assign({ height: '100%' }, (sx || {})) }, rest)));
};
        ...
        React__default.createElement(List, { className: "sw-sidebar-menu" }, menuItems.map(function (item, id) {
            ...
            if (item.type === "href") {
                return (React__default.createElement(Tooltip, { key: id, title: !open ? item.label : "", placement: "right" },
                    React__default.createElement(ListItem, { onClick: mobile ? handleToggle : function () { return null; }, activeClassName: "active-link", component: NavLink, to: item.href, key: id },
