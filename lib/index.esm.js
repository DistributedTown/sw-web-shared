...
var SwSlider = function (_a) {
    ...
    return (React.createElement(CustomizedSlider, __assign$2({}, rest, { onChange: function (_, v) { return setValue(v); }, components: { Thumb: SwThumbComponent(value) }, className: "sw-slider ".concat(className, " mode-").concat(mode) })));
};
