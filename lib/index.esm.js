...
import { styled, createTheme, Drawer, IconButton, SvgIcon, Button, Avatar, Divider as Divider$1, Box as Box$1, Typography, useTheme, Slider, SliderThumb, LinearProgress, linearProgressClasses, Dialog, DialogContent, MobileStepper, Badge, Tooltip as Tooltip$1 } from '@mui/material';
...
var SwAnimatedRoute = function (_a) {
    ...
    return (React__default.createElement(Route, { key: to, path: to }, function (_a) {
        var match = _a.match;
...
var SwQuote = function (_a) {
    ...
    return (React.createElement(Box$1, { className: "sw-box-quote ".concat(className) }, mobile ? (React.createElement(React.Fragment, null,
...
function SwClipboardCopy(_a) {
    ...
    return (React__default.createElement("div", { className: "copy-wrapper ".concat(mode), onClick: handleCopyClick },
...
var SwStepper = function (_a) {
    ...
    return (React__default.createElement(Box$1, { sx: { width: "100%", position: "relative" } },
        stepperText && (React__default.createElement(Typography, { className: "stepper-top", sx: { color: "text.primary" }, component: "div", variant: "h1", align: "center" }, stepperText)),
        ...
        React__default.createElement(Box$1, { sx: { maxWidth: "450px", width: "100%", margin: "0 auto" } },
            React__default.createElement("div", { key: "stepper-dots", className: "stepper-dots", style: { display: activeStep !== -1 ? "flex" : "none" } }, steps.map(function (_, index) {
                return (React__default.createElement(Fragment, { key: index },
                    React__default.createElement("div", { className: "stepper-dot ".concat(index === activeStep ? "active" : "") }, index < activeStep && React__default.createElement(CheckIcon, { color: "info" })),
                    steps.length - 1 !== index && React__default.createElement("div", { className: "stepper-line" })));
            })),
            React__default.createElement(Typography, { sx: { color: "text.primary", textAlign: "center", pb: 1 }, component: "div", variant: "h2" }, title),
            React__default.createElement(Typography, { sx: {
                    color: "text.primary",
                    textAlign: "center",
                    pb: 2,
