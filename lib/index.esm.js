...
var CustomizedButton = styled(Button)(function (props) {
...
var SwUploadFile = function (_a) {
    var _b = _a.multiple, multiple = _b === void 0 ? false : _b, _c = _a.variant, variant = _c === void 0 ? "square" : _c, _d = _a.sx, sx = _d === void 0 ? {
        width: "120px",
        height: "120px",
    } : _d, _e = _a.mode, mode = _e === void 0 ? "light" : _e, _f = _a.initialPreviewUrl, initialPreviewUrl = _f === void 0 ? null : _f, _g = _a.fileChange, fileChange = _g === void 0 ? function (file) { return null; } : _g, _h = _a.defaulUploadIcon, defaulUploadIcon = _h === void 0 ? React__default.createElement(DefaultUploadSvg, null) : _h;
    var _j = useState(initialPreviewUrl), preview = _j[0], setPreview = _j[1];
    var _k = useDropzone({
        multiple: multiple,
        disabled: !!preview,
    ...
    , __assign$2({ 
        ...
        React__default.createElement(Avatar, { alt: "Avatar", variant: variant, src: preview, imgProps: {
                style: {
                    maxHeight: "100%",
                    maxWidth: "100%",
                    objectFit: "cover",
...
var SwThumbComponent = function (value, variant) {
    return function (props) {
        ...
        return (React.createElement(SliderThumb, __assign$2({}, other),
            children,
            variant === "dotted" && (React.createElement(Typography, { className: "sw-thumb-value", component: "span", variant: "subtitle2" }, value || 0))));
    };
};
...
function SwClipboardCopy(_a) {
    ...
    return (React__default.createElement(CopyWrapper, { style: sx, className: "copy-wrapper ".concat(mode), onClick: handleCopyClick },
        React__default.createElement(Typography, { variant: "h4", sx: {
                textAlign: "center",
                flex: 1,
...
var SwStepper = function (_a) {
    ...
    return (React__default.createElement(Wrapper, { sx: { width: "100%", position: "relative" } },
        ...
        React__default.createElement(Box$1, { sx: { maxWidth: maxWidth, width: "100%", margin: "0 auto" } },
            React__default.createElement("div", { key: "stepper-dots", className: "stepper-dots", style: { display: activeStep !== -1 ? "flex" : "none" } }, steps.map(function (_, index) {
                return (React__default.createElement(Fragment, { key: index },
                    React__default.createElement("div", { className: "stepper-dot ".concat(index === activeStep ? "active" : ""), style: dotStyles }, index < activeStep && (React__default.createElement(CheckIcon, { color: mode === "light" ? "info" : "primary" }))),
                    steps.length - 1 !== index && React__default.createElement("div", { className: "stepper-line" })));
            })),
            title && (React__default.createElement(Typography, { sx: {
                    color: mode === "light" ? "text.primary" : "primary.main",
                    textAlign: "center",
                    pb: 1,
                }, component: "div", variant: "h2" }, title)),
            description && (React__default.createElement(Typography, { sx: {
                    color: mode === "light" ? "text.primary" : "primary.main",
                    textAlign: "center",
                    pb: 2,
                    m: "0 -20px",
