...
import { styled as styled$1, Button } from '@mui/material';
    ...
    return (React__default.createElement(React__default.Fragment, null,
        ...
        React__default.createElement(Box, { sx: {
            ...
            React__default.createElement(Box, { component: "main", sx: {
                ...
                React__default.createElement(Container, { maxWidth: "lg", sx: { mt: 4, mb: 4 } }, children)))));
};
...
var SwSidebar = function (_a) {
    ...
    var _h = useRouteMatch(), path = _h.path, url = _h.url;
    console.log(path, url, 'here');
    var Drawer = DrawerRef(width, backgroundColor);
    var _j = React__default.useState(open), opened = _j[0]; _j[1];
    return (React__default.createElement(Drawer, { className: "sw-main-sidebar", variant: variant, open: opened },
        ...
        React__default.createElement(List, { className: "sw-sidebar-menu" }, menuItems.map(function (item, id) {
            ...
            return (React__default.createElement(ListItem, { exact: true, activeClassName: "active-link", component: NavLink, to: item.href, key: id },
...
function JoinSelSvg(_a) {
    ...
    return (React__default.createElement("svg", { style: { height: height, width: width }, className: className, viewBox: "0 0 52.492 36", xmlns: "http://www.w3.org/2000/svg" },
...
var CustomizedButton = styled$1(Button)(function (_a) {
    var theme = _a.theme;
...
var SwButton = function (_a) {
    ...
    return (React.createElement(CustomizedButton, __assign({}, rest, { variant: variant, color: color, className: "\"sw-button\" " + className }),
        React.createElement("span", { className: "sw-btn-label" }, label)));
};
...
export { DitoLogoSvg, JoinSelSvg, MainBackgroundSvg, SwButton, SwLayout, SwLogoSvg, SwSidebar };
