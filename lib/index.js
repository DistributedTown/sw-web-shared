...
var DrawerRef = function (drawerWidth, backgroundColor) {
    return styles$1.styled(MuiDrawer__default["default"], {
        shouldForwardProp: function (prop) { return prop !== "open"; },
    })(function (_a) {
        var _b;
        var theme = _a.theme, open = _a.open;
        return ({
            "& .MuiDrawer-paper": __assign(__assign({ position: "relative", whiteSpace: "nowrap", padding: "0 50px", width: drawerWidth, borderRight: "4px solid " + theme.palette.text.primary, transition: theme.transitions.create("width", {
...
var SwSidebar = function (_a) {
    var _b = _a.menuItems, menuItems = _b === void 0 ? [] : _b, _c = _a.open, open = _c === void 0 ? false : _c, _d = _a.width, width = _d === void 0 ? 300 : _d, _e = _a.backgroundColor, backgroundColor = _e === void 0 ? "transparent" : _e, _f = _a.variant, variant = _f === void 0 ? "permanent" : _f, _g = _a.sidebarTop, sidebarTop = _g === void 0 ? null : _g; _a.mobile;
    var Drawer = DrawerRef(width, backgroundColor);
    var _j = React__default["default"].useState(open), opened = _j[0], setOpened = _j[1];
    var handleToggle = function () {
        setOpened(!opened);
    };
    return (React__default["default"].createElement(Drawer, { className: "sw-main-sidebar", variant: variant, open: opened, ModalProps: {
        ...
        React__default["default"].createElement(DrawerFooter, null,
            React__default["default"].createElement(Tooltip__default["default"], { title: !opened ? 'Open' : "Close", placement: "right" },
                React__default["default"].createElement(material.IconButton, { color: "secondary", onClick: handleToggle }, !opened ? React__default["default"].createElement(ChevronRightIcon__default["default"], null) : React__default["default"].createElement(ChevronLeftIcon__default["default"], null))))));
};
