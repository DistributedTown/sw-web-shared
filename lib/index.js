...
var SwStepper = function (_a) {
    ...
    return (React__default["default"].createElement(Wrapper, { sx: { width: "100%", position: "relative" } },
        ...
        React__default["default"].createElement(material.Box, { sx: { maxWidth: "450px", width: "100%", margin: "0 auto" } },
            React__default["default"].createElement("div", { key: "stepper-dots", className: "stepper-dots", style: { display: activeStep !== -1 ? "flex" : "none" } }, steps.map(function (_, index) {
                return (React__default["default"].createElement(React.Fragment, { key: index },
                    React__default["default"].createElement("div", { className: "stepper-dot ".concat(index === activeStep ? "active" : "") }, index < activeStep && (React__default["default"].createElement(CheckIcon__default["default"], { color: mode === "light" ? "info" : "primary" }))),
