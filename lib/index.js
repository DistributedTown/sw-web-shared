...
var SwSidebar = function (_a) {
    ...
    return (React__default["default"].createElement(material.Drawer, { anchor: "left", sx: __assign$2(__assign$2({ width: !mobile ? width : '100%', transition: theme.transitions.create("width", {
        ...
        React__default["default"].createElement("div", { className: "sw-sidebar-content ".concat(mode) }, children),
...
var CustomizedButton = material.styled(material.Button)(function (_a) {
    var theme = _a.theme;
    return "\n  width: 100%;\n  background-color: ".concat(theme.palette.text.primary, ";\n  border: 2px solid ").concat(theme.palette.text.primary, ";\n  height: 56px;\n  cursor: pointer;\n  line-height: 0;\n  color: ").concat(theme.palette.primary.main, ";\n\n\n  &.Mui-disabled {\n    background-color: ").concat(theme.palette.text.primary, " !important;\n  }\n\n  &:hover,\n  &.active-link {\n    color: ").concat(theme.palette.text.primary, ";\n    background-color: ").concat(theme.palette.primary.main, ";\n    borderColor: ").concat(theme.palette.text.primary, ";\n\n    .sw-btn-icon {\n      fill: ").concat(theme.palette.text.primary, ";\n    }\n  }\n");
});
var SwButton = function (_a) {
    var _b = _a.label, label = _b === void 0 ? null : _b, _c = _a.children, children = _c === void 0 ? null : _c, _d = _a.className, className = _d === void 0 ? "" : _d, _e = _a.variant, variant = _e === void 0 ? "contained" : _e, _f = _a.color, color = _f === void 0 ? "primary" : _f, rest = __rest$1(_a, ["label", "children", "className", "variant", "color"]);
    return (React__namespace.createElement(CustomizedButton, __assign$2({}, rest, { variant: variant, color: color, className: "sw-button ".concat(className) }),
