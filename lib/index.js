...
var TelegramIcon = require('@mui/icons-material/Telegram');
...
var PhotoCameraIcon__default = /*#__PURE__*/_interopDefaultLegacy(PhotoCameraIcon);
var Popover__default = /*#__PURE__*/_interopDefaultLegacy(Popover);
var TwitterIcon__default = /*#__PURE__*/_interopDefaultLegacy(TwitterIcon);
var TelegramIcon__default = /*#__PURE__*/_interopDefaultLegacy(TelegramIcon);
var LinkedInIcon__default = /*#__PURE__*/_interopDefaultLegacy(LinkedInIcon);
...
var SimpleBar = React__default["default"].forwardRef(function (_ref, ref) {
  ...
  }) : React__default["default"].createElement("div", _extends({}, scrollableNodeProps, {
...
var SwScrollbar = function (_a) {
    ...
    return (React__namespace.createElement(SimpleBar, __assign$2({ forceVisible: "y", className: className, style: __assign$2({ height: '100%', width: '100%' }, (sx || {})) }, rest)));
};

var CustomizedLayout = material.styled(Box__default["default"])(function (_a) {
    _a.theme;
...
var SwLayout = function (_a) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        backgroundUrl && React__default["default"].createElement("div", { className: "sw-background ".concat(className), style: {
                display: "flex",
        ...
        React__default["default"].createElement(CustomizedLayout, { sx: {
                display: "flex",
            ...
            React__default["default"].createElement(Box__default["default"], { component: "main", sx: {
                ...
                React__default["default"].createElement(Container__default["default"], { className: "sw-layout-top", maxWidth: "xl", sx: { display: hideTop ? 'none' : 'flex' } }, top),
                React__default["default"].createElement(SwScrollbar, { sx: __assign$2({ height: '100%' }, (scrollbarStyles || {})) },
                    React__default["default"].createElement(Container__default["default"], { maxWidth: "xl", disableGutters: disableGutters }, children))))));
};

var DrawerFooter = styles.styled("div")(function (_a) {
    _a.theme;
    return ({
        display: "flex",
        alignItems: "center",
...
var CustomizedDrawer = styles.styled(material.Drawer)(function (_a) {
    var theme = _a.theme;
...
var SwSidebar = function (_a) {
    ...
    return (React__default["default"].createElement(CustomizedDrawer, { anchor: "left", sx: __assign$2(__assign$2({ width: !mobile ? width : "100%", transition: theme.transitions.create("width", {
            ...
            _b))), { flexShrink: 0, "& .MuiDrawer-paper": __assign$2(__assign$2({ transition: theme.transitions.create("width", {
                ...
                _c))), (sx || {})) }), className: "sw-main-sidebar ".concat(mobile ? "is-mobile" : "", " ").concat(className), variant: mobile ? "temporary" : "permanent", open: open },
        mobile && (React__default["default"].createElement(Tooltip__default["default"], { title: "Close sidebar", placement: "right", color: "white" },
            React__default["default"].createElement(material.IconButton, { className: "sw-sidebar-close-button", color: "info", onClick: handleToggle },
                React__default["default"].createElement(CloseIcon__default["default"], null)))),
        sidebarTopIcon && (React__default["default"].createElement("div", { className: "sw-sidebar-top" }, React__default["default"].createElement(material.SvgIcon, { component: sidebarTopIcon, width: mobile || !open ? "60" : "100", height: mobile ? "60" : "100" }))),
        React__default["default"].createElement("div", { className: "sw-sidebar-content ".concat(open ? "open" : "closed", " ").concat(mode) }, children),
        !mobile && !preventClose && (React__default["default"].createElement(DrawerFooter, null,
            React__default["default"].createElement(Tooltip__default["default"], { title: !open ? "Open" : "Close", placement: "right" },
                React__default["default"].createElement(material.IconButton, { color: "info", onClick: handleToggle }, !open ? React__default["default"].createElement(ChevronRightIcon__default["default"], null) : React__default["default"].createElement(ChevronLeftIcon__default["default"], null)))))));
};

var CustomizedList = material.styled(List__default["default"])(function (_a) {
    var theme = _a.theme;
...
var SwMenuItems = function (_a) {
    ...
    return (React__default["default"].createElement(CustomizedList, { className: "sw-sidebar-menu" }, menuItems.map(function (item, id) {
        if (item.type === "divider") {
            return React__default["default"].createElement(Divider__default["default"], { key: id, className: "sw-sidebar-divider" });
        }
        if (item.type === "href") {
            return (React__default["default"].createElement(Tooltip__default["default"], { key: id, title: !open ? item.label : "", placement: "right" },
                React__default["default"].createElement(ListItem__default["default"], { onClick: mobile ? handleToggle : function () { return null; }, 
                    // @ts-ignore
                    activeClassName: "active-link", component: reactRouterDom.NavLink, disabled: item.disabled, to: item.href, replace: true, key: id },
                    React__default["default"].createElement("div", { className: "sw-sidebar-menu-icon" }, item.icon),
                    React__default["default"].createElement(ListItemText__default["default"], { sx: {
                            fontSize: "body1",
                        }, primary: item.label }))));
        }
        return (React__default["default"].createElement(Tooltip__default["default"], { key: id, title: !open ? item.label : "", placement: "right" },
            React__default["default"].createElement(ListItem__default["default"], { onClick: item.onClick, key: id, disabled: item.disabled },
                React__default["default"].createElement("div", { className: "sw-sidebar-menu-icon" }, item.icon),
...
var CustomizedButton = material.styled(material.Button)(function (props) {
...
var SwButton = function (_a) {
    ...
    return (React__namespace.createElement(CustomizedButton, __assign$2({}, rest, { className: "sw-button ".concat(className, " ").concat(mode, " ").concat(btnType) }),
        React__namespace.createElement("span", { style: { marginTop: '4px' }, className: "sw-btn-label" }, children || label)));
};
...
function DefaultUploadSvg() {
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "110", height: "109.995", viewBox: "0 0 110 109.995" },
        React__default["default"].createElement("g", { transform: "translate(-3 -3.001)" },
            React__default["default"].createElement("path", { d: "M71.75 76.33v-9.167c2.062-1.022 7.961-8.044 8.58-13.53 1.623-.124 4.171-1.613 4.923-7.494.4-3.158-1.2-4.932-2.173-5.491A24.255 24.255 0 0085.5 30.5c0-11.128-4.368-20.625-13.75-20.625C71.75 9.876 68.491 3 58 3 38.557 3 30.5 15.472 30.5 30.5a27.317 27.317 0 002.42 10.147c-.972.559-2.576 2.338-2.173 5.491.752 5.88 3.3 7.37 4.923 7.494.619 5.486 6.518 12.508 8.58 13.53v9.168C39.667 90.08 3 80.913 3 113h110c0-32.087-36.667-22.92-41.25-36.67z", "data-name": "Path 1643" }))));
}
var UploadWrapper = material.styled("div")(function (props) {
    var _a = props, theme = _a.theme, mode = _a.mode; _a.variant;
    return "\n    position: relative;\n    cursor: pointer;\n\n    .MuiAvatar-root {\n      width: 100%;\n      height: 100%;\n      opacity: 1;\n      transition: ".concat(theme.transitions.create(["opacity", "transform"]), ";\n      backface-visibility: hidden;\n      border: 3px solid ").concat(mode === "light"
        ...
        ? theme.palette.background.paper
        : theme.palette.primary.main, ";\n        }\n      }\n    }\n\n\n    &.rounded {\n      border-width: 1px;\n      border-style: solid;\n\n      .MuiAvatar-root {\n        background: transparent;\n        border: 1px solid ").concat(mode === "light"
        ? theme.palette.background.paper
...
var SwUploadFile = function (_a) {
    var _b = _a.multiple, multiple = _b === void 0 ? false : _b, _c = _a.variant, variant = _c === void 0 ? "square" : _c, _d = _a.sx, sx = _d === void 0 ? {
        width: "120px",
        height: "120px",
    } : _d, _e = _a.mode, mode = _e === void 0 ? "light" : _e, _f = _a.initialPreviewUrl, initialPreviewUrl = _f === void 0 ? null : _f, _g = _a.fileChange, fileChange = _g === void 0 ? function (file) { return null; } : _g, _h = _a.defaulUploadIcon, defaulUploadIcon = _h === void 0 ? React__default["default"].createElement(DefaultUploadSvg, null) : _h;
    var _j = React.useState(initialPreviewUrl), preview = _j[0], setPreview = _j[1];
    var _k = useDropzone({
        multiple: multiple,
        disabled: !!preview,
    ...
    var Action = function () {
        return (React__default["default"].createElement("div", { onClick: handleActionClick, className: "sw-upload-action" }, preview ? (React__default["default"].createElement(HighlightOffIcon__default["default"], { className: "remove" })) : (React__default["default"].createElement(PhotoCameraIcon__default["default"], { className: "upload" }))));
    };
    return (React__default["default"].createElement(UploadWrapper
    // @ts-ignore
    , __assign$2({ 
        // @ts-ignore
        mode: mode, variant: variant }, getRootProps({
        className: "".concat(variant, " sw-uploader-wrapper"),
        style: sx,
    })),
        React__default["default"].createElement(material.Avatar, { alt: "Avatar", variant: variant, src: preview, imgProps: {
                style: {
                    maxHeight: "100%",
                    maxWidth: "100%",
                    objectFit: "cover",
        ...
        React__default["default"].createElement("input", __assign$2({}, getInputProps()))));
};

var CustomizedDivider = material.styled(material.Divider)(function (_a) {
    var theme = _a.theme;
...
var SwDivider = function (_a) {
    ...
    return (React__namespace.createElement(CustomizedDivider, __assign$2({ className: "sw-divider", color: "white", sx: styles }, props)));
};

var CustomizedQuote = material.styled(material.Box)(function (_a) {
    var theme = _a.theme;
...
var SwQuote = function (_a) {
    ...
    var _e = React__namespace.useState(null), anchorEl = _e[0], setAnchorEl = _e[1];
    ...
    return (React__namespace.createElement(CustomizedQuote, { className: "sw-box-quote ".concat(className) }, mobile ? (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement(material.Typography, { "aria-owns": open ? "mouse-over-popover" : undefined, "aria-haspopup": "true", onMouseEnter: handlePopoverOpen, onMouseLeave: handlePopoverClose, color: "info", component: "div", variant: "subtitle1" }, mobileStartText),
        React__namespace.createElement(Popover__default["default"], { id: "mouse-over-popover", sx: {
                pointerEvents: "none",
            ...
            React__namespace.createElement(Quote, { showBorder: false, children: children })))) : (React__namespace.createElement(Quote, { showBorder: false, children: children }))));
};
var Quote = function (_a) {
    var children = _a.children, showBorder = _a.showBorder;
    var theme = material.useTheme();
    return (React__namespace.createElement("div", { className: "quote ".concat(showBorder ? 'show-border' : ''), style: { boxShadow: showBorder ? theme.shadows[1] : 'none' } },
        React__namespace.createElement(material.Typography, { color: "info", component: "div", variant: "h2" }, children)));
};

var CustomizedSlider = material.styled(material.Slider)(function (_a) {
    var theme = _a.theme;
...
var SwThumbComponent = function (value, variant) {
    return function (props) {
        var children = props.children, other = __rest$1(props, ["children"]);
        return (React__namespace.createElement(material.SliderThumb, __assign$2({}, other),
            children,
            variant === "dotted" && (React__namespace.createElement(material.Typography, { className: "sw-thumb-value", component: "span", variant: "subtitle2" }, value || 0))));
    };
};
var SwMarkComponent = function () {
    return function (props) {
        ...
        return React__namespace.createElement("div", __assign$2({}, other));
    };
};
var SwSlider = function (_a) {
    var className = _a.className, _b = _a.mode, mode = _b === void 0 ? "black" : _b, _c = _a.variant, variant = _c === void 0 ? "dotted" : _c, rest = __rest$1(_a, ["className", "mode", "variant"]);
    return (React__namespace.createElement(CustomizedSlider, __assign$2({}, rest, { components: {
            Thumb: SwThumbComponent(rest.value, variant),
            Mark: SwMarkComponent(),
        }, className: "sw-slider ".concat(className, " variant-").concat(variant, " mode-").concat(mode) })));
};
...
function CreateUnselSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 36 36" },
        React__default["default"].createElement("path", { fillRule: "evenodd", d: "M36 18A18 18 0 1118 0a18 18 0 0118 18zM19.125 9a1.125 1.125 0 00-2.25 0v7.875H9a1.125 1.125 0 000 2.25h7.875V27a1.125 1.125 0 002.25 0v-7.875H27a1.125 1.125 0 000-2.25h-7.875z", "data-name": "Path 1592" })));
}
...
function DitoCreditsSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: __assign$2({ height: height, width: width }, (sx || {})), className: className, "data-name": "Group 17", viewBox: "0 0 167.785 114.465" },
        React__default["default"].createElement("g", { transform: "translate(.5 .501)", style: { isolation: "isolate" } },
            React__default["default"].createElement("g", { stroke: "#fff", strokeWidth: "1", "data-name": "Group 17" },
                React__default["default"].createElement("path", { d: "M166.786 79.681v20.82c0 7.071-18.856 12.963-42.032 12.963s-41.639-5.7-41.639-12.767V98.34l-.393-16.5h.2c3.143 6.089 20.427 10.8 41.247 10.8s42.229-5.892 42.229-12.963h.393z", "data-name": "Path 179" }),
                React__default["default"].createElement("path", { d: "M130.662 12.575v20.626h-.393c0 7.267-19.445 12.963-42.425 12.963a100.8 100.8 0 01-26.516-2.946l-.393.393a45.891 45.891 0 00-14.534-8.053v-.393l-.589-21.8c1.375 6.678 19.641 11.981 41.836 11.981s42.621-5.7 42.621-12.767z", "data-name": "Path 180" }),
                React__default["default"].createElement("path", { d: "M130.662 12.968h0c0 7.071-19.445 12.767-42.621 12.767s-40.657-5.3-42.032-11.981c0-.2-.2-.589-.2-.786C45.809 5.897 64.665.005 88.038.005c23.375-.196 42.624 5.696 42.624 12.963z", "data-name": "Path 181" }),
                React__default["default"].createElement("path", { d: "M90.29 84.469h0l-.179-3.962-.358-16.208c1.254 6.123 17.914 10.986 38.158 10.986s38.158-5.223 38.7-11.526h.179v18.73h-.358c0 6.483-17.377 11.886-38.516 11.886s-34.759-4.323-37.626-9.906z", "data-name": "Path 182" }),
                React__default["default"].createElement("path", { d: "M63.532 95.001a42.143 42.143 0 0011.592-18.075h.982c4.321.393 8.642.589 13.356.589h1.962v4.321l.393 16.5h-2.161a101.775 101.775 0 01-25.534-2.75z", "data-name": "Path 183" }),
                React__default["default"].createElement("path", { d: "M90.993 61.897v.982l.393 18.266h-1.964c-4.91 0-9.428-.2-13.749-.589h-.982a40.308 40.308 0 001.964-12.767 39.751 39.751 0 00-.982-8.445h.982c4.124.393 8.249.589 12.767.589l1.768.982a2.135 2.135 0 00-.197.982z", "data-name": "Path 184" }),
                React__default["default"].createElement("path", { d: "M60.382 39.38a100.8 100.8 0 0026.516 2.946c22.98 0 42.425-5.7 42.425-12.963h.393V52.54c-21.409 0-38.89 5.107-41.05 11.588l-1.768-.982q-6.482 0-12.374-.589h-.982a39.645 39.645 0 00-13.55-22.981z", "data-name": "Path 185" }),
                React__default["default"].createElement("g", { "data-name": "Group 16", transform: "translate(0 22.523)" },
                    React__default["default"].createElement("path", { d: "M83.87 33.588h0a42.991 42.991 0 00-13.946-23.371A37.322 37.322 0 0055 1.965 37.941 37.941 0 0042.626.001a42.23 42.23 0 10-.786 84.457 43.083 43.083 0 0029.069-11.2 42.653 42.653 0 0011.785-18.659 39.116 39.116 0 001.964-12.571c-.003-2.744-.788-5.691-.788-8.44z", "data-name": "Path 186" }),
                    React__default["default"].createElement("path", { d: "M166.589 36.337v.393c-.589 6.875-19.641 12.571-42.425 12.571s-40.461-5.3-41.836-11.981v-.982a2.494 2.494 0 01.2-1.179c2.161-6.482 19.641-11.588 41.05-11.588h.589c23.174 0 42.422 5.696 42.422 12.766z", "data-name": "Path 187" }))))));
}
...
function TokenomicsSvg$1(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 16.431 16.432" },
        React__default["default"].createElement("g", { "data-name": "Group 1893", transform: "translate(-141.564 -460.578)" },
            React__default["default"].createElement("path", { d: "M14.215 10.583c4.083 0 8.215-1.3 8.215-3.792S18.3 3 14.215 3 6 4.3 6 6.792s4.132 3.791 8.215 3.791z", "data-name": "Path 1469", transform: "translate(135.564 457.578)" }),
            React__default["default"].createElement("path", { d: "M6 19.9c0 2.489 4.132 3.792 8.215 3.792s8.215-1.3 8.215-3.792V18c0 2.489-4.132 3.792-8.215 3.792S6 20.489 6 18z", "data-name": "Path 1471", transform: "translate(135.564 449.025)" }),
            React__default["default"].createElement("path", { d: "M6 25.9c0 2.489 4.132 3.792 8.215 3.792s8.215-1.3 8.215-3.792V24c0 2.489-4.132 3.792-8.215 3.792S6 26.489 6 24z", "data-name": "Path 1472", transform: "translate(135.564 447.322)" }))));
}
...
function CenterWhiteBarSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 8.659 767" },
        React__default["default"].createElement("g", { fill: "#fff", "data-name": "Path 1488" },
            React__default["default"].createElement("path", { d: "M8.16 766.5H.5V.5h7.66v766z" }),
            React__default["default"].createElement("path", { fill: "#707070", d: "M1 1v765h6.66V1H1M0 0h8.66v767H0V0z" }))));
}
...
function TreasurySelSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 37 37" },
        React__default["default"].createElement("path", { stroke: "rgba(0,0,0,0)", strokeMiterlimit: "10", strokeWidth: "1", d: "M20.25 22.5a44.122 44.122 0 01-9.633-.949Q6.4 20.6 5.062 19.16a48.192 48.192 0 0010.688 1.09 53.958 53.958 0 008.209-.6A25.46 25.46 0 0030.234 18q2.39-1.054 2.391-2.25V13.5h1.125a3.025 3.025 0 011.635.861A2 2 0 0136 15.75V18q0 1.23-2.109 2.268A20.985 20.985 0 0128.16 21.9a48.974 48.974 0 01-7.91.6zm-2.25-9a48.907 48.907 0 01-6.258-.369 29.307 29.307 0 01-4.535-.879 18.994 18.994 0 01-2.865-1.09 7.378 7.378 0 01-1.635-1q-.457-.422-.457-.6V8.191a16.031 16.031 0 006.188 2.2A49.83 49.83 0 0018 11.25a49.69 49.69 0 009.563-.861 16.021 16.021 0 006.187-2.2V9q0 1.195-2.109 2.232a21.4 21.4 0 01-5.73 1.652A47.418 47.418 0 0118 13.5zM18 9a47.345 47.345 0 01-7.91-.615 21.4 21.4 0 01-5.73-1.652Q2.251 5.7 2.251 4.483t2.109-2.25A21.051 21.051 0 0110.09.6 48.661 48.661 0 0118 0a48.661 48.661 0 017.91.6 21.051 21.051 0 015.73 1.635q2.109 1.037 2.109 2.25T31.64 6.733a21.4 21.4 0 01-5.73 1.652A47.345 47.345 0 0118 9zM1.125 11.25q0 1.195 2.391 2.25a25.417 25.417 0 006.275 1.652 54.117 54.117 0 008.209.6 53.408 53.408 0 007.523-.51 29.81 29.81 0 005.977-1.39q-.035.07-.123.229a3.261 3.261 0 01-.545.579 6.767 6.767 0 01-1.107.809 13.454 13.454 0 01-1.9.879 18.122 18.122 0 01-2.813.826 37.465 37.465 0 01-3.991.58Q18.6 18 15.75 18a47.344 47.344 0 01-7.91-.615 21.4 21.4 0 01-5.73-1.652Q0 14.7 0 13.5v-2.25A2.178 2.178 0 011.125 9.6zm0 11.848v1.652q0 1.195 2.391 2.25a25.417 25.417 0 006.275 1.652 54.117 54.117 0 008.209.6 54.431 54.431 0 007.436-.492 29.767 29.767 0 005.994-1.371q-.53 1.756-5.03 2.934A42.4 42.4 0 0115.75 31.5a48.661 48.661 0 01-7.91-.6 21.094 21.094 0 01-5.731-1.634Q0 28.232 0 27v-2.25a2.178 2.178 0 011.125-1.65zM20.25 24.75a52.8 52.8 0 007.471-.51 29.761 29.761 0 005.959-1.388q-.492 1.758-4.992 2.953A42.01 42.01 0 0118 27a48.661 48.661 0 01-7.91-.6 21.051 21.051 0 01-5.73-1.635Q2.251 23.73 2.25 22.5v-2.25a2.174 2.174 0 011.02-1.582q.527.176.914.281a1.9 1.9 0 00-.668 1.3q0 1.195 2.355 2.25a24.781 24.781 0 006.223 1.652 53.542 53.542 0 008.156.599zm12.375 4.5V27.6a2.18 2.18 0 011.125 1.65v2.25q0 1.23-2.109 2.268A20.985 20.985 0 0125.91 35.4 48.975 48.975 0 0118 36a42.011 42.011 0 01-10.688-1.195q-4.5-1.195-4.992-2.953a29.731 29.731 0 005.959 1.389 52.689 52.689 0 007.471.509 53.958 53.958 0 008.209-.6 25.46 25.46 0 006.275-1.65q2.39-1.054 2.391-2.25z", transform: "translate(.5 .5)" })));
}
...
function ProjectsSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, "data-name": "Group 1463", viewBox: "0 0 35.981 36" },
        React__default["default"].createElement("path", { d: "M34.461 28.217V22.9a2.57 2.57 0 00-2.57-2.57h-10.28v-5.14h2.57a2.572 2.572 0 002.57-2.57V4.905a2.572 2.572 0 00-2.57-2.57h-7.71a2.572 2.572 0 00-2.57 2.57v7.71a2.572 2.572 0 002.57 2.57h2.57v5.14H8.76A2.57 2.57 0 006.19 22.9v5.323a5.14 5.14 0 102.57 0V22.9h10.28v5.323a5.14 5.14 0 102.57 0V22.9h10.28v5.322a5.14 5.14 0 102.57 0zM16.471 4.905h7.71v7.71h-7.71zm-6.425 28.27a2.57 2.57 0 11-2.57-2.57 2.57 2.57 0 012.569 2.571zm12.85 0a2.57 2.57 0 11-2.57-2.57 2.57 2.57 0 012.57 2.57zm10.28 2.57a2.57 2.57 0 112.57-2.57 2.57 2.57 0 01-2.57 2.571z", transform: "translate(-2.335 -2.335)" })));
}
...
function OpenGigsSelSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, "data-name": "Group 1465", viewBox: "0 0 36 36" },
        React__default["default"].createElement("g", null,
            React__default["default"].createElement("path", { d: "M7.245 24.652v-1.285H4.673v1.286a9 9 0 009 9h3.857v-2.572h-3.857a6.429 6.429 0 01-6.429-6.429z", "data-name": "Path 1564", transform: "translate(-2.102 -.224)" }),
            React__default["default"].createElement("path", { d: "M28.979 13.673v1.286h2.571v-1.286a9 9 0 00-9-9h-3.857v2.572h3.857a6.429 6.429 0 016.429 6.429z", "data-name": "Path 1565", transform: "translate(-.693 -2.102)" }),
            React__default["default"].createElement("path", { d: "M13.908 12.852H6.194a3.857 3.857 0 00-3.857 3.857v2.571h2.571v-2.571a1.286 1.286 0 011.286-1.286h7.714a1.286 1.286 0 011.286 1.286v2.571h2.571v-2.571a3.857 3.857 0 00-3.857-3.857z", "data-name": "Path 1566", transform: "translate(-2.337 -1.28)" }),
            React__default["default"].createElement("path", { d: "M9.816 12.622A5.143 5.143 0 104.673 7.48a5.143 5.143 0 005.143 5.143zm0-7.714A2.571 2.571 0 117.245 7.48a2.571 2.571 0 012.571-2.572z", "data-name": "Path 1567", transform: "translate(-2.102 -2.337)" }),
            React__default["default"].createElement("path", { d: "M32.6 29.208h-7.713a3.857 3.857 0 00-3.857 3.857v2.571h2.57v-2.571a1.286 1.286 0 011.286-1.286H32.6a1.286 1.286 0 011.286 1.286v2.571h2.571v-2.571a3.857 3.857 0 00-3.857-3.857z", "data-name": "Path 1568", transform: "translate(-.459 .363)" }),
            React__default["default"].createElement("path", { d: "M23.367 23.836a5.143 5.143 0 105.143-5.143 5.143 5.143 0 00-5.143 5.143zm7.714 0a2.571 2.571 0 11-2.571-2.571 2.571 2.571 0 012.571 2.571z", "data-name": "Path 1569", transform: "translate(-.224 -.693)" }))));
}
...
function TownhallNavSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 16 11.733" },
        React__default["default"].createElement("path", { d: "M20.583 11.492a2.56 2.56 0 01-1.867-.861A3.328 3.328 0 0117.85 8.6a2.785 2.785 0 01.7-2.125 2.843 2.843 0 014.052 0 2.778 2.778 0 01.713 2.125 3.337 3.337 0 01-.867 2.033 2.553 2.553 0 01-1.865.859zm2.201-2.934z", "data-name": "Path 1496", transform: "translate(-9.917 -5.625)" }),
        React__default["default"].createElement("path", { d: "M22.1 25.05h-8.787a.923.923 0 01-.733-.356 1.007 1.007 0 01-.175-.859 4.394 4.394 0 012.011-2.7A6.626 6.626 0 0121 21.118a4.369 4.369 0 012.012 2.718 1.009 1.009 0 01-.177.859.923.923 0 01-.731.354z", "data-name": "Path 1497", transform: "translate(-7.041 -13.317)" }),
        React__default["default"].createElement("path", { d: "M7.777 12.808a2.507 2.507 0 01-2.3-2.431 2.35 2.35 0 01.6-1.787 2.371 2.371 0 013.4 0 2.333 2.333 0 01.6 1.784 2.505 2.505 0 01-2.3 2.43z", "data-name": "Path 1498", transform: "translate(-3.41 -6.808)" }),
        React__default["default"].createElement("path", { d: "M7.68 20.016a5.057 5.057 0 00-2.188-.43 5.157 5.157 0 00-2.686.721 3.618 3.618 0 00-1.653 2.223.913.913 0 00.16.779.844.844 0 00.669.325h3.7a.267.267 0 00.262-.219c0-.021.009-.042.014-.063a4.828 4.828 0 011.924-2.794.267.267 0 00-.021-.446c-.052-.031-.112-.063-.181-.1z", "data-name": "Path 1499", transform: "translate(-1.125 -12.968)" })));
}
...
function NotificationsSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 16 19.39" },
        React__default["default"].createElement("g", { "data-name": "Group 336", transform: "translate(57)" },
            React__default["default"].createElement("path", { d: "M20.962 17.635a12.078 12.078 0 01-1.6-5.8V7.5A6.4 6.4 0 0013.038 1a6.4 6.4 0 00-6.323 6.5v4.33a11.87 11.87 0 01-1.6 5.8.4.4 0 000 .433.322.322 0 00.337.26h15.173a.44.44 0 00.375-.212.485.485 0 00-.038-.476z", "data-name": "Path 1032", transform: "translate(-62.05 -1)" }),
            React__default["default"].createElement("path", { d: "M17.7 43a2.392 2.392 0 004.329 0z", "data-name": "Path 1033", transform: "translate(-68.878 -24.985)" }))));
}
...
function SettingsSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 16 16" },
        React__default["default"].createElement("path", { d: "M62.073 56.8a5 5 0 00.041-.8c0-.28-.041-.52-.041-.8l1.718-1.32a.367.367 0 00.082-.52l-1.636-2.76a.4.4 0 00-.491-.16l-2.046.8a5.955 5.955 0 00-1.391-.8l-.286-2.12a.438.438 0 00-.409-.32h-3.273a.438.438 0 00-.409.32l-.327 2.12a6.928 6.928 0 00-1.391.8l-2.046-.8a.383.383 0 00-.491.16l-1.636 2.76a.483.483 0 00.082.52l1.759 1.32c0 .28-.041.52-.041.8s.041.52.041.8l-1.718 1.32a.367.367 0 00-.082.52l1.636 2.76a.4.4 0 00.491.16l2.046-.8a5.954 5.954 0 001.391.8l.327 2.12a.4.4 0 00.409.32h3.273a.438.438 0 00.409-.32l.328-2.12a6.924 6.924 0 001.391-.8l2.046.8a.383.383 0 00.491-.16l1.636-2.76a.482.482 0 00-.082-.52zm-6.1 2a2.8 2.8 0 112.868-2.8 2.815 2.815 0 01-2.864 2.8z", "data-name": "Path 1163", transform: "translate(-47.998 -48.001)" })));
}
...
function SkillWalletNavSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 16 14.769" },
        React__default["default"].createElement("g", { "data-name": "Group 1260", transform: "translate(-142.231 -344.268)" },
            React__default["default"].createElement("path", { d: "M53.95 74.665V68.1a1.641 1.641 0 011.642-1.642h7.577v-.819A1.636 1.636 0 0061.542 64h-11.85A1.662 1.662 0 0048 65.615v11.539a1.662 1.662 0 001.692 1.615h11.846a1.633 1.633 0 001.627-1.642v-.819h-7.577a1.641 1.641 0 01-1.638-1.642z", "data-name": "Path 1164", transform: "translate(94.231 280.268)" }),
            React__default["default"].createElement("path", { d: "M245 170.615v5.38a.617.617 0 00.615.615h7.185a.617.617 0 00.615-.615v-5.38a.617.617 0 00-.615-.615h-7.186a.617.617 0 00-.614.615zm2.963 3.916a1.23 1.23 0 111.149-1.149 1.23 1.23 0 01-1.149 1.148z", "data-name": "Path 1165", transform: "translate(-95.184 178.348)" }))));
}
...
function FooterShareSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 32 32.003" },
        React__default["default"].createElement("g", { transform: "translate(-8.243 155.5)" },
            React__default["default"].createElement("path", { d: "M31.167 15.167a5.333 5.333 0 10-5.292-4.676L13.537 16.66a5.333 5.333 0 100 7.679l12.338 6.169a5.333 5.333 0 101.592-3.18l-12.338-6.169a5.387 5.387 0 000-1.316l12.338-6.169a5.307 5.307 0 003.7 1.493z", "data-name": "Path 1494", transform: "translate(3.742 -160)" }))));
}
...
function LogoffSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 16 15.707" },
        React__default["default"].createElement("g", { "data-name": "Group 26", transform: "translate(-1)" },
            React__default["default"].createElement("path", { d: "M192 163.208h5.184l-1.192 1.222.817.817 2.624-2.624L196.81 160l-.847.817 1.222 1.222H192z", "data-name": "Path 1077", transform: "translate(-182.434 -154.77)" }),
            React__default["default"].createElement("path", { d: "M55.871 62.1a6.241 6.241 0 114.415-10.663l1.148-1.144a8.369 8.369 0 00-1.05-.876 7.849 7.849 0 101.046 12l-1.144-1.14a6.214 6.214 0 01-4.415 1.82zm7.287-6.209l-.032-.032.032-.032.032.032z", "data-name": "Path 1078", transform: "translate(-47 -48)" }))));
}
...
function MilestonesCompletedSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 21.5 21.5" },
        React__default["default"].createElement("path", { d: "M0 0v21.5h21.5V7.6l-3.527 3.527v6.844H3.527V3.527h6.844L13.9 0zm18.454.272l-7.779 7.78L7.9 5.272 5.046 8.124l5.629 5.628 2.85-2.85 7.775-7.78-2.846-2.85z" })));
}
...
function MilestonesSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 13.277 3.319" },
        React__default["default"].createElement("path", { d: "M11.618 0A1.661 1.661 0 0010.1 1H8.159a1.658 1.658 0 00-3.041 0H3.18a1.66 1.66 0 100 1.328h1.938a1.658 1.658 0 003.041 0H10.1A1.659 1.659 0 1011.618 0z" })));
}
...
function ParticipationRateSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 23 23" },
        React__default["default"].createElement("g", { transform: "translate(-2.25 -2.25)" },
            React__default["default"].createElement("path", { d: "M3.893 22.5v1.643H7.66l-5.41 5.41 1.162 1.162 5.41-5.41v3.767h1.643V22.5z", "data-name": "Path 1580", transform: "translate(0 -5.464)" }),
            React__default["default"].createElement("path", { d: "M27.071 4.5h-5.75v1.643h2.945l-6.231 6.231-3.526-3.527a.821.821 0 00-1.162 0L9 13.2l1.162 1.162 3.767-3.767 3.527 3.527a.821.821 0 001.162 0L25.429 7.3v2.95h1.643z", "data-name": "Path 1581", transform: "translate(-1.821 -.607)" }),
            React__default["default"].createElement("path", { d: "M18 31.5h11.5v1.643H18z", "data-name": "Path 1582", transform: "translate(-4.25 -7.893)" }),
            React__default["default"].createElement("path", { d: "M2.25 2.25h1.643v11.5H2.25z", "data-name": "Path 1583" }))));
}
...
function ScoreReachedSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 13.278 16.73" },
        React__default["default"].createElement("g", { transform: "translate(-.001)", style: { isolation: "isolate" } },
            React__default["default"].createElement("path", { d: "M4.078 7.03a2.39 2.39 0 10-2.39-2.39 2.39 2.39 0 002.39 2.39zm0-3.585A1.195 1.195 0 112.883 4.64a1.195 1.195 0 011.195-1.195z", "data-name": "Path 1529", transform: "translate(-1.687 -2.25)" }),
            React__default["default"].createElement("path", { d: "M15.89 2.25a2.39 2.39 0 102.39 2.39 2.39 2.39 0 00-2.39-2.39zm0 3.585a1.195 1.195 0 111.195-1.195 1.195 1.195 0 01-1.195 1.195z", "data-name": "Path 1530", transform: "translate(-9.251 -2.25)" }),
            React__default["default"].createElement("path", { d: "M27.7 7.03a2.39 2.39 0 10-2.39-2.39 2.39 2.39 0 002.39 2.39zm0-3.585a1.195 1.195 0 11-1.192 1.195A1.195 1.195 0 0127.7 3.445z", "data-name": "Path 1531", transform: "translate(-16.814 -2.25)" }),
            React__default["default"].createElement("path", { d: "M4.078 13.5a2.39 2.39 0 102.39 2.39 2.39 2.39 0 00-2.39-2.39zm0 3.585a1.195 1.195 0 111.195-1.195 1.195 1.195 0 01-1.195 1.195z", "data-name": "Path 1532", transform: "translate(-1.687 -7.525)" }),
            React__default["default"].createElement("path", { d: "M15.89 13.5a2.39 2.39 0 102.39 2.39 2.39 2.39 0 00-2.39-2.39zm0 3.585a1.195 1.195 0 111.195-1.195 1.195 1.195 0 01-1.195 1.195z", "data-name": "Path 1533", transform: "translate(-9.251 -7.525)" }),
            React__default["default"].createElement("path", { d: "M27.7 13.5a2.39 2.39 0 102.39 2.39 2.39 2.39 0 00-2.39-2.39zm0 3.585a1.195 1.195 0 111.2-1.195 1.195 1.195 0 01-1.2 1.195z", "data-name": "Path 1534", transform: "translate(-16.814 -7.525)" }),
            React__default["default"].createElement("path", { d: "M27.7 24.75a2.39 2.39 0 102.39 2.39 2.39 2.39 0 00-2.39-2.39zm0 3.585a1.195 1.195 0 111.2-1.195 1.195 1.195 0 01-1.2 1.195z", "data-name": "Path 1535", transform: "translate(-16.814 -12.8)" }),
            React__default["default"].createElement("path", { d: "M3.938 28.688h1.195v1.195H3.938z", "data-name": "Path 1536", transform: "translate(-2.742 -14.647)" }),
            React__default["default"].createElement("path", { d: "M10.688 28.688h1.195v1.195h-1.195z", "data-name": "Path 1537", transform: "translate(-7.107 -14.647)" }),
            React__default["default"].createElement("path", { d: "M17.438 28.688h1.195v1.195h-1.195z", "data-name": "Path 1538", transform: "translate(-11.172 -14.647)" }))));
}
...
function LayerBlurSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 1366 768" },
        React__default["default"].createElement("g", { fill: "#fff", stroke: "#707070", strokeWidth: "1", "data-name": "Rectangle 1780" },
            React__default["default"].createElement("path", { stroke: "none", d: "M0 0H1366V768H0z" }),
            React__default["default"].createElement("path", { fill: "none", d: "M0.5 0.5H1365.5V767.5H0.5z" }))));
}
...
function Shape1Svg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 234.924 628.344" },
        React__default["default"].createElement("path", { fill: "none", stroke: "#fff", strokeMiterlimit: "10", strokeWidth: "1", d: "M.372.333l234.052 261.7v219.94L45.059 627.949", "data-name": "Path 1589" })));
}
...
function Shape2Svg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 295.059 393.445" },
        React__default["default"].createElement("path", { fill: "none", stroke: "#fff", strokeMiterlimit: "10", strokeWidth: "1", d: "M.469 60.764l233.79-59.759L64.42 148.894l88.592 50.688L238.459 2.674l55.948 189.156-227.948 22.348-65.99 179.1", "data-name": "Path 1590" })));
}
...
function Shape3Svg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 65.596 49.049" },
        React__default["default"].createElement("path", { fill: "none", stroke: "#fff", strokeMiterlimit: "10", strokeWidth: "1", d: "M64.999 0L0 48.245", "data-name": "Line 51", transform: "translate(.299 .402)" })));
}
...
function Shape4Svg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 117.453 66.133" },
        React__default["default"].createElement("g", { "data-name": "Group 1816", transform: "translate(.502 .383)" },
...
function Shape5Svg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 74.281 173.434" },
        React__default["default"].createElement("g", { fill: "none", stroke: "#fff", strokeMiterlimit: "10", strokeWidth: "1", "data-name": "Group 1817", transform: "translate(.5 .936)" },
...
function Shape6Svg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { height: height, width: width }, className: className, viewBox: "0 0 374.127 223.264" },
        React__default["default"].createElement("path", { fill: "none", stroke: "#fff", strokeMiterlimit: "10", strokeWidth: "1", d: "M373.805 123.53L227.152.675.352 222.907", "data-name": "Path 1591" })));
}
...
function Shape7Svg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "64.363", height: "128.725", "data-name": "Group 1815", viewBox: "0 0 64.363 128.725" },
...
function DitoCreditsSuccessSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { style: { height: height, width: width }, className: className, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 60.286 41.332" },
        React__default["default"].createElement("g", { stroke: "#fff", strokeWidth: "1", "data-name": "Group 17", transform: "translate(.5 .5)" },
            React__default["default"].createElement("path", { d: "M292.678 317.919v7.4c0 2.513-6.7 4.608-14.941 4.608s-14.8-2.025-14.8-4.538v-.838l-.14-5.865h.07c1.117 2.164 7.261 3.84 14.661 3.84s15.011-2.094 15.011-4.608h.14z", "data-name": "Path 179", transform: "translate(-233.392 -289.596)" }),
            React__default["default"].createElement("path", { d: "M175.928 112.074v7.326h-.14c0 2.583-6.912 4.608-15.08 4.608a35.831 35.831 0 01-9.425-1.047l-.14.14a16.313 16.313 0 00-5.166-2.862v-.14l-.209-7.75c.489 2.374 6.982 4.259 14.871 4.259s15.15-2.025 15.15-4.538z", "data-name": "Path 180", transform: "translate(-129.483 -107.604)" }),
            React__default["default"].createElement("path", { d: "M175.929 83.234h0c0 2.513-6.912 4.538-15.15 4.538s-14.452-1.885-14.941-4.259c0-.07-.07-.209-.07-.279 0-2.513 6.7-4.608 15.011-4.608 8.308-.07 15.15 2.025 15.15 4.608z", "data-name": "Path 181", transform: "translate(-129.484 -78.624)" }),
            React__default["default"].createElement("path", { d: "M261.942 270.946h0l-.064-1.408-.127-5.761c.446 2.177 6.368 3.9 13.564 3.9s13.564-1.856 13.755-4.1h.064v6.658h-.127c0 2.3-6.177 4.225-13.691 4.225s-12.355-1.53-13.374-3.514z", "data-name": "Path 182", transform: "translate(-229.847 -240.921)" }),
            React__default["default"].createElement("path", { d: "M188.608 317.028a14.98 14.98 0 004.119-6.423h.349c1.536.14 3.072.209 4.748.209h.7v1.536l.14 5.865h-.768a36.177 36.177 0 01-9.076-.977z", "data-name": "Path 183", transform: "translate(-166.025 -283.259)" }),
            React__default["default"].createElement("path", { d: "M225.75 255.089v.349l.14 6.493h-.7c-1.745 0-3.351-.07-4.887-.209h-.349a14.328 14.328 0 00.7-4.538 14.13 14.13 0 00-.349-3h.349c1.466.14 2.932.209 4.538.209l.628.349a.759.759 0 00-.07.347z", "data-name": "Path 184", transform: "translate(-193.405 -233.087)" }),
            React__default["default"].createElement("path", { d: "M186.137 170.492a35.831 35.831 0 009.425 1.047c8.168 0 15.08-2.025 15.08-4.608h.14v8.238c-7.61 0-13.824 1.815-14.592 4.119l-.628-.349q-2.3 0-4.4-.209h-.349a14.092 14.092 0 00-4.813-8.169z", "data-name": "Path 185", transform: "translate(-164.673 -156.494)" }),
            React__default["default"].createElement("g", { "data-name": "Group 16", transform: "translate(0 8.006)" },
                React__default["default"].createElement("path", { d: "M29.812 177.822h0a15.281 15.281 0 00-4.957-8.308 13.267 13.267 0 00-5.306-2.932 13.487 13.487 0 00-4.4-.7 15.011 15.011 0 10-.279 30.021 15.314 15.314 0 0010.333-3.98 15.161 15.161 0 004.189-6.633 13.9 13.9 0 00.7-4.468c0-.975-.28-2.022-.28-3z", "data-name": "Path 186", transform: "translate(0 -165.883)" }),
                React__default["default"].createElement("path", { d: "M291.7 233.119v.14c-.209 2.444-6.982 4.468-15.08 4.468s-14.382-1.885-14.871-4.259v-.349a.886.886 0 01.07-.419c.768-2.3 6.982-4.119 14.592-4.119h.209c8.24 0 15.08 2.025 15.08 4.538z", "data-name": "Path 187", transform: "translate(-232.487 -220.202)" })),
            React__default["default"].createElement("path", { d: "M80.319 204.811a2.3 2.3 0 112.3-2.3 1.4 1.4 0 002.793 0 5.153 5.153 0 00-3.7-4.887v-.559a1.4 1.4 0 10-2.793 0v.559a4.876 4.876 0 00-3.7 4.887 5.125 5.125 0 005.1 5.1 2.3 2.3 0 110 4.608h0a2.324 2.324 0 01-2.3-2.3 1.4 1.4 0 10-2.793 0 5.089 5.089 0 003.7 4.887v1.117a1.4 1.4 0 002.793 0v-1.117a5.035 5.035 0 003.421-6.353 5.091 5.091 0 00-4.821-3.642z", "data-name": "Path 188", transform: "translate(-66.216 -182.583)" }))));
}
...
function DitoCreditsSuccessLogoSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { style: { height: height, width: width }, className: className, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 167 114.472" },
        React__default["default"].createElement("g", { stroke: "#fff", "data-name": "Tesseract Credits - Icon - Black - New", transform: "translate(.5 .501)" },
            React__default["default"].createElement("path", { strokeWidth: "1", d: "M166 84.302v17.981c0 6.1-16.2 11.193-36.118 11.193s-35.781-4.918-35.781-11.024v-2.039l-.338-14.245h.169c2.7 5.257 17.553 9.327 35.443 9.327s36.287-5.087 36.287-11.192h.337z", "data-name": "Path 179" }),
            React__default["default"].createElement("path", { strokeWidth: "1", d: "M124.96 10.858v17.807h-.338c0 6.275-16.708 11.193-36.456 11.193a86.22 86.22 0 01-22.785-2.544l-.338.339A39.378 39.378 0 0052.554 30.7v-.339l-.506-18.824c1.181 5.766 16.878 10.345 35.95 10.345s36.624-4.918 36.624-11.023z", "data-name": "Path 180" }),
            React__default["default"].createElement("path", { strokeWidth: "1", d: "M124.959 11.197h0c0 6.105-16.709 11.023-36.624 11.023s-34.937-4.578-36.118-10.344c0-.169-.169-.509-.169-.678 0-6.105 16.2-11.193 36.287-11.193 20.084-.17 36.624 4.918 36.624 11.192z", "data-name": "Path 181" }),
            React__default["default"].createElement("path", { strokeWidth: "1", d: "M89.866 84.478h0l-.178-3.963-.357-16.209c1.248 6.124 17.83 10.986 37.978 10.986s37.978-5.223 38.513-11.527H166v18.731h-.357c0 6.484-17.295 11.887-38.335 11.887s-34.589-4.325-37.442-9.905z", "data-name": "Path 182" }),
            React__default["default"].createElement("path", { strokeWidth: "1", d: "M64.997 97.53a36.405 36.405 0 009.957-15.6h.844c3.713.339 7.426.509 11.477.509h1.688v3.731l.338 14.246h-1.857a87.057 87.057 0 01-21.941-2.374z", "data-name": "Path 183" }),
            React__default["default"].createElement("path", { strokeWidth: "1", d: "M89.477 63.48v.848l.337 15.767h-1.688c-4.22 0-8.1-.169-11.814-.509h-.844a34.961 34.961 0 001.688-11.023 34.476 34.476 0 00-.844-7.292h.844c3.544.339 7.088.509 10.97.509l1.519.848a1.848 1.848 0 00-.168.852z", "data-name": "Path 184" }),
            React__default["default"].createElement("path", { strokeWidth: "1", d: "M65.904 39.786a86.215 86.215 0 0022.785 2.544c19.747 0 36.456-4.918 36.456-11.193h.337v20.011c-18.4 0-33.418 4.409-35.275 10.006l-1.519-.848q-5.57 0-10.633-.508h-.844A34.262 34.262 0 0065.57 39.956z", "data-name": "Path 185" }),
            React__default["default"].createElement("g", { "data-name": "Group 16", transform: "translate(0 34.951)" },
                React__default["default"].createElement("path", { strokeWidth: "1", d: "M72.069 29h0A37.154 37.154 0 0060.086 8.817a32.026 32.026 0 00-12.827-7.123 32.461 32.461 0 00-10.633-1.7 36.463 36.463 0 00-.675 72.922 36.444 36.444 0 0035.106-25.777 33.92 33.92 0 001.688-10.853c-.001-2.369-.676-4.912-.676-7.286z", "data-name": "Path 186" }),
                React__default["default"].createElement("path", { strokeWidth: "1", d: "M165.831 31.371v.339c-.506 5.935-16.877 10.854-36.456 10.854s-34.768-4.579-35.95-10.345v-.848a2.159 2.159 0 01.169-1.018c1.856-5.6 16.877-10.005 35.274-10.005h.506c19.918.003 36.457 4.923 36.457 11.023z", "data-name": "Path 187" }),
                React__default["default"].createElement("g", { fill: "none", strokeMiterlimit: "10", strokeWidth: "0.5", "data-name": "Group 10792", transform: "translate(20.305 22.236)" },
                    React__default["default"].createElement("path", { d: "M0 1.848v23.808l25.392 1.347 7.638-2.416V3.958L25.06 0z", "data-name": "Path 1647" }),
                    React__default["default"].createElement("path", { d: "M0 0L0 24.15", "data-name": "Line 68", transform: "translate(6.125 1.847)" }),
                    React__default["default"].createElement("path", { d: "M0 1.849l11.27 2.607 21.761-.5", "data-name": "Path 1648" }),
                    React__default["default"].createElement("path", { d: "M9.257 1.165l2.013 3.29v19.612l-1.508 2.106", "data-name": "Path 1649" }),
                    React__default["default"].createElement("path", { d: "M0 25.654l11.27-1.589 21.761-.225", "data-name": "Path 1650" }),
                    React__default["default"].createElement("path", { d: "M0 0L0.218 26.832", "data-name": "Line 69", transform: "translate(24.279 .02)" }))))));
}
...
function DitoCreditsNewSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: __assign$2({ height: height, width: width }, (sx || {})), className: className, viewBox: "0 0 26.5 18.188" },
        React__default["default"].createElement("g", { fill: "#fff", stroke: "#000", strokeWidth: "0.5", "data-name": "Credits - Icon - White", transform: "translate(.25 .25)" },
            React__default["default"].createElement("path", { d: "M26 13.141v2.8c0 .952-2.538 1.745-5.657 1.745s-5.6-.767-5.6-1.718v-.317l-.053-2.221h.026c.423.819 2.749 1.454 5.551 1.454s5.684-.793 5.684-1.745h.053z", "data-name": "Path 179" }),
            React__default["default"].createElement("path", { d: "M19.572 1.692v2.776h-.053c0 .978-2.617 1.745-5.71 1.745a13.566 13.566 0 01-3.569-.4l-.053.053a6.176 6.176 0 00-1.956-1.084v-.053l-.079-2.934c.185.9 2.644 1.613 5.631 1.613s5.736-.767 5.736-1.718z", "data-name": "Path 180" }),
            React__default["default"].createElement("path", { d: "M19.572 1.746h0c0 .952-2.617 1.718-5.736 1.718S8.364 2.75 8.179 1.851c0-.026-.026-.079-.026-.106C8.153.793 10.691 0 13.837 0c3.147-.024 5.735.768 5.735 1.746z", "data-name": "Path 181" }),
            React__default["default"].createElement("path", { d: "M14.076 13.168h0l-.028-.618-.056-2.527c.2.955 2.793 1.713 5.948 1.713s5.948-.814 6.032-1.8H26v2.92h-.059c0 1.011-2.709 1.853-6 1.853s-5.418-.671-5.865-1.541z", "data-name": "Path 182" }),
            React__default["default"].createElement("path", { d: "M10.18 15.203a5.671 5.671 0 001.56-2.432h.132c.582.053 1.163.079 1.8.079h.264v.582l.053 2.221h-.291a13.7 13.7 0 01-3.437-.37z", "data-name": "Path 183" }),
            React__default["default"].createElement("path", { d: "M14.014 9.896v.132l.053 2.458h-.264c-.661 0-1.269-.026-1.85-.079h-.132a5.425 5.425 0 00.264-1.718 5.35 5.35 0 00-.132-1.137h.132c.555.053 1.11.079 1.718.079l.238.132a.287.287 0 00-.027.133z", "data-name": "Path 184" }),
            React__default["default"].createElement("path", { d: "M10.322 6.201a13.565 13.565 0 003.569.4c3.093 0 5.71-.767 5.71-1.745h.053v3.119c-2.881 0-5.234.687-5.525 1.56l-.238-.132q-.872 0-1.665-.079h-.132a5.335 5.335 0 00-1.822-3.096z", "data-name": "Path 185" }),
            React__default["default"].createElement("g", { "data-name": "Group 16", transform: "translate(0 5.448)" },
                React__default["default"].createElement("path", { d: "M11.288 4.517h0a5.786 5.786 0 00-1.877-3.146A5.023 5.023 0 007.402.261a5.106 5.106 0 00-1.665-.264 5.684 5.684 0 10-.106 11.367 5.8 5.8 0 003.912-1.507 5.741 5.741 0 001.586-2.511 5.264 5.264 0 00.264-1.692c.001-.367-.105-.763-.105-1.137z", "data-name": "Path 186" }),
                React__default["default"].createElement("path", { d: "M25.974 4.891v.053c-.079.925-2.643 1.692-5.71 1.692s-5.446-.714-5.631-1.613v-.132a.335.335 0 01.026-.159c.291-.872 2.643-1.56 5.525-1.56h.079c3.119 0 5.711.767 5.711 1.719z", "data-name": "Path 187" })))));
}
...
function ArchitectureSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: width, height: height, viewBox: "0 0 17.577 19.463" },
        React__default["default"].createElement("path", { d: "M21.213 6.822l-8.161-3.766a.628.628 0 00-.527 0L4.364 6.822A.628.628 0 004 7.393v10.672a.628.628 0 00.364.571l8.161 3.764a.628.628 0 00.527 0l8.161-3.767a.628.628 0 00.364-.571V7.393a.628.628 0 00-.364-.571zm-8.424-2.5l6.66 3.076-6.66 3.076-6.661-3.081zM5.256 8.373l6.905 3.189v9.291l-6.905-3.19zm8.161 12.48v-9.291l6.905-3.189v9.291z", transform: "translate(-4 -2.998)" })));
}
...
function BlockchainSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: width, height: height, viewBox: "0 0 10.436 17.577" },
        React__default["default"].createElement("path", { d: "M10.433 8.953l-5.215 3.186L0 8.953 5.218 0zm-5.215 4.209L0 9.976l5.218 7.6 5.218-7.6-5.218 3.186z", "data-name": "Icon awesome-ethereum" })));
}
...
function DefiSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: width, height: height, viewBox: "0 0 13.183 17.577" },
        React__default["default"].createElement("path", { d: "M22.183 6H9v2.2l7.141 6.591L9 21.38v2.2h13.183v-3.3h-7.69l5.493-5.493L14.493 9.3h7.69z", "data-name": "Icon material-functions", transform: "translate(-9 -6)" })));
}
...
function FrontendSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: width, height: height, viewBox: "0 0 17.577 17.577" },
        React__default["default"].createElement("path", { fillRule: "evenodd", d: "M0 2.2A2.2 2.2 0 012.2 0h8.789a2.2 2.2 0 012.2 2.2v2.2h2.2a2.2 2.2 0 012.2 2.2v8.78a2.2 2.2 0 01-2.2 2.2H6.591a2.2 2.2 0 01-2.2-2.2v-2.2H2.2a2.2 2.2 0 01-2.2-2.2zm5.493 10.983v2.2a1.1 1.1 0 001.1 1.1h8.787a1.1 1.1 0 001.1-1.1V6.591a1.1 1.1 0 00-1.1-1.1h-2.2v5.493a2.2 2.2 0 01-2.2 2.2z", "data-name": "Path 1468" })));
}
...
function ManagementSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: height, height: width, viewBox: "0 0 26.746 23.402" },
        React__default["default"].createElement("path", { id: "Icon_awesome-briefcase", "data-name": "Icon awesome-briefcase", d: "M16.716,18.13a.836.836,0,0,1-.836.836H10.865a.836.836,0,0,1-.836-.836V15.623H0v7.522a2.571,2.571,0,0,0,2.507,2.507H24.238a2.571,2.571,0,0,0,2.507-2.507V15.623H16.716ZM24.238,7.265H20.059V4.757A2.571,2.571,0,0,0,17.552,2.25H9.194A2.571,2.571,0,0,0,6.686,4.757V7.265H2.507A2.571,2.571,0,0,0,0,9.772v4.179H26.746V9.772A2.571,2.571,0,0,0,24.238,7.265Zm-7.522,0H10.03V5.593h6.686Z", transform: "translate(0 -2.25)" })));
}
...
function MobileSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: width, height: height, viewBox: "0 0 13.671 21.873" },
        React__default["default"].createElement("path", { d: "M11.62 0H2.051A2.051 2.051 0 000 2.051v17.771a2.051 2.051 0 002.051 2.051h9.569a2.051 2.051 0 002.051-2.051V2.051A2.051 2.051 0 0011.62 0zM6.835 20.506A1.367 1.367 0 118.2 19.139a1.366 1.366 0 01-1.365 1.367zm4.785-4.614a.514.514 0 01-.513.513H2.563a.514.514 0 01-.513-.513V2.563a.514.514 0 01.513-.513h8.544a.514.514 0 01.513.513z", "data-name": "Icon awesome-mobile-alt" })));
}
...
function WebDevSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: width, height: height, viewBox: "0 0 22.467 19.971" },
        React__default["default"].createElement("path", { d: "M20.595 0H1.872A1.873 1.873 0 000 1.872v12.482a1.873 1.873 0 001.872 1.872h7.489L8.737 18.1H5.929a.936.936 0 100 1.872h10.609a.936.936 0 000-1.872H13.73l-.624-1.872h7.489a1.873 1.873 0 001.872-1.872V1.872A1.873 1.873 0 0020.595 0zm-.624 13.73H2.5V2.5h17.471z", "data-name": "Icon awesome-desktop" })));
}
...
function PhotographySvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: width, height: height, viewBox: "0 0 23.341 17.577" },
        React__default["default"].createElement("path", { d: "M7.6 4.445L6.865 7.4H0v14.622h23.341V7.4H16.8l-.735-2.953zm4.13 2.947a6.564 6.564 0 11-6.564 6.564 6.563 6.563 0 016.564-6.564zm7.7 1.429h3.309v1.921h-3.312V8.821zm-7.7.51a4.625 4.625 0 104.625 4.625 4.625 4.625 0 00-4.625-4.625z", transform: "translate(0 -4.445)" })));
}
...
function SmartContractsSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: width, height: height, viewBox: "0 0 19.827 19.827" },
        React__default["default"].createElement("g", { transform: "translate(1.125 1.125)" },
            React__default["default"].createElement("path", { stroke: "#000", strokeLinejoin: "round", strokeWidth: "2.25", d: "M13.3 15.542V1.014A1.009 1.009 0 0012.3 0H.998a1.009 1.009 0 00-1 1.014v14.873a1.681 1.681 0 001.663 1.69h13.634", "data-name": "Path 1479" }),
            React__default["default"].createElement("path", { stroke: "#000", strokeLinejoin: "round", strokeWidth: "2.25", d: "M15.295 17.576h0a2.282 2.282 0 01-2.282-2.282V1.605h3.425a1.141 1.141 0 011.141 1.141v12.549a2.282 2.282 0 01-2.282 2.282z", "data-name": "Path 1480" }),
            React__default["default"].createElement("path", { stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2.25", d: "M7.928 3.803h3.042", "data-name": "Path 1481" }),
            React__default["default"].createElement("path", { stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2.25", d: "M7.928 6.084h3.042", "data-name": "Path 1482" }),
            React__default["default"].createElement("path", { stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2.25", d: "M2.414 8.788h9.125", "data-name": "Path 1483" }),
            React__default["default"].createElement("path", { stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2.25", d: "M2.414 11.492h9.125", "data-name": "Path 1484" }),
            React__default["default"].createElement("path", { stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2.25", d: "M2.414 13.774h9.125", "data-name": "Path 1485" }),
            React__default["default"].createElement("path", { d: "M10.553 12.438H7.511a.761.761 0 01-.761-.761V8.636a.761.761 0 01.761-.761h3.042a.761.761 0 01.761.761v3.042a.761.761 0 01-.761.76z", "data-name": "Path 1486", transform: "translate(-4.468 -5.272)" }))));
}
...
function TokenomicsSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: width, height: height, viewBox: "0 0 17.577 17.577" },
        React__default["default"].createElement("path", { d: "M14.789 11.112c4.368 0 8.789-1.393 8.789-4.056S19.156 3 14.789 3 6 4.393 6 7.056s4.421 4.056 8.789 4.056z", "data-name": "Path 1469", transform: "translate(-6 -3)" }),
        React__default["default"].createElement("path", { d: "M6 20.028c0 2.663 4.421 4.056 8.789 4.056s8.789-1.393 8.789-4.056V18c0 2.663-4.421 4.056-8.789 4.056S6 20.663 6 18z", "data-name": "Path 1471", transform: "translate(-6 -11.104)" }),
        React__default["default"].createElement("path", { d: "M6 26.028c0 2.663 4.421 4.056 8.789 4.056s8.789-1.393 8.789-4.056V24c0 2.663-4.421 4.056-8.789 4.056S6 26.663 6 24z", "data-name": "Path 1472", transform: "translate(-6 -12.507)" })));
}
...
function TrainSportSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: width, height: height, viewBox: "0 0 25.084 19.755" },
        React__default["default"].createElement("path", { d: "M29.171 12.619l-3.923-5.6 1.868-1.309 3.922 5.6z", "data-name": "Path 1474", transform: "translate(-6.514 -5.71)" }),
        React__default["default"].createElement("path", { d: "M23.622 16.409l-2.107-2.985-10.037 6.963 2.107 2.982-2.007 1.393-5.62-7.955 2.007-1.392 2.107 2.985 10.036-6.962L18 8.453l2.007-1.392 5.621 7.953-2.007 1.393z", "data-name": "Path 1475", transform: "translate(-3.252 -6.034)" }),
        React__default["default"].createElement("path", { d: "M30.735 9.622L32.6 8.315l-1.305-1.867-1.867 1.307 1.307 1.867z", "data-name": "Path 1476", transform: "translate(-7.517 -5.887)" }),
        React__default["default"].createElement("path", { d: "M8.922 26.8L5 21.2l-1.868 1.3 3.922 5.6z", "data-name": "Path 1477", transform: "translate(-2.573 -8.35)" }),
        React__default["default"].createElement("path", { d: "M5.57 27.242L3.7 28.549l-1.3-1.867 1.867-1.307z", "data-name": "Path 1478", transform: "translate(-2.396 -9.353)" })));
}
...
function VideoSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: width, height: height, viewBox: "0 0 19.53 12.206" },
        React__default["default"].createElement("path", { fillRule: "evenodd", d: "M3.255 6.75v1.628h6.51v.814H2.441A2.441 2.441 0 000 11.633v4.883a2.441 2.441 0 002.441 2.441h9.765a2.441 2.441 0 002.433-2.239l4.891.612v-6.51l-4.891.611a2.441 2.441 0 00-2.433-2.239h-.814V7.564a.814.814 0 00-.814-.814zm11.393 6.32v2.008l3.255.407v-2.822zm-1.628-1.437a.814.814 0 00-.814-.814H2.441a.814.814 0 00-.814.814v4.883a.814.814 0 00.814.814h9.765a.814.814 0 00.814-.814z", "data-name": "Path 1473", transform: "translate(0 -6.75)" })));
}

var ProgressBarWrapper = material.styled("div")(function (_a) {
    _a.theme;
    return "\nposition: relative;\n\n.MuiLinearProgress-root {\n  &:after {\n    transition: width .4s linear;\n  }\n}\n\n.sw-progress-bar-label {\n  position: absolute;\n  z-index: 1;\n  top: 0;\n  left: 50%;\n  transform: translateX(-50%);\n  transition: color .4s linear;\n  line-height: 22px;\n}\n\n";
});
var NoBorderLinearProgress = material.styled(material.LinearProgress)(function (_a) {
    var _b;
    ...
    return _b = {
        ...
        _b["&.".concat(material.linearProgressClasses.colorPrimary)] = {
            backgroundColor: theme.palette.background.paper,
        },
        _b["& .".concat(material.linearProgressClasses.bar)] = {
            borderRadius: 0,
...
var SwProgressBar = function (_a) {
    ...
    return (React__default["default"].createElement(ProgressBarWrapper, { className: "sw-progress-bar" },
        React__default["default"].createElement(NoBorderLinearProgress, __assign$2({}, rest, { variant: variant, value: percentage })),
        React__default["default"].createElement(material.Typography, { className: "sw-progress-bar-label", sx: {
                color: +percentage < 45
                    ? "primary.main"
...
var ShareButton = /** @class */ (function (_super) {
    ...
    ShareButton.prototype.render = function () {
        ...
        return (React__default["default"].createElement("button", __assign$1({}, rest, { "aria-label": rest['aria-label'] || networkName, className: newClassName, onClick: this.handleClick, ref: forwardedRef, style: newStyle }), children));
    };
...
function createShareButton(networkName, link, optsMap, defaultProps) {
    function CreatedButton(props, ref) {
        ...
        return (React__default["default"].createElement(ShareButton$1, __assign({}, defaultProps, passedProps, { forwardedRef: ref, networkName: networkName, networkLink: link, opts: optsMap(props) })));
    }
...
var CopyWrapper = material.styled("div")(function (_a) {
    var theme = _a.theme;
    return "\n  display: flex;\n  align-content: center;\n  text-transform: none;\n  width: 100%;\n  justify-content: space-between;\n  line-height: 48px;\n  height: 48px;\n  border-width: 1px;\n  border-style: solid;\n  padding: 0 15px;\n  margin-top: 5px;\n  align-items: center;\n  cursor: pointer;\n\n  &.dark {\n    background-color: ".concat(theme.palette.background.paper, " !important;\n  }\n\n  &.light {\n    border: 1px solid ").concat(theme.palette.primary.main, ";\n  }\n");
});
function SwClipboardCopy(_a) {
    var url = _a.url, mode = _a.mode, _b = _a.sx, sx = _b === void 0 ? {} : _b, _c = _a.trim, trim = _c === void 0 ? function (v) { return v; } : _c;
    ...
    return (React__default["default"].createElement(CopyWrapper, { style: sx, className: "copy-wrapper ".concat(mode), onClick: handleCopyClick },
        React__default["default"].createElement(material.Typography, { variant: "h4", sx: {
                textAlign: "center",
                flex: 1,
            }, color: "info.dark", component: "span" }, trim(url)),
        React__default["default"].createElement("div", { className: "copy-text", style: {
                transition: "all 0.3s ease-in",
                opacity: isCopied ? "0.7" : "1",
            } },
            React__default["default"].createElement(material.Typography, { variant: "h4", color: "info.dark", component: "span" }, isCopied ? "Copied!" : "COPY"))));
}
...
function SwShare(props) {
    ...
    return (React__default["default"].createElement(material.Dialog, { onClose: handleClose, fullScreen: fullScreen, open: open, sx: __assign$2({}, (dialogsx || {})) },
        React__default["default"].createElement(material.DialogContent, { sx: __assign$2({ width: "450px", height: "370px", display: "flex", position: "relative", flexDirection: "column", borderWidth: "2px", padding: "35px 30px", bgcolor: mode === "light" ? "background.paper" : "primary.main", borderColor: mode === "light" ? "primary.main" : "background.paper" }, (sx || {})) },
            React__default["default"].createElement(CloseIcon__default["default"], { onClick: handleClose, sx: {
                    position: "absolute",
                    cursor: "pointer",
                    top: 8,
                    right: 8,
            ...
            React__default["default"].createElement(material.Typography, { variant: "h1", color: mode === "light" ? "primary.main" : "text.primary", textAlign: "center", component: "span" }, "Share"),
            ...
            React__default["default"].createElement("div", { className: "links", style: {
                    display: "flex",
                    justifyContent: "space-between",
                    width: "330px",
                    margin: "10px auto 0 auto",
                } },
                React__default["default"].createElement(LinkedinShareButton$1, __assign$2({ url: url, className: "social-button" }, linkedinProps),
                    React__default["default"].createElement(LinkedInIcon__default["default"], { sx: {
                            width: "85px",
                            height: "85px",
                            color: mode === "light" ? "primary.main" : "text.primary",
                        } })),
                React__default["default"].createElement(TelegramShareButton$1, __assign$2({ url: url, className: "social-button" }, telegramProps),
                    React__default["default"].createElement(TelegramIcon__default["default"], { sx: {
                            width: "85px",
                            height: "85px",
                            color: mode === "light" ? "primary.main" : "text.primary",
                        } })),
                React__default["default"].createElement(TwitterShareButton$1, __assign$2({ url: url, className: "social-button" }, twitterProps),
                    React__default["default"].createElement(TwitterIcon__default["default"], { sx: {
                            width: "85px",
                            height: "85px",
                            color: mode === "light" ? "primary.main" : "text.primary",
                        } }))),
            React__default["default"].createElement("div", { className: "copy-link", style: {
                    width: "310px",
                ...
                React__default["default"].createElement(SwClipboardCopy, { mode: mode, url: url })))));
}

var CustomizedStepperWrapper = function (mode) {
    return material.styled(material.Box)(function (_a) {
        var theme = _a.theme;
        return "\n.stepper-dots {\n  width: 100%;\n  display: flex;\n  align-items: center;\n  margin: 20px 0;\n\n  .stepper-dot {\n    height: 36px;\n    width: 36px;\n    border-radius: 50%;\n    border: 3px solid ".concat(mode === "light"
            ? theme.palette.background.paper
...
var SwStepper = function (_a) {
    var stepperText = _a.stepperText, title = _a.title, steps = _a.steps, description = _a.description, activeStep = _a.activeStep, _b = _a.descriptionTooltip, descriptionTooltip = _b === void 0 ? null : _b, _c = _a.backButton, backButton = _c === void 0 ? null : _c, _d = _a.nextbutton, nextbutton = _d === void 0 ? null : _d, _e = _a.mode, mode = _e === void 0 ? "light" : _e, _f = _a.dotStyles, dotStyles = _f === void 0 ? {} : _f, _g = _a.maxWidth, maxWidth = _g === void 0 ? "450px" : _g;
    var Wrapper = CustomizedStepperWrapper(mode);
    return (React__default["default"].createElement(Wrapper, { sx: { width: "100%", position: "relative" } },
        stepperText && (React__default["default"].createElement(material.Typography, { className: "stepper-top", sx: { color: mode === "light" ? "text.primary" : "primary.main" }, component: "div", variant: "h1", align: "center" }, stepperText)),
        React__default["default"].createElement(material.MobileStepper, { steps: steps.length, position: "static", activeStep: activeStep, sx: {
                padding: 0,
                height: "40px",
        ...
        React__default["default"].createElement(material.Box, { sx: { maxWidth: maxWidth, width: "100%", margin: "0 auto" } },
            React__default["default"].createElement("div", { key: "stepper-dots", className: "stepper-dots", style: { display: activeStep !== -1 ? "flex" : "none" } }, steps.map(function (_, index) {
                return (React__default["default"].createElement(React.Fragment, { key: index },
                    React__default["default"].createElement("div", { className: "stepper-dot ".concat(index === activeStep ? "active" : ""), style: dotStyles }, index < activeStep && (React__default["default"].createElement(CheckIcon__default["default"], { color: mode === "light" ? "info" : "primary" }))),
                    steps.length - 1 !== index && React__default["default"].createElement("div", { className: "stepper-line" })));
            })),
            title && (React__default["default"].createElement(material.Typography, { sx: {
                    color: mode === "light" ? "text.primary" : "primary.main",
                    textAlign: "center",
                    pb: 1,
                }, component: "div", variant: "h2" }, title)),
            description && (React__default["default"].createElement(material.Typography, { sx: {
                    color: mode === "light" ? "text.primary" : "primary.main",
                    textAlign: "center",
                    pb: 2,
                    m: "0 -20px",
                }, component: "div", variant: "subtitle1" },
                React__default["default"].createElement(material.Badge, { sx: {
                        padding: "0 8px",
                    }, badgeContent: descriptionTooltip && (React__default["default"].createElement(material.Tooltip, { title: descriptionTooltip },
...
var FindTextCenter = function (parentElWidth, offset, metric, font) {
    if (offset === void 0) { offset = 0; }
    if (metric === void 0) { metric = 'width'; }
    if (font === void 0) { font = 'JosefinSans-Regular, Josefin Sans'; }
    var canvas = document.createElement('canvas');
    var middle = parentElWidth / 2;
    return function (text, fontSize) {
        var context = canvas.getContext('2d');
        context.font = "".concat(fontSize, " ").concat(font);
        var metrics = context.measureText(text);
        var size = Number(metrics[metric]);
...
var DrawScaledImage = function (ctx, img, x, y, w, h, offsetX, offsetY) {
...
var GenerateQRCodeImage = function (_a) {
    var text = _a.text, logo = _a.logo, width = _a.width, height = _a.height, logoSize = _a.logoSize, logoWidth = _a.logoWidth, logoHeight = _a.logoHeight, logoBorderWidth = _a.logoBorderWidth;
    return __awaiter$1(void 0, void 0, void 0, function () {
        var wrapper, canvas, ctx, LOGO_SIZE, image, STROKE_OFFSET;
        return __generator$1(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    STROKE_OFFSET = logoBorderWidth / 2;
                    ...
                    return [2 /*return*/, new Promise(function (resolve) {
                            new QRCode(wrapper, {
                                ...
                                onRenderingEnd: function (data, base64) { return resolve(base64); },
                            });
                        })];
            }
        });
...
var SwBackgroundSvg = function () {
    var SVGDomElement = new DOMParser().parseFromString("<svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" width=\"396.276\" height=\"638.311\" viewBox=\"0 0 396.276 638.311\">\n      <defs>\n        <linearGradient id=\"linear-gradient\" x1=\"-348.905\" y1=\"-296.014\" x2=\"-348.897\" y2=\"-296.001\" gradientUnits=\"objectBoundingBox\">\n          <stop offset=\"0\" stop-color=\"#fff\" stop-opacity=\"0\"></stop>\n          <stop offset=\"0.512\" stop-color=\"#d1d1d1\" stop-opacity=\"0.137\"></stop>\n          <stop offset=\"0.917\" stop-color=\"#434342\" stop-opacity=\"0.569\"></stop>\n          <stop offset=\"1\" stop-color=\"#171716\" stop-opacity=\"0.698\"></stop>\n        </linearGradient>\n        <linearGradient id=\"linear-gradient-2\" x1=\"-348.898\" y1=\"-296.495\" x2=\"-348.891\" y2=\"-296.481\" gradientUnits=\"objectBoundingBox\">\n          <stop offset=\"0\" stop-color=\"#fff\" stop-opacity=\"0\"></stop>\n          <stop offset=\"0.546\" stop-color=\"#cacac9\" stop-opacity=\"0.137\"></stop>\n          <stop offset=\"0.977\" stop-color=\"#232322\" stop-opacity=\"0.569\"></stop>\n          <stop offset=\"1\" stop-color=\"#171716\" stop-opacity=\"0.6\"></stop>\n        </linearGradient>\n        <linearGradient id=\"linear-gradient-3\" x1=\"-439.076\" y1=\"-299.909\" x2=\"-439.097\" y2=\"-299.901\" gradientUnits=\"objectBoundingBox\">\n          <stop offset=\"0\" stop-color=\"#fff\" stop-opacity=\"0\"></stop>\n          <stop offset=\"0.721\" stop-color=\"#9f9f9e\" stop-opacity=\"0.125\"></stop>\n          <stop offset=\"1\" stop-color=\"#171716\" stop-opacity=\"0.302\"></stop>\n        </linearGradient>\n        <linearGradient id=\"linear-gradient-4\" x1=\"-426.427\" y1=\"-219.695\" x2=\"-426.413\" y2=\"-219.692\" gradientUnits=\"objectBoundingBox\">\n          <stop offset=\"0\" stop-color=\"#fff\" stop-opacity=\"0\"></stop>\n          <stop offset=\"0.819\" stop-color=\"#525251\" stop-opacity=\"0.298\"></stop>\n          <stop offset=\"1\" stop-color=\"#171716\" stop-opacity=\"0.4\"></stop>\n        </linearGradient>\n        <linearGradient id=\"linear-gradient-5\" x1=\"-117.77\" y1=\"-90.095\" x2=\"-117.773\" y2=\"-90.098\" gradientUnits=\"objectBoundingBox\">\n          <stop offset=\"0\" stop-color=\"#fff\" stop-opacity=\"0\"></stop>\n          <stop offset=\"0.672\" stop-color=\"#c4c4c3\" stop-opacity=\"0.102\"></stop>\n          <stop offset=\"1\" stop-color=\"#171716\" stop-opacity=\"0.4\"></stop>\n        </linearGradient>\n        <linearGradient id=\"linear-gradient-6\" x1=\"-322.219\" y1=\"-229.739\" x2=\"-322.251\" y2=\"-229.724\" xlink:href=\"#linear-gradient-5\"></linearGradient>\n        <linearGradient id=\"linear-gradient-7\" x1=\"-301.658\" y1=\"-482.179\" x2=\"-301.639\" y2=\"-482.248\" xlink:href=\"#linear-gradient-5\"></linearGradient>\n      </defs>\n      <g id=\"Group_5\" data-name=\"Group 5\" transform=\"translate(-247.862 -220.844)\">\n        <g id=\"Group_6\" data-name=\"Group 6\">\n          <g id=\"Group_4\" data-name=\"Group 4\" transform=\"translate(-640.589 -51.697)\">\n            <g id=\"Group_1\" data-name=\"Group 1\" transform=\"translate(888.951 273.041)\">\n              <rect id=\"Rectangle_2206\" data-name=\"Rectangle 2206\" width=\"395.276\" height=\"637.311\" fill=\"#fff\" stroke=\"#000\" stroke-miterlimit=\"10\" stroke-width=\"1\"></rect>\n              <rect id=\"Rectangle_2206-2\" data-name=\"Rectangle 2206\" width=\"383.256\" height=\"623.409\" transform=\"translate(6.01 6.951)\" fill=\"none\" stroke=\"#000\" stroke-miterlimit=\"10\" stroke-width=\"0.502\"></rect>\n            </g>\n            \n            <g id=\"Group_2\" data-name=\"Group 2\" transform=\"translate(1187.08 863.445)\">\n              <g id=\"Group_2-2\" data-name=\"Group 2\" transform=\"translate(25.783 0.078)\">\n                <g id=\"Group_1-2\" data-name=\"Group 1\">\n                  <path id=\"Path_1\" data-name=\"Path 1\" d=\"M1129.754,705.163a5.52,5.52,0,0,0-.839-.343,2.986,2.986,0,0,0-.892-.145,1.521,1.521,0,0,0-.96.28.9.9,0,0,0-.356.747.828.828,0,0,0,.233.6,2.064,2.064,0,0,0,.6.42c.245.118.507.228.783.332a6.436,6.436,0,0,1,.684.295,2.737,2.737,0,0,1,.617.42,1.8,1.8,0,0,1,.435.611,2.209,2.209,0,0,1,.162.892,2.023,2.023,0,0,1-1.141,1.855,2.861,2.861,0,0,1-1.317.28,3.935,3.935,0,0,1-.938-.108,4.088,4.088,0,0,1-.835-.295,6.214,6.214,0,0,1-.684-.384l.446-.788a4.345,4.345,0,0,0,.57.337,3.564,3.564,0,0,0,.674.254,2.679,2.679,0,0,0,.684.093,2.063,2.063,0,0,0,.7-.123,1.338,1.338,0,0,0,.57-.395,1.076,1.076,0,0,0,.228-.714,1,1,0,0,0-.2-.633,1.733,1.733,0,0,0-.528-.44,5.443,5.443,0,0,0-.71-.326,7.144,7.144,0,0,1-.721-.291,3.541,3.541,0,0,1-.664-.4,1.854,1.854,0,0,1-.5-.574,1.68,1.68,0,0,1-.192-.829,1.856,1.856,0,0,1,.285-1.032,1.98,1.98,0,0,1,.783-.694,2.657,2.657,0,0,1,1.141-.276,4.247,4.247,0,0,1,1.279.175,4.9,4.9,0,0,1,.98.425Z\" transform=\"translate(-1125.212 -703.784)\"></path>\n                  <path id=\"Path_2\" data-name=\"Path 2\" d=\"M1131.055,706.831l-.021.373.125-.186,3.068-3.2h1.3l-3.1,3.213,3.276,4.282h-1.275l-2.738-3.64-.632.613v3.027h-1.016v-7.5h1.016Z\" transform=\"translate(-1123.456 -703.772)\"></path>\n                  <path id=\"Path_3\" data-name=\"Path 3\" d=\"M1135.091,703.814h1v7.5h-1Z\" transform=\"translate(-1121.583 -703.772)\"></path>\n                  <path id=\"Path_4\" data-name=\"Path 4\" d=\"M1137.314,703.814h1.006v6.532h3.806v.964h-4.812Z\" transform=\"translate(-1120.758 -703.772)\"></path>\n                  <path id=\"Path_5\" data-name=\"Path 5\" d=\"M1141.935,703.814h1.006v6.532h3.805v.964h-4.812Z\" transform=\"translate(-1119.045 -703.772)\"></path>\n                  <path id=\"Path_6\" data-name=\"Path 6\" d=\"M1125.237,711.839h1.182l2.022,5.723-.177-.062,1.483-3.846.466,1.358-1.99,4.646Zm3.618,0h1l2.208,5.651-.218-.041,1.929-5.608h1.079l-2.945,7.8Z\" transform=\"translate(-1125.237 -700.796)\"></path>\n                  <path id=\"Path_7\" data-name=\"Path 7\" d=\"M1132.028,719.4l3.267-7.807h.062l3.276,7.807h-1.151l-2.446-6.232.714-.466-2.727,6.7Zm1.919-2.842h2.788l.332.87h-3.411Z\" transform=\"translate(-1122.719 -700.889)\"></path>\n                  <path id=\"Path_8\" data-name=\"Path 8\" d=\"M1137.791,711.817h1.006v6.531h3.8v.965h-4.81Z\" transform=\"translate(-1120.582 -700.805)\"></path>\n                  <path id=\"Path_9\" data-name=\"Path 9\" d=\"M1142.412,711.817h1.006v6.531h3.8v.965h-4.81Z\" transform=\"translate(-1118.868 -700.805)\"></path>\n                  <path id=\"Path_10\" data-name=\"Path 10\" d=\"M1147.033,711.817h4.874v.964h-3.867v2.281h3.452v.975h-3.452v2.311h4.011v.965h-5.017Z\" transform=\"translate(-1117.154 -700.805)\"></path>\n                  <path id=\"Path_11\" data-name=\"Path 11\" d=\"M1151.472,711.817h4.987v.964h-2.011v6.532h-1.006v-6.532h-1.97Z\" transform=\"translate(-1115.508 -700.805)\"></path>\n                </g>\n              </g>\n              <g id=\"Group_1928\" data-name=\"Group 1928\">\n                <g id=\"Group_1925\" data-name=\"Group 1925\">\n                  <path id=\"Path_35\" data-name=\"Path 35\" d=\"M1110.709,711.644l-4.28-3.231v2.543s3.12,1.605,3.049,1.557A9.306,9.306,0,0,1,1110.709,711.644Z\" transform=\"translate(-1106.429 -701.989)\" fill=\"url(#linear-gradient)\"></path>\n                  <path id=\"Path_36\" data-name=\"Path 36\" d=\"M1110.709,711l-4.28,3.23V711.69s3.12-1.607,3.049-1.557A9.439,9.439,0,0,0,1110.709,711Z\" transform=\"translate(-1106.429 -701.352)\" fill=\"url(#linear-gradient-2)\"></path>\n                  <path id=\"Path_37\" data-name=\"Path 37\" d=\"M1113.3,715.076l-2.189,3.829,2.57.033.838-4.07Z\" transform=\"translate(-1104.691 -699.595)\" fill=\"url(#linear-gradient-3)\"></path>\n                  <path id=\"Path_38\" data-name=\"Path 38\" d=\"M1116.754,719.313l-3.139-5.477-.381,1.849,1.593,3.627Z\" transform=\"translate(-1103.905 -699.978)\" fill=\"url(#linear-gradient-4)\"></path>\n                  <path id=\"Path_39\" data-name=\"Path 39\" d=\"M1111.115,703.75l3.848,8.176,9,4.735.015-2.586-7.456-3.42-2.838-6.842Z\" transform=\"translate(-1104.691 -703.718)\" fill=\"url(#linear-gradient-5)\"></path>\n                  <rect id=\"Rectangle_41-2\" data-name=\"Rectangle 41\" width=\"6.424\" height=\"6.424\" transform=\"translate(0 12.911)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_42-2\" data-name=\"Rectangle 42\" width=\"3.854\" height=\"3.854\" transform=\"translate(1.285 14.196)\" fill=\"#fff\"></rect>\n                  <circle id=\"Ellipse_4\" data-name=\"Ellipse 4\" cx=\"0.642\" cy=\"0.642\" r=\"0.642\" transform=\"translate(2.57 15.48)\" fill=\"#040506\"></circle>\n                  <rect id=\"Rectangle_43-2\" data-name=\"Rectangle 43\" width=\"6.424\" height=\"6.424\" transform=\"translate(12.849 12.911)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_44-2\" data-name=\"Rectangle 44\" width=\"3.854\" height=\"3.854\" transform=\"translate(14.133 14.196)\" fill=\"#fff\"></rect>\n                  <circle id=\"Ellipse_5\" data-name=\"Ellipse 5\" cx=\"0.642\" cy=\"0.642\" r=\"0.642\" transform=\"translate(15.418 15.48)\" fill=\"#040506\"></circle>\n                  <rect id=\"Rectangle_45-2\" data-name=\"Rectangle 45\" width=\"6.424\" height=\"6.424\" transform=\"translate(0 0)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_46-2\" data-name=\"Rectangle 46\" width=\"3.854\" height=\"3.854\" transform=\"translate(1.285 1.285)\" fill=\"#fff\"></rect>\n                  <circle id=\"Ellipse_6\" data-name=\"Ellipse 6\" cx=\"0.642\" cy=\"0.642\" r=\"0.642\" transform=\"translate(2.57 2.57)\" fill=\"#040506\"></circle>\n                  <rect id=\"Rectangle_47-2\" data-name=\"Rectangle 47\" width=\"7.709\" height=\"1.285\" transform=\"translate(2.57 9.025)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_48-2\" data-name=\"Rectangle 48\" width=\"1.285\" height=\"1.285\" transform=\"translate(6.424 7.74)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_49-2\" data-name=\"Rectangle 49\" width=\"1.285\" height=\"1.285\" transform=\"translate(3.855 7.74)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_50-2\" data-name=\"Rectangle 50\" width=\"1.285\" height=\"2.57\" transform=\"translate(7.709 6.455)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_51-2\" data-name=\"Rectangle 51\" width=\"8.994\" height=\"1.285\" transform=\"translate(10.279 2.632)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_52-2\" data-name=\"Rectangle 52\" width=\"3.854\" height=\"1.285\" transform=\"translate(15.418 3.917)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_53-2\" data-name=\"Rectangle 53\" width=\"1.285\" height=\"1.285\" transform=\"translate(17.988 0.063)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_54-2\" data-name=\"Rectangle 54\" width=\"1.285\" height=\"1.285\" transform=\"translate(17.988 5.202)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_55-2\" data-name=\"Rectangle 55\" width=\"1.285\" height=\"1.285\" transform=\"translate(15.418 0.063)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_56-2\" data-name=\"Rectangle 56\" width=\"1.285\" height=\"1.285\" transform=\"translate(16.761 1.406)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_57-2\" data-name=\"Rectangle 57\" width=\"3.854\" height=\"1.285\" transform=\"translate(11.564 6.487)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_58-2\" data-name=\"Rectangle 58\" width=\"1.285\" height=\"1.285\" transform=\"translate(16.703 6.487)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_59-2\" data-name=\"Rectangle 59\" width=\"1.285\" height=\"1.285\" transform=\"translate(15.418 7.74)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_60-2\" data-name=\"Rectangle 60\" width=\"1.285\" height=\"1.285\" transform=\"translate(18.003 10.326)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_61-2\" data-name=\"Rectangle 61\" width=\"1.285\" height=\"1.285\" transform=\"translate(17.988 7.74)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_62-2\" data-name=\"Rectangle 62\" width=\"1.285\" height=\"1.285\" transform=\"translate(15.418 5.202)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_63-2\" data-name=\"Rectangle 63\" width=\"1.285\" height=\"1.285\" transform=\"translate(12.849 5.202)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_64-2\" data-name=\"Rectangle 64\" width=\"1.285\" height=\"1.285\" transform=\"translate(11.564 3.917)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_65-2\" data-name=\"Rectangle 65\" width=\"1.285\" height=\"1.285\" transform=\"translate(12.849 0.063)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_66-2\" data-name=\"Rectangle 66\" width=\"1.285\" height=\"1.285\" transform=\"translate(8.994 0.063)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_67-2\" data-name=\"Rectangle 67\" width=\"1.285\" height=\"1.285\" transform=\"translate(12.849 1.348)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_68-2\" data-name=\"Rectangle 68\" width=\"1.285\" height=\"1.285\" transform=\"translate(11.564 1.348)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_69-2\" data-name=\"Rectangle 69\" width=\"1.285\" height=\"1.285\" transform=\"translate(14.133 1.348)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_70-2\" data-name=\"Rectangle 70\" width=\"1.285\" height=\"2.601\" transform=\"translate(7.709 12.88)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_71-2\" data-name=\"Rectangle 71\" width=\"1.285\" height=\"2.601\" transform=\"translate(10.279 12.88)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_72-2\" data-name=\"Rectangle 72\" width=\"1.285\" height=\"3.886\" transform=\"translate(8.994 12.88)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_73-2\" data-name=\"Rectangle 73\" width=\"1.285\" height=\"1.301\" transform=\"translate(8.994 11.587)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_74-2\" data-name=\"Rectangle 74\" width=\"1.285\" height=\"1.301\" transform=\"translate(10.279 16.757)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_75-2\" data-name=\"Rectangle 75\" width=\"3.854\" height=\"1.285\" transform=\"translate(5.14 10.31)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_76-2\" data-name=\"Rectangle 76\" width=\"1.285\" height=\"1.285\" transform=\"translate(2.57 10.31)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_77-2\" data-name=\"Rectangle 77\" width=\"1.285\" height=\"1.285\" transform=\"translate(6.424 11.595)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_78-2\" data-name=\"Rectangle 78\" width=\"1.285\" height=\"1.285\" transform=\"translate(1.285 10.31)\" fill=\"#040506\"></rect>\n                  <rect id=\"Rectangle_79-2\" data-name=\"Rectangle 79\" width=\"2.914\" height=\"1.285\" transform=\"translate(1.285 7.74)\" fill=\"#040506\"></rect>\n                  <path id=\"Path_1-2\" data-name=\"Path 1-2\" d=\"M1116.775,705.264\" transform=\"translate(-1102.592 -703.157)\" fill=\"none\" stroke=\"#040506\" stroke-miterlimit=\"10\" stroke-width=\"0.067\"></path>\n                  <path id=\"Path_40\" data-name=\"Path 40\" d=\"M1113.927,711.248\" transform=\"translate(-1103.648 -700.938)\" fill=\"none\" stroke=\"#040506\" stroke-miterlimit=\"10\" stroke-width=\"0.067\"></path>\n                  <path id=\"Path_41\" data-name=\"Path 41\" d=\"M1115.8,713.145\" transform=\"translate(-1102.953 -700.234)\" fill=\"none\" stroke=\"#040506\" stroke-miterlimit=\"10\" stroke-width=\"0.067\"></path>\n                  <path id=\"Path_42\" data-name=\"Path 42\" d=\"M1119.551,709.4\" transform=\"translate(-1101.563 -701.625)\" fill=\"#040506\"></path>\n                  <path id=\"Path_43\" data-name=\"Path 43\" d=\"M1113.927,711.248\" transform=\"translate(-1103.648 -700.938)\" fill=\"none\" stroke=\"#040506\" stroke-miterlimit=\"10\" stroke-width=\"0.089\"></path>\n                  <path id=\"Path_44\" data-name=\"Path 44\" d=\"M1115.8,713.145\" transform=\"translate(-1102.953 -700.234)\" fill=\"none\" stroke=\"#040506\" stroke-miterlimit=\"10\" stroke-width=\"0.089\"></path>\n                  <path id=\"Path_45\" data-name=\"Path 45\" d=\"M1111.115,703.727l2.433,5.2,2.232-.063-2.094-5.076Z\" transform=\"translate(-1104.691 -703.727)\" fill=\"url(#linear-gradient-6)\"></path>\n                  <path id=\"Path_46\" data-name=\"Path 46\" d=\"M1116.826,711.248h5.02v2.6h0Z\" transform=\"translate(-1102.573 -700.938)\" fill=\"url(#linear-gradient-7)\"></path>\n                </g>\n              </g>\n            </g>\n          </g>\n        </g>\n      </g>\n    </svg>", 'application/xml');
    var serializedSVG = new XMLSerializer().serializeToString(SVGDomElement);
    return "data:image/svg+xml;base64, ".concat(window.btoa(serializedSVG));
};

var drawCanvasElements = function (canvas, ctx, config) {
    var title = config.title, timestamp = config.timestamp, canvasFont = config.canvasFont, qrImage = config.qrImage;
    var drawBackground = function () { return __awaiter$1(void 0, void 0, void 0, function () {
    ...
    var drawQRCode = function () { return __awaiter$1(void 0, void 0, void 0, function () {
        var image, qrCodeImg, xOffset;
        return __generator$1(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, GenerateQRCodeImage(qrImage)];
                case 1:
                    image = _a.sent();
                    return [4 /*yield*/, LoadImage(image)];
                case 2:
                    qrCodeImg = _a.sent();
                    xOffset = qrCodeImg.width < canvas.width ? (canvas.width - qrCodeImg.width) / 2 : 0;
                    ctx.drawImage(qrCodeImg, xOffset, qrImage.top, qrCodeImg.width, qrCodeImg.height);
                    return [2 /*return*/];
            }
        });
    }); };
    var drawNameAndTime = function () { return __awaiter$1(void 0, void 0, void 0, function () {
        var fontFace, center, titleLeft, timestampLeft;
        return __generator$1(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fontFace = new FontFace(canvasFont.name, "url(".concat(canvasFont.url, ")"), {
                        weight: '100',
                    });
                    return [4 /*yield*/, fontFace.load()];
                case 1:
                    _a.sent();
                    center = FindTextCenter(canvas.width, 0, 'width', canvasFont.fontFamily);
                    // Title styles
                    ctx.font = "".concat(title.fontWeight, " ").concat(title.fontSize, " ").concat(canvasFont.fontFamily);
                    ctx.strokeStyle = title.color;
                    titleLeft = center(title.text, title.fontSize);
                    ctx.fillText(title.text, titleLeft, title.top);
                    // Timestamp styles
                    ctx.font = "".concat(timestamp.fontWeight, " ").concat(timestamp.fontSize, " ").concat(canvasFont.fontFamily);
                    timestampLeft = center(timestamp.text, timestamp.fontSize);
    ...
    return {
        ...
        drawNameAndTime: drawNameAndTime,
    };
};
var defaulConfig = function (config, avatar, tokenId, title, timestamp) {
    var WIDTH = (config === null || config === void 0 ? void 0 : config.width) || 396;
    var HEIGHT = (config === null || config === void 0 ? void 0 : config.height) || 638;
    return __assign$2({ width: WIDTH, height: HEIGHT, canvasFont: {
            name: 'custom',
...
var SkillWalletIDBadgeGenerator = function (_a) {
    var canvas = _a.canvas, avatar = _a.avatar, tokenId = _a.tokenId, title = _a.title, timestamp = _a.timestamp, config = _a.config;
    return __awaiter$1(void 0, void 0, void 0, function () {
        var ctx, ctxContents;
        return __generator$1(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    ctxContents = drawCanvasElements(canvas, ctx, config);
                    return [4 /*yield*/, ctxContents.drawBackground()];
                case 1:
                    _b.sent();
                    return [4 /*yield*/, ctxContents.drawQRCode()];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, ctxContents.drawNameAndTime()];
                case 3:
                    _b.sent();
                    return [2 /*return*/, {
                            previewElement: canvas,
                            download: function (filename) {
                                if (filename === void 0) { filename = 'SkillwalletID.png'; }
                                var link = document.createElement('a');
                                link.download = filename;
                                link.href = canvas.toDataURL('image/png', 1.0);
                                link.click();
                            },
                            toBase64: function (mimeType) {
                                if (mimeType === void 0) { mimeType = 'image/png'; }
                                return canvas.toDataURL(mimeType, 1.0);
                            },
                            toFile: function (filename, mimeType) {
                                if (filename === void 0) { filename = 'SkillwalletID.png'; }
                                if (mimeType === void 0) { mimeType = 'image/png'; }
                                return __awaiter$1(void 0, void 0, void 0, function () {
                                    return __generator$1(this, function (_a) {
...
exports.ArchitectureSvg = ArchitectureSvg;
exports.BackendSvg = BackendSvg;
exports.BlockchainSvg = BlockchainSvg;
exports.CenterWhiteBarSvg = CenterWhiteBarSvg;
exports.CommunitySvg = CommunitySvg;
exports.ConsensusSvg = ConsensusSvg;
exports.CreateUnselSvg = CreateUnselSvg;
exports.DefiSvg = DefiSvg;
exports.DitoCreditsNewSvg = DitoCreditsNewSvg;
exports.DitoCreditsSuccessLogoSvg = DitoCreditsSuccessLogoSvg;
exports.DitoCreditsSuccessSvg = DitoCreditsSuccessSvg;
exports.DitoCreditsSvg = DitoCreditsSvg;
exports.DitoLogoCircleSvg = DitoLogoCircleSvg;
exports.DitoLogoFullSvg = DitoLogoFullSvg;
exports.DitoLogoSvg = DitoLogoSvg;
exports.FooterMembersSvg = FooterMembersSvg;
exports.FooterShareSvg = FooterShareSvg;
exports.FrontendSvg = FrontendSvg;
exports.GameTheorySvg = GameTheorySvg$1;
exports.GameTheorySvg2 = GameTheorySvg;
exports.GardeningSvg = GardeningSvg;
exports.GovernanceSvg = GovernanceSvg;
exports.HouseHoldingSvg = HouseHoldingSvg;
exports.JoinSelSvg = JoinSelSvg;
exports.JoinUnselSvg = JoinUnselSvg;
exports.LayerBlurSvg = LayerBlurSvg;
exports.LegalSvg = LegalSvg;
exports.LogoffSvg = LogoffSvg;
exports.MainBackgroundSvg = MainBackgroundSvg;
exports.ManagementSvg = ManagementSvg;
exports.MilestonesCompletedSvg = MilestonesCompletedSvg;
exports.MilestonesSvg = MilestonesSvg;
exports.MobileSvg = MobileSvg;
exports.NetworkDesignSvg = NetworkDesignSvg;
exports.NetworkSvg = NetworkSvg;
exports.NotificationsSvg = NotificationsSvg;
exports.OpenGigsSelSvg = OpenGigsSelSvg;
exports.OpenGigsSvg = OpenGigsSvg;
exports.PaintingSvg = PaintingSvg;
exports.ParseSWErrorMessage = ParseSWErrorMessage;
exports.ParticipationRateSvg = ParticipationRateSvg;
exports.PhotographySvg = PhotographySvg;
exports.ProjectsCreatedSvg = ProjectsCreatedSvg;
exports.ProjectsSelSvg = ProjectsSelSvg;
exports.ProjectsSvg = ProjectsSvg;
exports.QRCodeSvg = QRCodeSvg;
exports.ScoreReachedSvg = ScoreReachedSvg;
exports.SettingsSvg = SettingsSvg;
exports.Shape1Svg = Shape1Svg;
exports.Shape2Svg = Shape2Svg;
exports.Shape3Svg = Shape3Svg;
exports.Shape4Svg = Shape4Svg;
exports.Shape5Svg = Shape5Svg;
exports.Shape6Svg = Shape6Svg;
exports.Shape7Svg = Shape7Svg;
exports.SkillWalletIDBadgeGenerator = SkillWalletIDBadgeGenerator;
exports.SkillWalletNavSvg = SkillWalletNavSvg;
exports.SmartContractsSvg = SmartContractsSvg;
exports.SwButton = SwButton;
exports.SwClipboardCopy = SwClipboardCopy;
exports.SwDivider = SwDivider;
exports.SwLayout = SwLayout;
exports.SwLogoSvg = SwLogoSvg;
exports.SwMenuItems = SwMenuItems;
exports.SwProgressBar = SwProgressBar;
exports.SwQuote = SwQuote;
exports.SwScrollbar = SwScrollbar;
exports.SwShare = SwShare;
exports.SwSidebar = SwSidebar;
exports.SwSlider = SwSlider;
exports.SwStepper = SwStepper;
exports.SwUploadFile = SwUploadFile;
exports.TeachingSvg = TeachingSvg;
exports.TokenomicsSvg = TokenomicsSvg$1;
exports.TokenomicsSvg2 = TokenomicsSvg;
exports.TownhallNavSvg = TownhallNavSvg;
exports.TrainSportSvg = TrainSportSvg;
exports.TreasurySelSvg = TreasurySelSvg;
exports.TreasurySvg = TreasurySvg;
exports.VideoSvg = VideoSvg;
exports.WebDevSvg = WebDevSvg;
exports.YourContributionsSvg = YourContributionsSvg;
exports.asyncPoll = asyncPoll;
exports.base64toFile = base64toFile;
exports.createShadows = createShadows;
exports.ensureVariablesExist = ensureVariablesExist;
exports.envionmentGenerator = envionmentGenerator;
