...
var SwScrollbar = function (_a) {
    ...
    return (React__namespace.createElement(reactCustomScrollbars.Scrollbars, __assign({ autoHeightMin: "100%", autoHeightMax: "100%", className: className, renderView: renderView, renderThumbHorizontal: renderThumb, renderThumbVertical: renderThumb, style: __assign({ height: '100%' }, (sx || {})) }, rest)));
};
