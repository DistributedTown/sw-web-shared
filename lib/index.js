...
var SwMainLayout = function (_a) {
    var _b = _a.menuItems, menuItems = _b === void 0 ? [] : _b; _a.backgroundUrl; _a.contentBackgroundColor; _a.sidebarBackgroundColor; var _f = _a.collapsed, collapsed = _f === void 0 ? false : _f;
    var Content = antd.Layout.Content, Sider = antd.Layout.Sider;
    var _g = React.useState(collapsed), collapse = _g[0], onCollapse = _g[1];
    return (React__default["default"].createElement(antd.Layout, { className: "sw-main-layout" },
        React__default["default"].createElement(Sider, { className: "sw-main-sidebar", collapsible: true, collapsed: collapse, onCollapse: function () { return onCollapse(!collapse); } },
            ...
            React__default["default"].createElement(antd.Menu, { defaultSelectedKeys: ["1"], mode: "inline" }, menuItems.map(function (item, id) {
                ...
                return (React__default["default"].createElement(antd.Menu.Item, { key: id, icon: item.icon },
                    React__default["default"].createElement("button", { onClick: item.onClick }, item.label)));
            }))),
        React__default["default"].createElement(antd.Layout, { className: "site-layout" },
            React__default["default"].createElement(Content, { style: { margin: "0 16px" } },
                React__default["default"].createElement("div", { className: "site-layout-background" }, "Bill is a cat.")))));
};
