...
material.styled("div")(function (_a) {
    var theme = _a.theme;
...
var CustomizedStepperWrapper = material.styled(material.Box)(function (_a) {
    var theme = _a.theme;
    return "\n.stepper-dots {\n  width: 100%;\n  display: flex;\n  align-items: center;\n  margin: 20px 0;\n\n  .stepper-dot {\n    height: 36px;\n    width: 36px;\n    border-radius: 50%;\n    border: 3px solid ".concat(theme.palette.background.paper, ";\n    box-sizing: border-box;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n\n    &.active {\n      background-color: ").concat(theme.palette.background.paper, ";\n    }\n  }\n\n  .stepper-line {\n    border-top: 4px solid ").concat(theme.palette.background.paper, ";\n    flex: 1;\n  }\n}\n\n.stepper-top {\n  position: absolute;\n  margin: 0 auto;\n  width: 100%;\n  top: 0px;\n  text-align: center;\n  left: 50%;\n  transform: translateX(-50%);\n}\n\n.MuiMobileStepper-dots {\n  display: none;\n}\n");
});
var SwStepper = function (_a) {
    ...
    return (React__default["default"].createElement(CustomizedStepperWrapper, { sx: { width: "100%", position: "relative" } },
