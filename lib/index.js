...
function renderTrackHorizontalDefault(_ref) {
  ...
  return _react2["default"].createElement(
    "div",
    _extends$1({ style: finalStyle }, props)
  );
}
  ...
  var Scrollbars = (function (_Component) {
    ...
    function Scrollbars(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (_ref =
          Scrollbars.__proto__ || Object.getPrototypeOf(Scrollbars)).call.apply(
          _ref,
    ...
    _createClass(Scrollbars, [
      ...
      },
      {
        ...
        value: function getValues() {
          var _ref2 = this.view || {},
            ...
            scrollWidth =
              _ref2$scrollWidth === undefined ? 0 : _ref2$scrollWidth,
            _ref2$scrollHeight = _ref2.scrollHeight,
            scrollHeight =
              _ref2$scrollHeight === undefined ? 0 : _ref2$scrollHeight,
            _ref2$clientWidth = _ref2.clientWidth,
            clientWidth =
              _ref2$clientWidth === undefined ? 0 : _ref2$clientWidth,
            _ref2$clientHeight = _ref2.clientHeight,
            clientHeight =
              _ref2$clientHeight === undefined ? 0 : _ref2$clientHeight;
      ...
      },
      {
        ...
        value: function teardownDragging() {
          (0, _domCss2["default"])(
            document.body,
            _styles.disableSelectStyleReset
          );
      ...
      },
      {
        ...
        value: function _update(callback) {
          ...
          if ((0, _getScrollbarWidth2["default"])()) {
            ...
            var trackHorizontalWidth = (0, _getInnerWidth2["default"])(
              this.trackHorizontal
            );
            ...
            var trackVerticalHeight = (0, _getInnerHeight2["default"])(
              this.trackVertical
            );
      ...
      },
      {
        ...
        value: function render() {
          ...
          var containerStyle = _extends(
            {},
            _styles.containerStyleDefault,
            autoHeight &&
              _extends({}, _styles.containerStyleAutoHeight, {
          ...
          var viewStyle = _extends(
            ...
            autoHeight &&
              _extends({}, _styles.viewStyleAutoHeight, {
          ...
          var trackHorizontalStyle = _extends(
            {},
            _styles.trackHorizontalStyleDefault,
          ...
          var trackVerticalStyle = _extends(
            {},
            _styles.trackVerticalStyleDefault,
            autoHide && trackAutoHeightStyle,
            (!scrollbarWidth || (universal && !didMountUniversal)) && {
              display: "none",
            }
...
var renderThumb = function (_a) {
  ...
  return React__namespace.createElement(
    "div",
    __assign({ style: __assign(__assign({}, style), thumbStyle) }, props)
  );
};
var renderView = function (_a) {
  ...
  return React__namespace.createElement(
    "div",
    __assign(
      { className: "box", style: __assign(__assign({}, style), viewStyle) },
      props
    )
  );
};
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement(
        ...
        React__default["default"].createElement(
          ...
          { className: "sw-layout-top", maxWidth: "xl" },
          top
        ),
        React__default["default"].createElement(
          SwScrollbar,
...
var SwSidebar = function (_a) {
  var _b = _a.menuItems,
    ...
    backgroundColor = _e === void 0 ? "transparent" : _e,
    _f = _a.variant,
    variant = _f === void 0 ? "permanent" : _f,
    _g = _a.sidebarTop,
    sidebarTop = _g === void 0 ? null : _g;
  var Drawer = DrawerRef(width, backgroundColor);
  var _h = React__default["default"].useState(open),
    opened = _h[0];
  _h[1];
  return React__default["default"].createElement(
    Drawer,
    { className: "sw-main-sidebar", variant: variant, open: opened },
    React__default["default"].createElement(
      "div",
      ...
      menuItems.map(function (item, id) {
        ...
        if (item.type === "href") {
          return React__default["default"].createElement(
            ...
            { key: id, title: !opened ? item.label : "", placement: "right" },
            React__default["default"].createElement(
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement(
        ...
        React__default["default"].createElement(
          "g",
          { id: "Group_1818", "data-name": "Group 1818" },
          React__default["default"].createElement(
            "g",
            { id: "Group_12", "data-name": "Group 12" },
            React__default["default"].createElement(
              "g",
              { id: "Path_1-2", "data-name": "Path 1-2" },
              React__default["default"].createElement("path", {
                id: "Path_22",
                "data-name": "Path 22",
                className: "cls-1",
            ...
            React__default["default"].createElement(
              "g",
              { id: "Path_1-2-2", "data-name": "Path 1-2-2" },
              React__default["default"].createElement("path", {
                id: "Path_23",
                "data-name": "Path 23",
                className: "cls-1",
                d:
                  "M.65,67.78a.26.26,0,0,1-.24-.25.24.24,0,0,1,.17-.23L55.75,49.22v-.38H34.41a.25.25,0,0,1-.25-.24v-21l-12-2.93a.25.25,0,0,1-.2-.28.26.26,0,0,1,.29-.2h0l12.17,3L56,26.36a.21.21,0,0,1,.18.07.21.21,0,0,1,.07.17V49.39a.25.25,0,0,1-.16.24L.73,67.76Zm34-19.42H55.74V26.86l-21.09.76Z",
              })
            ),
            React__default["default"].createElement(
              "g",
              { id: "Group_11", "data-name": "Group 11" },
              React__default["default"].createElement("path", {
                id: "Path_24",
                "data-name": "Path 24",
                className: "cls-1",
                d:
                  "M56,26.85a.25.25,0,0,1-.15-.44L70,15.08a.24.24,0,0,1,.34,0,.24.24,0,0,1,0,.35h0L56.14,26.79A.2.2,0,0,1,56,26.85Z",
              })
            )
          ),
          React__default["default"].createElement(
            "g",
            { id: "Group_15", "data-name": "Group 15" },
            React__default["default"].createElement(
              "g",
              { id: "Path_1-2-3", "data-name": "Path 1-2-3" },
              React__default["default"].createElement("path", {
                id: "Path_25",
                "data-name": "Path 25",
                className: "cls-1",
                d:
                  "M56,27.25a.64.64,0,0,1-.28-.06l-8.22-4L22.25,25.07a.65.65,0,0,1-.7-.58v0a.64.64,0,0,1,.6-.7l25.42-1.89a.63.63,0,0,1,.33.06L56.27,26a.64.64,0,0,1,.3.87.65.65,0,0,1-.58.37Z",
              })
            ),
            React__default["default"].createElement(
              "g",
              { id: "Path_1-2-4", "data-name": "Path 1-2-4" },
              React__default["default"].createElement("path", {
                id: "Path_26",
                "data-name": "Path 26",
                className: "cls-1",
                d:
                  "M.65,68.18h0A.65.65,0,0,1,0,67.53H0L.88,7.94h0a.69.69,0,0,1,.17-.41h0a.44.44,0,0,1,.15-.12h0a.62.62,0,0,1,.26-.09L59.61,0a.65.65,0,0,1,.73.57.66.66,0,0,1-.57.73L2.17,8.55l-.87,59A.64.64,0,0,1,.65,68.18Z",
              })
            ),
            React__default["default"].createElement(
              "g",
              { id: "Group_13", "data-name": "Group 13" },
              React__default["default"].createElement("path", {
                id: "Path_27",
                "data-name": "Path 27",
                className: "cls-1",
                d:
                  "M48.31,52.53h0L22.17,51.26a.64.64,0,0,1-.62-.65V24.41a.65.65,0,0,1,.65-.65h0a.65.65,0,0,1,.65.65h0V50l25.38,1.22,7.11-2.3V26.6a.65.65,0,0,1,.62-.68.66.66,0,0,1,.68.63V49.39a.64.64,0,0,1-.45.62l-7.68,2.48A.65.65,0,0,1,48.31,52.53Z",
              })
            ),
            React__default["default"].createElement(
              "g",
              { id: "Group_14", "data-name": "Group 14" },
              React__default["default"].createElement("path", {
                id: "Path_28",
                "data-name": "Path 28",
                className: "cls-1",
                d:
                  "M59.7,76.4h-.09l-59-8.21a.66.66,0,0,1,.18-1.3L59.38,75,69.46,59.85V15.47L59.16,1A.66.66,0,0,1,60.23.27L70.64,14.89a.64.64,0,0,1,.13.37V60.05a.66.66,0,0,1-.11.36L60.24,76.1A.65.65,0,0,1,59.7,76.4Z",
              })
            )
          ),
          React__default["default"].createElement(
            ...
            React__default["default"].createElement(
              ...
              React__default["default"].createElement("path", {
                className: "cls-1",
                d:
                  "M96.47,30V10.39h5.41q10.37,0,10.36,9.56a9.61,9.61,0,0,1-2.87,7.29A10.68,10.68,0,0,1,101.66,30Zm2.29-17.53V27.92h2.93a8.28,8.28,0,0,0,6-2.07A7.72,7.72,0,0,0,109.84,20q0-7.53-8-7.53Z",
              }),
              React__default["default"].createElement("path", {
                className: "cls-1",
                d: "M118.4,30h-2.3V10.39h2.3Z",
              }),
              React__default["default"].createElement("path", {
                className: "cls-1",
                d:
              ...
              React__default["default"].createElement("path", {
                className: "cls-1",
                d:
                  "M237.64,30H227.25V10.39h10v2.08h-7.66V19h7.08v2.07h-7.08v6.86h8.09Z",
              }),
              React__default["default"].createElement("path", {
                className: "cls-1",
                d:
                  "M241.42,30V10.39h5.41q10.36,0,10.36,9.56a9.65,9.65,0,0,1-2.87,7.29A10.68,10.68,0,0,1,246.61,30Zm2.29-17.53V27.92h2.93a8.28,8.28,0,0,0,6-2.07A7.72,7.72,0,0,0,254.79,20q0-7.53-8-7.53Z",
              })
            ),
            React__default["default"].createElement(
              "g",
              ...
              React__default["default"].createElement("path", {
                className: "cls-1",
                d:
                  "M117.74,64.33a8.61,8.61,0,0,1-6.68-2.75,10.21,10.21,0,0,1-2.51-7.15,10.82,10.82,0,0,1,2.56-7.55,8.91,8.91,0,0,1,7-2.82,8.38,8.38,0,0,1,6.54,2.74A10.19,10.19,0,0,1,127.09,54a10.86,10.86,0,0,1-2.54,7.59A8.78,8.78,0,0,1,117.74,64.33Zm.17-18.19a6.29,6.29,0,0,0-5,2.23A8.62,8.62,0,0,0,111,54.22a8.69,8.69,0,0,0,1.88,5.83,6.14,6.14,0,0,0,4.9,2.21,6.46,6.46,0,0,0,5.09-2.1,8.63,8.63,0,0,0,1.86-5.9,9,9,0,0,0-1.81-6A6.19,6.19,0,0,0,117.91,46.14Z",
              }),
              React__default["default"].createElement("path", {
                className: "cls-1",
                d:
                  "M153.51,44.39,148,64h-2.69l-4-14.33a9.41,9.41,0,0,1-.31-2h-.06a9.91,9.91,0,0,1-.35,2L136.46,64h-2.67l-5.74-19.61h2.53l4.17,15a10.53,10.53,0,0,1,.33,2h.06a12,12,0,0,1,.43-2l4.33-15h2.2l4.16,15.15a10.39,10.39,0,0,1,.33,1.83h0a11.27,11.27,0,0,1,.37-1.88l4-15.1Z",
              }),
              React__default["default"].createElement("path", {
                className: "cls-1",
                d:
                  "M172.22,64h-2.81L159.32,48.37a6,6,0,0,1-.63-1.23h-.08a20.69,20.69,0,0,1,.11,2.69V64h-2.3V44.39h3l9.82,15.38c.41.64.67,1.08.79,1.31h.05a21.08,21.08,0,0,1-.13-2.88V44.39h2.29Z",
              })
            )
          )
        )
