...
function SwShare(props) {
    var onClose = props.onClose, title = props.title, open = props.open, sx = props.sx, mode = props.mode, url = props.url;
    ...
    return (React__default["default"].createElement(material.Dialog, { onClose: handleClose, open: open },
        React__default["default"].createElement(material.DialogContent, { sx: __assign$2({ width: '450px', height: '370px', display: 'flex', flexDirection: 'column', borderWidth: '2px', padding: '35px 30px', bgcolor: mode === 'light' ? 'background.paper' : 'primary.main', borderColor: mode === 'light' ? 'primary.main' : 'background.paper' }, (sx || {})) },
            ...
            React__default["default"].createElement("div", { className: "links", style: {
                ...
                React__default["default"].createElement(LinkedinShareButton$1, { url: url, className: "social-button" },
                    React__default["default"].createElement(LinkedInIcon__default["default"], { sx: {
                            width: '85px',
                            height: '85px',
                            color: mode === 'light' ? 'primary.main' : 'text.primary'
                        } })),
                React__default["default"].createElement(TelegramShareButton$1, { url: url, className: "social-button" },
                    React__default["default"].createElement(TelegramIcon__default["default"], { sx: {
                            width: '85px',
                            height: '85px',
                            color: mode === 'light' ? 'primary.main' : 'text.primary'
                        } })),
                React__default["default"].createElement(TwitterShareButton$1, { url: url, className: "social-button", title: title },
