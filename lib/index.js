...
var _objectWithoutPropertiesLoose$2 = require('@babel/runtime/helpers/esm/objectWithoutPropertiesLoose');
...
var css_248z$c = ".sw-main-box .sw-layout-top {\n  align-items: center;\n  justify-content: flex-end;\n  padding: 0 20px;\n  position: relative;\n  height: 50px; }\n";
...
function z(a){if("object"===typeof a&&null!==a){var u=a.$$typeof;switch(u){case c:switch(a=a.type,a){case l:case m:case e:case g:case f$6:case p:return a;default:switch(a=a&&a.$$typeof,a){case k:case n:case t:case r:case h:return a;default:return u}}case d:return u}}}function A(a){return z(a)===m}var AsyncMode=l;var ConcurrentMode=m;var ContextConsumer=k;var ContextProvider=h;var Element$1=c;var ForwardRef=n;var Fragment=e;var Lazy=t;var Memo=r;var Portal=d;
var Profiler=g;var StrictMode=f$6;var Suspense=p;var isAsyncMode=function(a){return A(a)||z(a)===l};var isConcurrentMode=A;var isContextConsumer=function(a){return z(a)===k};var isContextProvider=function(a){return z(a)===h};var isElement$1=function(a){return "object"===typeof a&&null!==a&&a.$$typeof===c};var isForwardRef=function(a){return z(a)===n};var isFragment=function(a){return z(a)===e};var isLazy=function(a){return z(a)===t};
...
var ordinaryToPrimitive = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable(fn = input.toString) && !isObject$3(val = fn.call(input))) return val;
  if (isCallable(fn = input.valueOf) && !isObject$3(val = fn.call(input))) return val;
  if (pref !== 'string' && isCallable(fn = input.toString) && !isObject$3(val = fn.call(input))) return val;
...
var SwLayout = function (_a) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        backgroundUrl && React__default["default"].createElement("div", { className: "sw-background " + className, style: {
                display: "flex",
...
var SwSidebar = function (_a) {
    ...
    return (React__default["default"].createElement(material.Drawer, { anchor: "left", sx: __assign$2(__assign$2({ width: !mobile ? width : '100%', transition: theme.transitions.create("width", {
            ...
            _b))), { flexShrink: 0, '& .MuiDrawer-paper': __assign$2(__assign$2({ transition: theme.transitions.create("width", {
                ...
                _c))), (sx || {})) }), className: "sw-main-sidebar " + (mobile ? 'is-mobile' : ''), variant: mobile ? 'temporary' : 'permanent', open: open },
        ...
        React__default["default"].createElement("div", { className: "sw-sidebar-content " + mode }, children),
    ...
    return (React__default["default"].createElement(List__default["default"], { className: "sw-sidebar-menu" }, menuItems.map(function (item, id) {
        ...
        if (item.type === "href") {
            return (React__default["default"].createElement(Tooltip__default["default"], { key: id, title: !open ? item.label : "", placement: "right" },
                React__default["default"].createElement(ListItem__default["default"], { onClick: mobile ? handleToggle : function () { return null; }, activeClassName: "active-link", component: reactRouterDom.NavLink, disabled: item.disabled, to: item.href, replace: true, key: id },
...
var SwButton = function (_a) {
    ...
    return (React__namespace.createElement(CustomizedButton, __assign$2({}, rest, { variant: variant, color: color, className: "sw-button " + className }),
...
var SwQuote = function (_a) {
    ...
    return (React__namespace.createElement(material.Box, { className: "sw-box-quote " + className }, mobile ? (React__namespace.createElement(React__namespace.Fragment, null,
...
var SwSlider = function (_a) {
    ...
    var _c = React__namespace.useState(rest.defaultValue), value = _c[0], setValue = _c[1];
    return (React__namespace.createElement(CustomizedSlider, __assign$2({}, rest, { onChange: function (_, v) { return setValue(v); }, components: { Thumb: SwThumbComponent(value) }, className: "sw-slider " + className + " mode-" + mode })));
};
...
var NoBorderLinearProgress = material.styled(material.LinearProgress)(function (_a) {
    ...
    return (_b = {
        ...
        _b["&." + material.linearProgressClasses.colorPrimary] = {
            backgroundColor: theme.palette.background.paper,
        },
        _b["& ." + material.linearProgressClasses.bar] = {
            borderRadius: 0,
...
function SwClipboardCopy(_a) {
    ...
    return (React__default["default"].createElement("div", { className: "copy-wrapper " + mode, onClick: handleCopyClick },
