...
var ChevronLeftIcon__default = /*#__PURE__*/ _interopDefaultLegacy(
  ChevronLeftIcon
);
var ChevronRightIcon__default = /*#__PURE__*/ _interopDefaultLegacy(
  ChevronRightIcon
);
var CloseIcon__default = /*#__PURE__*/ _interopDefaultLegacy(CloseIcon);
var HighlightOffIcon__default = /*#__PURE__*/ _interopDefaultLegacy(
  HighlightOffIcon
);
var PhotoCameraIcon__default = /*#__PURE__*/ _interopDefaultLegacy(
  PhotoCameraIcon
);
...
var j = (function () {
  ...
  q = function (e) {
    ...
    r.setAttribute(N, "active"), r.setAttribute("data-styled-version", "5.3.1");
    var s = Y();
      ...
      return (function (e, t, n, r) {
        ...
        var m = (function (e, t, n) {
          ...
          S = (function (e, t, n, r) {
            ...
            return (
              "production" !== process.env.NODE_ENV && React.useDebugValue(s),
              "production" !== process.env.NODE_ENV && !t && r && r(s),
              s
            );
          })(
            s,
        ...
        return (
          ...
          (C.className = Array.prototype
            ...
            .join(" ")),
          (C.ref = b),
          React.createElement(_, C)
        );
      })(C, e, t, P);
    };
  return (
    (O.displayName = v),
    ((C = React__default["default"].forwardRef(O)).attrs = N),
    (C.componentStyle = I),
    (C.displayName = v),
...
var isSymbol$4 = USE_SYMBOL_AS_UID$1
  ? function (it) {
...
var ordinaryToPrimitive$1 = function (input, pref) {
  ...
  if (
    ...
    !isObject$d((val = fn.call(input)))
  )
    return val;
  if (isCallable$e((fn = input.valueOf)) && !isObject$d((val = fn.call(input))))
    return val;
  if (
    pref !== "string" &&
    isCallable$e((fn = input.toString)) &&
...
var createWellKnownSymbol = USE_SYMBOL_AS_UID
  ? Symbol$2
  : (Symbol$2 && Symbol$2.withoutSetter) || uid$2;
...
var nativeWeakMap =
  isCallable$c(WeakMap$2) && /native code/.test(inspectSource$2(WeakMap$2));
...
var CONFIGURABLE =
  EXISTS &&
  (!DESCRIPTORS$3 ||
    (DESCRIPTORS$3 && getDescriptor(FunctionPrototype$1, "name").configurable));
...
(redefine$7.exports = function (O, key, value, options) {
  ...
  return (
    (isCallable$b(this) && getInternalState$3(this).source) ||
...
var classof$6 = TO_STRING_TAG_SUPPORT$2
  ...
  : function (it) {
      ...
      return it === undefined
        ...
        (result = classofRaw(O)) == "Object" && isCallable$9(O.callee)
        ? "Arguments"
        : result;
    };
...
var isConstructorLegacy = function (argument) {
  ...
  return (
    INCORRECT_TO_STRING ||
    !!exec$1.call(constructorRegExp, inspectSource(argument))
  );
};
...
var objectDefineProperties = DESCRIPTORS$2
...
var defineIterator$2 = function (
  ...
  if (IterablePrototype[ITERATOR$5] !== defaultIterator) {
    redefine$4(IterablePrototype, ITERATOR$5, defaultIterator, {
      name: DEFAULT,
    });
  }
...
var objectToString$3 = TO_STRING_TAG_SUPPORT$1
  ? {}.toString
  : function toString() {
...
var onFreeze = function (it) {
  if (FREEZING && REQUIRED && isExtensible$1(it) && !has(it, METADATA))
    setMetadata(it);
  return it;
};
...
var getIterator$1 = function (argument, usingIterator) {
  ...
  if (aCallable$1(iteratorMethod))
    return anObject$7(iteratorMethod.call(argument));
...
var iterate$2 = function (iterable, unboundFunction, options) {
  ...
  if (IS_ITERATOR) {
    ...
    if (isArrayIteratorMethod(iterFn)) {
      for (
        index = 0, length = toLength$3(iterable.length);
        length > index;
        index++
      ) {
...
var collection$1 = function (CONSTRUCTOR_NAME, wrapper, common) {
  ...
  var REPLACE = isForced(
    CONSTRUCTOR_NAME,
    !isCallable$2(NativeConstructor) ||
      !(
        IS_WEAK ||
    ...
    if (!ACCEPT_ITERABLES) {
      Constructor = wrapper(function (dummy, iterable) {
        ...
        if (iterable != undefined)
          iterate$1(iterable, that[ADDER], { that: that, AS_ENTRIES: IS_MAP });
        return that;
      });
...
for (var COLLECTION_NAME in DOMIterables) {
  handlePrototype(
    global$6[COLLECTION_NAME] && global$6[COLLECTION_NAME].prototype,
    COLLECTION_NAME
  );
}
...
var IE = /msie|trident/i.test(
  global$5.navigator && global$5.navigator.userAgent
);
...
var Scheduler = (function () {
  ...
  Scheduler.prototype.start = function () {
    ...
    if (this.stopped) {
      ...
      events.forEach(function (name) {
        return global$5.addEventListener(name, _this.listener, true);
      });
    }
  };
  Scheduler.prototype.stop = function () {
    ...
    if (!this.stopped) {
      ...
      events.forEach(function (name) {
        return global$5.removeEventListener(name, _this.listener, true);
      });
      this.stopped = true;
    }
  };
  ...
  function (MATCH, nativeMatch, maybeCallNative) {
    return [
      ...
      function match(regexp) {
        ...
        var matcher =
          regexp == undefined ? undefined : getMethod$1(regexp, MATCH);
        return matcher
          ? matcher.call(regexp, O)
          : new RegExp(regexp)[MATCH](toString$1(O));
      },
...
var SimpleBar = React__default["default"].forwardRef(function (_ref, ref) {
  var children = _ref.children,
    ...
    scrollableNodeProps =
      _ref$scrollableNodePr === void 0 ? {} : _ref$scrollableNodePr,
    otherProps = _objectWithoutProperties$1(_ref, [
      "children",
      "scrollableNodeProps",
    ]);
...
var css_248z$6 =
  ".sw-scrollbar .simplebar-content {\n  height: 100%; }\n\n.sw-scrollbar .simplebar-scrollbar:before {\n  background-color: white;\n  border-radius: 0; }\n";
styleInject(css_248z$6);

var SwScrollbar = function (_a) {
  var _b = _a.className,
    className = _b === void 0 ? "sw-scrollbar" : _b,
    sx = _a.sx,
    rest = __rest(_a, ["className", "sx"]);
    ...
    __assign(
      {
        forceVisible: "y",
        className: className,
        style: __assign({ height: "100%", width: "100%" }, sx || {}),
      },
      rest
    )
  );
...
var SwLayout = function (_a) {
  var _b = _a.backgroundUrl,
    backgroundUrl = _b === void 0 ? null : _b,
    _c = _a.hideTop,
    hideTop = _c === void 0 ? false : _c,
    _d = _a.children,
    children = _d === void 0 ? null : _d,
    _e = _a.drawer,
    drawer = _e === void 0 ? null : _e,
    _f = _a.top,
    top = _f === void 0 ? null : _f,
    _g = _a.className,
...
var SwSidebar = function (_a) {
  ...
  var _d = _a.menuItems,
    ...
    _e = _a.open,
    open = _e === void 0 ? false : _e,
    _f = _a.width,
    width = _f === void 0 ? 300 : _f,
    _g = _a.backgroundColor,
    backgroundColor = _g === void 0 ? "transparent" : _g,
    _h = _a.sidebarTopIcon,
    sidebarTopIcon = _h === void 0 ? null : _h,
    _j = _a.mobile,
    mobile = _j === void 0 ? false : _j,
    _k = _a.handleToggle,
    handleToggle =
      _k === void 0
        ? function () {
  ...
  return React__default["default"].createElement(
    ...
    mobile &&
      React__default["default"].createElement(
        ...
        { title: "Close sidebar", placement: "right", color: "white" },
        React__default["default"].createElement(
          material.IconButton,
          {
    ...
    React__default["default"].createElement(
      "div",
      { className: "sw-sidebar-top" },
      React__default["default"].createElement(material.SvgIcon, {
    ...
    React__default["default"].createElement(
      ...
      { className: "sw-sidebar-menu" },
      menuItems.map(function (item, id) {
        if (item.type === "divider") {
          return React__default["default"].createElement(
            Divider__default["default"],
            { key: id, className: "sw-sidebar-divider" }
          );
        }
        if (item.type === "href") {
          return React__default["default"].createElement(
            Tooltip__default["default"],
            { key: id, title: !open ? item.label : "", placement: "right" },
            React__default["default"].createElement(
              ...
              React__default["default"].createElement(
                "div",
                { className: "sw-sidebar-menu-icon" },
                item.icon
              ),
              React__default["default"].createElement(
    ...
    !mobile &&
      React__default["default"].createElement(
        ...
        React__default["default"].createElement(
          Tooltip__default["default"],
          { title: !open ? "Open" : "Close", placement: "right" },
          React__default["default"].createElement(
            material.IconButton,
            { color: "secondary", onClick: handleToggle },
            !open
              ? React__default["default"].createElement(
                  ChevronRightIcon__default["default"],
                  null
                )
              : React__default["default"].createElement(
                  ChevronLeftIcon__default["default"],
                  null
                )
          )
        )
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement(
        ...
        React__default["default"].createElement(
          "g",
          { "data-name": "Path 1-2", transform: "translate(.001 23.763)" },
          React__default["default"].createElement("path", {
            fill: "#fff",
            d:
              "M2539.358 294.032a.245.245 0 01-.076-.477l55.169-18.082v-.373h-21.337a.245.245 0 01-.244-.245v-21.023l-12.021-2.923a.245.245 0 11.116-.475l12.174 2.96 21.548-.782a.238.238 0 01.179.069.244.244 0 01.074.176v22.793a.245.245 0 01-.168.232l-55.337 18.138a.255.255 0 01-.077.012zm34-19.418h21.092v-21.5l-21.092.765z",
            "data-name": "Path 23",
        ...
        React__default["default"].createElement(
          "g",
          { "data-name": "Group 11", transform: "translate(55.338 14.614)" },
          React__default["default"].createElement("path", {
            fill: "#fff",
            d:
              "M2621.847 248.612a.245.245 0 01-.153-.435l14.121-11.335a.244.244 0 01.306.381L2622 248.558a.244.244 0 01-.153.054z",
            "data-name": "Path 24",
      ...
      React__default["default"].createElement(
        "g",
        { "data-name": "Group 15", transform: "translate(2538.506 214.397)" },
        React__default["default"].createElement(
          "g",
          { "data-name": "Path 1-2", transform: "translate(21.548 21.872)" },
          React__default["default"].createElement("path", {
            fill: "#fff",
            d:
              "M2605.068 252.383a.657.657 0 01-.285-.066l-8.216-4-25.24 1.878a.641.641 0 01-.7-.6.652.652 0 01.6-.7l25.416-1.89a.639.639 0 01.333.064l8.375 4.076a.653.653 0 01-.287 1.24z",
            "data-name": "Path 25",
        ...
        React__default["default"].createElement(
          ...
          React__default["default"].createElement("path", {
            fill: "#fff",
            d:
              "M2539.158 282.581h-.009a.653.653 0 01-.643-.652v-.01l.881-59.58a.649.649 0 01.17-.417.65.65 0 01.146-.12.652.652 0 01.262-.088l58.151-7.3a.653.653 0 01.163 1.3l-57.6 7.228-.873 59.013a.653.653 0 01-.648.626z",
            "data-name": "Path 26",
            transform: "translate(-2538.506 -214.397)",
          })
        ),
        React__default["default"].createElement(
          "g",
          { "data-name": "Group 13", transform: "translate(21.548 23.762)" },
          React__default["default"].createElement("path", {
            fill: "#fff",
            d:
              "M2597.391 278.583h-.031l-26.114-1.263a.654.654 0 01-.621-.652v-26.2a.653.653 0 01.653-.653.652.652 0 01.652.653v25.574l25.373 1.227 7.111-2.3v-22.312a.653.653 0 111.305 0v22.793a.651.651 0 01-.452.621l-7.676 2.48a.661.661 0 01-.2.032z",
            "data-name": "Path 27",
        ...
        React__default["default"].createElement(
          ...
          React__default["default"].createElement("path", {
            fill: "#fff",
            d:
              "M2598.2 290.794a.573.573 0 01-.09-.006l-59.043-8.214a.652.652 0 11.18-1.292l58.636 8.157 10.08-15.188v-44.379l-10.294-14.443a.652.652 0 111.063-.757l10.417 14.612a.649.649 0 01.121.378v44.785a.649.649 0 01-.109.361l-10.417 15.692a.65.65 0 01-.544.294z",
            "data-name": "Path 28",
...
var SwButton = function (_a) {
  var label = _a.label,
    ...
    rest = __rest(_a, ["label", "className", "variant", "color"]);
  return React__namespace.createElement(
    CustomizedButton,
    __assign({}, rest, {
      variant: variant,
    ...
    React__namespace.createElement(
      "span",
      { style: { marginTop: "4px" }, className: "sw-btn-label" },
      label
    )
  );
};
...
function fileAccepted(file, accept) {
  var isAcceptable =
    file.type === "application/x-moz-file" || _default(file, accept);
  return [
    isAcceptable,
...
function useDropzone() {
  ...
  var openFileDialog = React.useCallback(
    function () {
      if (inputRef.current) {
        dispatch({
          type: "openDialog",
...
var SwUploadFile = function (_a) {
  var _b = _a.multiple,
    ...
    sx =
      _c === void 0
        ...
        : _c,
    _d = _a.initialPreviewUrl,
    initialPreviewUrl = _d === void 0 ? null : _d,
    _e = _a.fileChange,
    fileChange =
      _e === void 0
        ? function (file) {
        ...
        : _e;
  var _f = React.useState(initialPreviewUrl),
    preview = _f[0],
    setPreview = _f[1];
  var _g = useDropzone({
      multiple: multiple,
  ...
  var Action = function () {
    return React__default["default"].createElement(
      "div",
      { onClick: handleActionClick, className: "sw-upload-action" },
      preview
        ? React__default["default"].createElement(
            HighlightOffIcon__default["default"],
            { className: "remove" }
          )
        : React__default["default"].createElement(
            PhotoCameraIcon__default["default"],
            { className: "upload" }
          )
    );
  };
  return React__default["default"].createElement(
    "div",
    __assign({}, getRootProps({ className: "sw-uploader-wrapper", style: sx })),
    React__default["default"].createElement(material.Avatar, {
      alt: "Avatar",
      src: preview,
      imgProps: {
        style: {
...
CSSTransition.propTypes =
  process.env.NODE_ENV !== "production"
    ? _extends({}, Transition$1.propTypes, {
        /**
...
var SwAnimatedRoute = function (_a) {
  var exact = _a.exact,
    ...
    rest = __rest(_a, ["exact", "to", "sx", "component"]);
  return React__default["default"].createElement(
    reactRouterDom.Route,
    { exact: exact, key: to, path: to },
    function (_a) {
      var match = _a.match;
      return React__default["default"].createElement(
        CSSTransition$1,
...
var SwAnimatedComponent = function (_a) {
  var inMatch = _a.inMatch,
    sx = _a.sx,
    Component = _a.component,
    rest = __rest(_a, ["inMatch", "sx", "component"]);
  return React__default["default"].createElement(
    CSSTransition$1,
    {
      in: inMatch,
...
var SwDivider = function (_a) {
  var sx = _a.sx,
    _b = _a.width,
    width = _b === void 0 ? "4px" : _b,
    props = __rest(_a, ["sx", "width"]);
  ...
  return React__namespace.createElement(
    material.Divider,
    __assign({ className: "sw-divider", color: "white", sx: styles }, props)
  );
};
...
var SwQuote = function (_a) {
  var children = _a.children,
    mobileStartText = _a.mobileStartText,
    _b = _a.mobile,
    mobile = _b === void 0 ? false : _b;
  var _c = React__namespace.useState(null),
    anchorEl = _c[0],
    setAnchorEl = _c[1];
    ...
    mobile
      ? React__namespace.createElement(
          ...
          React__namespace.createElement(
            ...
            React__namespace.createElement(Quote, { children: children })
          )
        )
      : React__namespace.createElement(Quote, { children: children })
  );
...
var Quote = function (_a) {
  ...
  return React__namespace.createElement(
    ...
    React__namespace.createElement(
      material.Typography,
      { color: "text.primary", component: "div", variant: "subtitle1" },
      children
    )
  );
};
...
function CreateUnselSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      ...
      fillRule: "evenodd",
      d:
        "M36 18A18 18 0 1118 0a18 18 0 0118 18zM19.125 9a1.125 1.125 0 00-2.25 0v7.875H9a1.125 1.125 0 000 2.25h7.875V27a1.125 1.125 0 002.25 0v-7.875H27a1.125 1.125 0 000-2.25h-7.875z",
      "data-name": "Path 1592",
    })
  );
}
...
function DitoCreditsSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      fill: "url(#linear-gradient)",
      d:
        "M269.56 317.919v1.675c0 .569-1.517 1.043-3.382 1.043s-3.35-.458-3.35-1.027v-.19l-.032-1.327h.016c.253.49 1.644.869 3.319.869s3.4-.474 3.4-1.043h.032z",
      "data-name": "Path 179",
    ...
    React__default["default"].createElement("path", {
      fill: "url(#linear-gradient)",
      d:
        "M152.594 112.074v1.659h-.032c0 .585-1.564 1.043-3.414 1.043a8.11 8.11 0 01-2.133-.237l-.032.032a3.692 3.692 0 00-1.169-.648v-.032l-.047-1.754c.111.537 1.58.964 3.366.964s3.429-.458 3.429-1.027z",
      "data-name": "Path 180",
    ...
    React__default["default"].createElement("path", {
      fill: "url(#linear-gradient)",
      d:
        "M152.6 79.668c0 .569-1.565 1.027-3.429 1.027s-3.271-.427-3.382-.964c0-.016-.016-.047-.016-.063 0-.569 1.517-1.043 3.4-1.043 1.873-.016 3.427.458 3.427 1.043z",
      "data-name": "Path 181",
    ...
    React__default["default"].createElement("path", {
      fill: "url(#linear-gradient)",
      d:
        "M261.8 265.514l-.017-.369-.033-1.51c.117.571 1.67 1.024 3.556 1.024s3.556-.487 3.606-1.074h.017v1.746h-.029c0 .6-1.619 1.108-3.59 1.108s-3.242-.405-3.51-.925z",
      "data-name": "Path 182",
    ...
    React__default["default"].createElement("path", {
      fill: "url(#linear-gradient)",
      d:
        "M188.608 312.059a3.391 3.391 0 00.932-1.454h.079c.348.032.7.047 1.075.047h.158V311l.032 1.328h-.174a8.189 8.189 0 01-2.054-.221z",
      "data-name": "Path 183",
    ...
    React__default["default"].createElement("path", {
      fill: "url(#linear-gradient)",
      d:
        "M221.267 254.386v.079l.032 1.47h-.158c-.4 0-.759-.016-1.106-.047h-.079a3.244 3.244 0 00.158-1.027 3.2 3.2 0 00-.079-.68h.079c.332.032.664.047 1.027.047l.142.079a.172.172 0 00-.016.079z",
      "data-name": "Path 184",
    ...
    React__default["default"].createElement("path", {
      fill: "url(#linear-gradient)",
      d:
        "M186.029 167.737a8.11 8.11 0 002.133.237c1.849 0 3.414-.458 3.414-1.043h.032v1.869c-1.723 0-3.129.411-3.3.932l-.142-.079q-.522 0-1-.047h-.079a3.19 3.19 0 00-1.09-1.849z",
      "data-name": "Path 185",
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement("path", {
        d:
          "M6.748 168.585a3.459 3.459 0 00-1.122-1.885 3 3 0 00-1.2-.664 3.053 3.053 0 00-1-.158 3.4 3.4 0 10-.063 6.8 3.467 3.467 0 002.339-.9 3.432 3.432 0 00.948-1.5 3.147 3.147 0 00.158-1.011c.003-.223-.06-.46-.06-.682z",
        "data-name": "Path 186",
        transform: "translate(0 -165.883)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M268.531 229.608v.032c-.047.553-1.58 1.011-3.414 1.011s-3.255-.427-3.366-.964v-.079a.2.2 0 01.016-.095c.174-.522 1.58-.932 3.3-.932h.047c1.868 0 3.417.458 3.417 1.027z",
        "data-name": "Path 187",
    ...
    React__default["default"].createElement("path", {
      fill: "url(#linear-gradient)",
      d:
        "M76.374 197.735a.522.522 0 11.522-.522.316.316 0 10.632 0 1.166 1.166 0 00-.838-1.106v-.126a.316.316 0 10-.632 0v.126a1.1 1.1 0 00-.838 1.106 1.16 1.16 0 001.154 1.154.522.522 0 110 1.043.526.526 0 01-.522-.522.316.316 0 10-.632 0 1.152 1.152 0 00.838 1.112v.253a.316.316 0 00.632 0V200a1.14 1.14 0 00.774-1.438 1.152 1.152 0 00-1.09-.827z",
      "data-name": "Path 188",
...
function TokenomicsSvg$1(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement("path", {
        d:
          "M14.215 10.583c4.083 0 8.215-1.3 8.215-3.792S18.3 3 14.215 3 6 4.3 6 6.792s4.132 3.791 8.215 3.791z",
        "data-name": "Path 1469",
        transform: "translate(135.564 457.578)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M6 19.9c0 2.489 4.132 3.792 8.215 3.792s8.215-1.3 8.215-3.792V18c0 2.489-4.132 3.792-8.215 3.792S6 20.489 6 18z",
        "data-name": "Path 1471",
        transform: "translate(135.564 449.025)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M6 25.9c0 2.489 4.132 3.792 8.215 3.792s8.215-1.3 8.215-3.792V24c0 2.489-4.132 3.792-8.215 3.792S6 26.489 6 24z",
        "data-name": "Path 1472",
...
function CenterWhiteBarSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      "g",
      { fill: "#fff", "data-name": "Path 1488" },
      React__default["default"].createElement("path", {
        d: "M8.16 766.5H.5V.5h7.66v766z",
      }),
      React__default["default"].createElement("path", {
        fill: "#707070",
        d: "M1 1v765h6.66V1H1M0 0h8.66v767H0V0z",
      })
    )
  );
}
...
function ProjectsSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      fill: "url(#linear-gradient)",
      d:
        "M34.461 28.217V22.9a2.57 2.57 0 00-2.57-2.57h-10.28v-5.14h2.57a2.572 2.572 0 002.57-2.57V4.905a2.572 2.572 0 00-2.57-2.57h-7.71a2.572 2.572 0 00-2.57 2.57v7.71a2.572 2.572 0 002.57 2.57h2.57v5.14H8.76A2.57 2.57 0 006.19 22.9v5.323a5.14 5.14 0 102.57 0V22.9h10.28v5.323a5.14 5.14 0 102.57 0V22.9h10.28v5.322a5.14 5.14 0 102.57 0zM16.471 4.905h7.71v7.71h-7.71zm-6.425 28.27a2.57 2.57 0 11-2.57-2.57 2.57 2.57 0 012.569 2.571zm12.85 0a2.57 2.57 0 11-2.57-2.57 2.57 2.57 0 012.57 2.57zm10.28 2.57a2.57 2.57 0 112.57-2.57 2.57 2.57 0 01-2.57 2.571z",
...
function OpenGigsSelSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement("path", {
        d:
          "M7.245 24.652v-1.285H4.673v1.286a9 9 0 009 9h3.857v-2.572h-3.857a6.429 6.429 0 01-6.429-6.429z",
        "data-name": "Path 1564",
        transform: "translate(-2.102 -.224)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M28.979 13.673v1.286h2.571v-1.286a9 9 0 00-9-9h-3.857v2.572h3.857a6.429 6.429 0 016.429 6.429z",
        "data-name": "Path 1565",
        transform: "translate(-.693 -2.102)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M13.908 12.852H6.194a3.857 3.857 0 00-3.857 3.857v2.571h2.571v-2.571a1.286 1.286 0 011.286-1.286h7.714a1.286 1.286 0 011.286 1.286v2.571h2.571v-2.571a3.857 3.857 0 00-3.857-3.857z",
        "data-name": "Path 1566",
        transform: "translate(-2.337 -1.28)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M9.816 12.622A5.143 5.143 0 104.673 7.48a5.143 5.143 0 005.143 5.143zm0-7.714A2.571 2.571 0 117.245 7.48a2.571 2.571 0 012.571-2.572z",
        "data-name": "Path 1567",
        transform: "translate(-2.102 -2.337)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M32.6 29.208h-7.713a3.857 3.857 0 00-3.857 3.857v2.571h2.57v-2.571a1.286 1.286 0 011.286-1.286H32.6a1.286 1.286 0 011.286 1.286v2.571h2.571v-2.571a3.857 3.857 0 00-3.857-3.857z",
        "data-name": "Path 1568",
        transform: "translate(-.459 .363)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M23.367 23.836a5.143 5.143 0 105.143-5.143 5.143 5.143 0 00-5.143 5.143zm7.714 0a2.571 2.571 0 11-2.571-2.571 2.571 2.571 0 012.571 2.571z",
        "data-name": "Path 1569",
...
function TownhallNavSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      d:
        "M20.583 11.492a2.56 2.56 0 01-1.867-.861A3.328 3.328 0 0117.85 8.6a2.785 2.785 0 01.7-2.125 2.843 2.843 0 014.052 0 2.778 2.778 0 01.713 2.125 3.337 3.337 0 01-.867 2.033 2.553 2.553 0 01-1.865.859zm2.201-2.934z",
      "data-name": "Path 1496",
      transform: "translate(-9.917 -5.625)",
    }),
    React__default["default"].createElement("path", {
      d:
        "M22.1 25.05h-8.787a.923.923 0 01-.733-.356 1.007 1.007 0 01-.175-.859 4.394 4.394 0 012.011-2.7A6.626 6.626 0 0121 21.118a4.369 4.369 0 012.012 2.718 1.009 1.009 0 01-.177.859.923.923 0 01-.731.354z",
      "data-name": "Path 1497",
      transform: "translate(-7.041 -13.317)",
    }),
    React__default["default"].createElement("path", {
      d:
        "M7.777 12.808a2.507 2.507 0 01-2.3-2.431 2.35 2.35 0 01.6-1.787 2.371 2.371 0 013.4 0 2.333 2.333 0 01.6 1.784 2.505 2.505 0 01-2.3 2.43z",
      "data-name": "Path 1498",
      transform: "translate(-3.41 -6.808)",
    }),
    React__default["default"].createElement("path", {
      d:
        "M7.68 20.016a5.057 5.057 0 00-2.188-.43 5.157 5.157 0 00-2.686.721 3.618 3.618 0 00-1.653 2.223.913.913 0 00.16.779.844.844 0 00.669.325h3.7a.267.267 0 00.262-.219c0-.021.009-.042.014-.063a4.828 4.828 0 011.924-2.794.267.267 0 00-.021-.446c-.052-.031-.112-.063-.181-.1z",
      "data-name": "Path 1499",
...
function NotificationsSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      "g",
      { "data-name": "Group 336", transform: "translate(57)" },
      React__default["default"].createElement("path", {
        d:
          "M20.962 17.635a12.078 12.078 0 01-1.6-5.8V7.5A6.4 6.4 0 0013.038 1a6.4 6.4 0 00-6.323 6.5v4.33a11.87 11.87 0 01-1.6 5.8.4.4 0 000 .433.322.322 0 00.337.26h15.173a.44.44 0 00.375-.212.485.485 0 00-.038-.476z",
        "data-name": "Path 1032",
...
function SkillWalletNavSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      "g",
      { "data-name": "Group 1260", transform: "translate(-142.231 -344.268)" },
      React__default["default"].createElement("path", {
        d:
          "M53.95 74.665V68.1a1.641 1.641 0 011.642-1.642h7.577v-.819A1.636 1.636 0 0061.542 64h-11.85A1.662 1.662 0 0048 65.615v11.539a1.662 1.662 0 001.692 1.615h11.846a1.633 1.633 0 001.627-1.642v-.819h-7.577a1.641 1.641 0 01-1.638-1.642z",
        "data-name": "Path 1164",
        transform: "translate(94.231 280.268)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M245 170.615v5.38a.617.617 0 00.615.615h7.185a.617.617 0 00.615-.615v-5.38a.617.617 0 00-.615-.615h-7.186a.617.617 0 00-.614.615zm2.963 3.916a1.23 1.23 0 111.149-1.149 1.23 1.23 0 01-1.149 1.148z",
        "data-name": "Path 1165",
...
function FooterShareSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      "g",
      { transform: "translate(-8.243 155.5)" },
      React__default["default"].createElement("path", {
        d:
          "M31.167 15.167a5.333 5.333 0 10-5.292-4.676L13.537 16.66a5.333 5.333 0 100 7.679l12.338 6.169a5.333 5.333 0 101.592-3.18l-12.338-6.169a5.387 5.387 0 000-1.316l12.338-6.169a5.307 5.307 0 003.7 1.493z",
        "data-name": "Path 1494",
...
function LogoffSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      "g",
      { "data-name": "Group 26", transform: "translate(-1)" },
      React__default["default"].createElement("path", {
        d:
          "M192 163.208h5.184l-1.192 1.222.817.817 2.624-2.624L196.81 160l-.847.817 1.222 1.222H192z",
        "data-name": "Path 1077",
        transform: "translate(-182.434 -154.77)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M55.871 62.1a6.241 6.241 0 114.415-10.663l1.148-1.144a8.369 8.369 0 00-1.05-.876 7.849 7.849 0 101.046 12l-1.144-1.14a6.214 6.214 0 01-4.415 1.82zm7.287-6.209l-.032-.032.032-.032.032.032z",
        "data-name": "Path 1078",
...
function MilestonesCompletedSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      fill: "url(#linear-gradient)",
      d:
        "M0 0v21.5h21.5V7.6l-3.527 3.527v6.844H3.527V3.527h6.844L13.9 0zm18.454.272l-7.779 7.78L7.9 5.272 5.046 8.124l5.629 5.628 2.85-2.85 7.775-7.78-2.846-2.85z",
    })
  );
}
...
function MilestonesSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      fill: "url(#linear-gradient)",
      d:
        "M11.618 0A1.661 1.661 0 0010.1 1H8.159a1.658 1.658 0 00-3.041 0H3.18a1.66 1.66 0 100 1.328h1.938a1.658 1.658 0 003.041 0H10.1A1.659 1.659 0 1011.618 0z",
    })
  );
}
...
function ParticipationRateSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      "g",
      { fill: "url(#linear-gradient)", transform: "translate(-2.25 -2.25)" },
      React__default["default"].createElement("path", {
        d:
          "M3.893 22.5v1.643H7.66l-5.41 5.41 1.162 1.162 5.41-5.41v3.767h1.643V22.5z",
        "data-name": "Path 1580",
        transform: "translate(0 -5.464)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M27.071 4.5h-5.75v1.643h2.945l-6.231 6.231-3.526-3.527a.821.821 0 00-1.162 0L9 13.2l1.162 1.162 3.767-3.767 3.527 3.527a.821.821 0 001.162 0L25.429 7.3v2.95h1.643z",
        "data-name": "Path 1581",
...
function ScoreReachedSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement("path", {
        d:
          "M4.078 7.03a2.39 2.39 0 10-2.39-2.39 2.39 2.39 0 002.39 2.39zm0-3.585A1.195 1.195 0 112.883 4.64a1.195 1.195 0 011.195-1.195z",
        "data-name": "Path 1529",
        transform: "translate(-1.687 -2.25)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M15.89 2.25a2.39 2.39 0 102.39 2.39 2.39 2.39 0 00-2.39-2.39zm0 3.585a1.195 1.195 0 111.195-1.195 1.195 1.195 0 01-1.195 1.195z",
        "data-name": "Path 1530",
        transform: "translate(-9.251 -2.25)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M27.7 7.03a2.39 2.39 0 10-2.39-2.39 2.39 2.39 0 002.39 2.39zm0-3.585a1.195 1.195 0 11-1.192 1.195A1.195 1.195 0 0127.7 3.445z",
        "data-name": "Path 1531",
        transform: "translate(-16.814 -2.25)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M4.078 13.5a2.39 2.39 0 102.39 2.39 2.39 2.39 0 00-2.39-2.39zm0 3.585a1.195 1.195 0 111.195-1.195 1.195 1.195 0 01-1.195 1.195z",
        "data-name": "Path 1532",
        transform: "translate(-1.687 -7.525)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M15.89 13.5a2.39 2.39 0 102.39 2.39 2.39 2.39 0 00-2.39-2.39zm0 3.585a1.195 1.195 0 111.195-1.195 1.195 1.195 0 01-1.195 1.195z",
        "data-name": "Path 1533",
        transform: "translate(-9.251 -7.525)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M27.7 13.5a2.39 2.39 0 102.39 2.39 2.39 2.39 0 00-2.39-2.39zm0 3.585a1.195 1.195 0 111.2-1.195 1.195 1.195 0 01-1.2 1.195z",
        "data-name": "Path 1534",
        transform: "translate(-16.814 -7.525)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M27.7 24.75a2.39 2.39 0 102.39 2.39 2.39 2.39 0 00-2.39-2.39zm0 3.585a1.195 1.195 0 111.2-1.195 1.195 1.195 0 01-1.2 1.195z",
        "data-name": "Path 1535",
...
function Shape2Svg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      ...
      strokeWidth: "1",
      d:
        "M.469 60.764l233.79-59.759L64.42 148.894l88.592 50.688L238.459 2.674l55.948 189.156-227.948 22.348-65.99 179.1",
      "data-name": "Path 1590",
    })
  );
}
...
function Shape4Svg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      "g",
      { "data-name": "Group 1816", transform: "translate(.502 .383)" },
      React__default["default"].createElement(
        "g",
        {
          fill: "none",
        ...
        React__default["default"].createElement("path", {
          d: "M0 20.77h44L64.766.003",
          "data-name": "Path 12",
        }),
        React__default["default"].createElement("path", {
          d: "M0 65.251l21.322-21.322h43.336",
          "data-name": "Path 13",
        }),
        React__default["default"].createElement("path", {
          d: "M0 0L0 44.559",
      ...
      React__default["default"].createElement(
        ...
        React__default["default"].createElement("path", {
          d: "M0 20.77h44L64.767.003",
          "data-name": "Path 15",
        }),
        React__default["default"].createElement("path", {
          d: "M0 65.251l21.322-21.322h43.332",
          "data-name": "Path 16",
        }),
        React__default["default"].createElement("path", {
          d: "M0 0L0 44.559",
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement(
        ...
        React__default["default"].createElement("path", {
          d: "M73.28 63.037L62.29 79.224V0",
          "data-name": "Path 1-2",
        }),
        React__default["default"].createElement("path", {
          d: "M35.616 50.589V28.202",
          "data-name": "Path 1-2",
        }),
        React__default["default"].createElement("path", {
          d:
            "M62.291 79.224l10.99-16.187-10.99 16.187L50.284 54.04l8.1-2.617 14.9 11.614V15.416L62.294 0 49.552 23.076l.735 30.964",
          "data-name": "Path 1-2",
        }),
        React__default["default"].createElement("path", {
        ...
        React__default["default"].createElement("path", {
          d:
            "M58.388 50.589h-22.77V28.202l-12.879-3.131 12.879 3.131 22.769-.826v24.047l-19.175 6.285L.005 70.559",
          "data-name": "Path 1-2",
        }),
        React__default["default"].createElement("path", {
...
function Shape7Svg(_a) {
  ...
  return React__default["default"].createElement(
    "svg",
    {
      ...
      viewBox: "0 0 64.363 128.725",
    },
    React__default["default"].createElement("path", {
      fill: "#fff",
      d:
        "M3259.638 739.111v29.067a35.3 35.3 0 000 70.591v29.067a64.362 64.362 0 010-128.724z",
      "data-name": "Path 10",
      transform: "translate(-3195.276 -739.111)",
    })
  );
}
...
function DitoCreditsSuccessSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement("path", {
        d:
          "M292.678 317.919v7.4c0 2.513-6.7 4.608-14.941 4.608s-14.8-2.025-14.8-4.538v-.838l-.14-5.865h.07c1.117 2.164 7.261 3.84 14.661 3.84s15.011-2.094 15.011-4.608h.14z",
        "data-name": "Path 179",
        transform: "translate(-233.392 -289.596)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M175.928 112.074v7.326h-.14c0 2.583-6.912 4.608-15.08 4.608a35.831 35.831 0 01-9.425-1.047l-.14.14a16.313 16.313 0 00-5.166-2.862v-.14l-.209-7.75c.489 2.374 6.982 4.259 14.871 4.259s15.15-2.025 15.15-4.538z",
        "data-name": "Path 180",
        transform: "translate(-129.483 -107.604)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M175.929 83.234h0c0 2.513-6.912 4.538-15.15 4.538s-14.452-1.885-14.941-4.259c0-.07-.07-.209-.07-.279 0-2.513 6.7-4.608 15.011-4.608 8.308-.07 15.15 2.025 15.15 4.608z",
        "data-name": "Path 181",
        transform: "translate(-129.484 -78.624)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M261.942 270.946h0l-.064-1.408-.127-5.761c.446 2.177 6.368 3.9 13.564 3.9s13.564-1.856 13.755-4.1h.064v6.658h-.127c0 2.3-6.177 4.225-13.691 4.225s-12.355-1.53-13.374-3.514z",
        "data-name": "Path 182",
        transform: "translate(-229.847 -240.921)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M188.608 317.028a14.98 14.98 0 004.119-6.423h.349c1.536.14 3.072.209 4.748.209h.7v1.536l.14 5.865h-.768a36.177 36.177 0 01-9.076-.977z",
        "data-name": "Path 183",
        transform: "translate(-166.025 -283.259)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M225.75 255.089v.349l.14 6.493h-.7c-1.745 0-3.351-.07-4.887-.209h-.349a14.328 14.328 0 00.7-4.538 14.13 14.13 0 00-.349-3h.349c1.466.14 2.932.209 4.538.209l.628.349a.759.759 0 00-.07.347z",
        "data-name": "Path 184",
        transform: "translate(-193.405 -233.087)",
      }),
      React__default["default"].createElement("path", {
        d:
          "M186.137 170.492a35.831 35.831 0 009.425 1.047c8.168 0 15.08-2.025 15.08-4.608h.14v8.238c-7.61 0-13.824 1.815-14.592 4.119l-.628-.349q-2.3 0-4.4-.209h-.349a14.092 14.092 0 00-4.813-8.169z",
        "data-name": "Path 185",
        transform: "translate(-164.673 -156.494)",
      }),
      React__default["default"].createElement(
        "g",
        { "data-name": "Group 16", transform: "translate(0 8.006)" },
        React__default["default"].createElement("path", {
          d:
            "M29.812 177.822h0a15.281 15.281 0 00-4.957-8.308 13.267 13.267 0 00-5.306-2.932 13.487 13.487 0 00-4.4-.7 15.011 15.011 0 10-.279 30.021 15.314 15.314 0 0010.333-3.98 15.161 15.161 0 004.189-6.633 13.9 13.9 0 00.7-4.468c0-.975-.28-2.022-.28-3z",
          "data-name": "Path 186",
          transform: "translate(0 -165.883)",
        }),
        React__default["default"].createElement("path", {
          d:
            "M291.7 233.119v.14c-.209 2.444-6.982 4.468-15.08 4.468s-14.382-1.885-14.871-4.259v-.349a.886.886 0 01.07-.419c.768-2.3 6.982-4.119 14.592-4.119h.209c8.24 0 15.08 2.025 15.08 4.538z",
          "data-name": "Path 187",
          transform: "translate(-232.487 -220.202)",
        })
      ),
      React__default["default"].createElement("path", {
        d:
          "M80.319 204.811a2.3 2.3 0 112.3-2.3 1.4 1.4 0 002.793 0 5.153 5.153 0 00-3.7-4.887v-.559a1.4 1.4 0 10-2.793 0v.559a4.876 4.876 0 00-3.7 4.887 5.125 5.125 0 005.1 5.1 2.3 2.3 0 110 4.608h0a2.324 2.324 0 01-2.3-2.3 1.4 1.4 0 10-2.793 0 5.089 5.089 0 003.7 4.887v1.117a1.4 1.4 0 002.793 0v-1.117a5.035 5.035 0 003.421-6.353 5.091 5.091 0 00-4.821-3.642z",
        "data-name": "Path 188",
        transform: "translate(-66.216 -182.583)",
      })
    )
  );
}
...
var SwLogoSvg = function (_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      "g",
      { "data-name": "Group 12", transform: "translate(-90 -88)" },
      React__default["default"].createElement("circle", {
        cx: "180",
        cy: "180",
        r: "180",
      ...
      React__default["default"].createElement(
        "g",
        { "data-name": "Group 11", transform: "translate(-8.621 -6.967)" },
        React__default["default"].createElement("path", {
          d:
            "M228.563 277.684l-39.942-30.15v23.727s29.112 14.987 28.445 14.525 11.497-8.102 11.497-8.102z",
          fill: "url(#linear-gradient)",
          "data-name": "Path 35",
        ...
        React__default["default"].createElement("path", {
          d:
            "M228.563 278.68l-39.942 30.15V285.1s29.112-14.988 28.445-14.525 11.497 8.105 11.497 8.105z",
        ...
        React__default["default"].createElement("path", {
          d:
            "M251.444 185.017l35.9 76.3 84 44.184.146-24.127-69.59-31.913-26.476-63.861z",
...
function DitoLogoFullSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      "g",
      { "data-name": "Group 1818", transform: "translate(-2538.506 -214.397)" },
      React__default["default"].createElement(
        "g",
        { "data-name": "Group 12", transform: "translate(2538.913 214.804)" },
        React__default["default"].createElement(
          "g",
          { "data-name": "Path 1-2" },
          React__default["default"].createElement("path", {
...
var MainBackgroundSvg = function (_a) {
  ...
  return React__default["default"].createElement(
    "svg",
    {
      ...
      className: className,
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 1366.618 768.358",
    },
    React__default["default"].createElement(
      "g",
      { "data-name": "Group 1819", transform: "translate(21880.771 21782)" },
      React__default["default"].createElement("path", {
        fill: "#161615",
        d: "M0 0H1363.67V766.738H0z",
        "data-name": "Rectangle 1855",
        transform: "translate(-21878.143 -21782)",
      }),
      React__default["default"].createElement(
        "g",
        {
          "data-name": "Group 1816",
          transform: "translate(-21513.447 -21091.498)",
        },
        React__default["default"].createElement(
          "g",
          {
      ...
      React__default["default"].createElement(
        "g",
        {
          ...
          transform: "translate(-21857.961 -21519.049)",
        },
        React__default["default"].createElement("path", {
          d:
            "M2.884 5.764A2.884 2.884 0 100 2.881a2.884 2.884 0 002.884 2.883z",
          "data-name": "Path 2",
        }),
        React__default["default"].createElement("path", {
          d:
            "M2.884 40.255A2.884 2.884 0 100 37.372a2.884 2.884 0 002.884 2.883z",
          "data-name": "Path 3",
        }),
        React__default["default"].createElement("path", {
          d:
            "M2.884 74.743A2.883 2.883 0 100 71.86a2.884 2.884 0 002.884 2.883z",
          "data-name": "Path 4",
        }),
        React__default["default"].createElement("path", {
          d:
            "M2.884 109.231A2.883 2.883 0 100 106.348a2.884 2.884 0 002.884 2.883z",
          "data-name": "Path 5",
        }),
        React__default["default"].createElement("path", {
          d:
            "M2.884 143.719A2.884 2.884 0 100 140.835a2.884 2.884 0 002.884 2.884z",
          "data-name": "Path 6",
        }),
        React__default["default"].createElement("path", {
          d:
            "M27.798 74.743a2.883 2.883 0 10-2.883-2.883 2.883 2.883 0 002.883 2.883z",
          "data-name": "Path 7",
        }),
        React__default["default"].createElement("path", {
          d:
            "M27.798 109.231a2.883 2.883 0 10-2.883-2.883 2.883 2.883 0 002.883 2.883z",
          "data-name": "Path 8",
        }),
        React__default["default"].createElement("path", {
          d:
            "M27.798 143.719a2.884 2.884 0 10-2.883-2.884 2.884 2.884 0 002.883 2.884z",
          "data-name": "Path 9",
        })
      ),
      React__default["default"].createElement("path", {
        ...
        strokeMiterlimit: "10",
        strokeWidth: "1",
        d: "M-21876.9-21642.878l234.052 261.7v219.94l-189.365 145.976",
        "data-name": "Path 1589",
      }),
      React__default["default"].createElement("path", {
        fill: "none",
        ...
        strokeWidth: "1",
        d:
          "M-21875.65-21418.275l233.79-59.759-169.839 147.889 88.592 50.688 85.447-196.908 55.948 189.156-227.948 22.348-65.99 179.1",
        "data-name": "Path 1590",
      }),
      React__default["default"].createElement("path", {
        fill: "none",
        ...
        d: "M64.999 0L0 48.245",
        "data-name": "Line 51",
        transform: "translate(-21880.473 -21288.629)",
      }),
      React__default["default"].createElement(
        "g",
        {
          ...
          strokeWidth: "1",
          "data-name": "Group 1817",
          transform: "translate(-21289.793 -21188.834)",
        },
        React__default["default"].createElement(
          "g",
          { "data-name": "Group 9" },
      ...
      React__default["default"].createElement(
        ...
        {
          "data-name": "Group 1815",
          transform: "translate(-20578.834 -21375.16)",
        },
        React__default["default"].createElement("path", {
          fill: "#fff",
          d:
      ...
      React__default["default"].createElement("path", {
        ...
        strokeMiterlimit: "10",
        strokeWidth: "1",
        d: "M-20514.474-21113.377l-146.653-122.855-226.8 222.232",
        "data-name": "Path 1591",
      })
    )
  );
...
function ArchitectureSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      d:
        "M21.213 6.822l-8.161-3.766a.628.628 0 00-.527 0L4.364 6.822A.628.628 0 004 7.393v10.672a.628.628 0 00.364.571l8.161 3.764a.628.628 0 00.527 0l8.161-3.767a.628.628 0 00.364-.571V7.393a.628.628 0 00-.364-.571zm-8.424-2.5l6.66 3.076-6.66 3.076-6.661-3.081zM5.256 8.373l6.905 3.189v9.291l-6.905-3.19zm8.161 12.48v-9.291l6.905-3.189v9.291z",
...
function BlockchainSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      d:
        "M10.433 8.953l-5.215 3.186L0 8.953 5.218 0zm-5.215 4.209L0 9.976l5.218 7.6 5.218-7.6-5.218 3.186z",
...
function DefiSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      d:
        "M22.183 6H9v2.2l7.141 6.591L9 21.38v2.2h13.183v-3.3h-7.69l5.493-5.493L14.493 9.3h7.69z",
...
function FrontendSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      fillRule: "evenodd",
      d:
        "M0 2.2A2.2 2.2 0 012.2 0h8.789a2.2 2.2 0 012.2 2.2v2.2h2.2a2.2 2.2 0 012.2 2.2v8.78a2.2 2.2 0 01-2.2 2.2H6.591a2.2 2.2 0 01-2.2-2.2v-2.2H2.2a2.2 2.2 0 01-2.2-2.2zm5.493 10.983v2.2a1.1 1.1 0 001.1 1.1h8.787a1.1 1.1 0 001.1-1.1V6.591a1.1 1.1 0 00-1.1-1.1h-2.2v5.493a2.2 2.2 0 01-2.2 2.2z",
      "data-name": "Path 1468",
    })
  );
}
...
function ManagementSvg(_a) {
  ...
  return React__default["default"].createElement(
    "svg",
    {
      ...
      width: height,
      height: width,
      viewBox: "0 0 26.746 23.402",
    },
    React__default["default"].createElement("path", {
      id: "Icon_awesome-briefcase",
      "data-name": "Icon awesome-briefcase",
      d:
        "M16.716,18.13a.836.836,0,0,1-.836.836H10.865a.836.836,0,0,1-.836-.836V15.623H0v7.522a2.571,2.571,0,0,0,2.507,2.507H24.238a2.571,2.571,0,0,0,2.507-2.507V15.623H16.716ZM24.238,7.265H20.059V4.757A2.571,2.571,0,0,0,17.552,2.25H9.194A2.571,2.571,0,0,0,6.686,4.757V7.265H2.507A2.571,2.571,0,0,0,0,9.772v4.179H26.746V9.772A2.571,2.571,0,0,0,24.238,7.265Zm-7.522,0H10.03V5.593h6.686Z",
...
function MobileSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      d:
        "M11.62 0H2.051A2.051 2.051 0 000 2.051v17.771a2.051 2.051 0 002.051 2.051h9.569a2.051 2.051 0 002.051-2.051V2.051A2.051 2.051 0 0011.62 0zM6.835 20.506A1.367 1.367 0 118.2 19.139a1.366 1.366 0 01-1.365 1.367zm4.785-4.614a.514.514 0 01-.513.513H2.563a.514.514 0 01-.513-.513V2.563a.514.514 0 01.513-.513h8.544a.514.514 0 01.513.513z",
...
function WebDevSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      d:
        "M20.595 0H1.872A1.873 1.873 0 000 1.872v12.482a1.873 1.873 0 001.872 1.872h7.489L8.737 18.1H5.929a.936.936 0 100 1.872h10.609a.936.936 0 000-1.872H13.73l-.624-1.872h7.489a1.873 1.873 0 001.872-1.872V1.872A1.873 1.873 0 0020.595 0zm-.624 13.73H2.5V2.5h17.471z",
...
function PhotographySvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      d:
        "M7.6 4.445L6.865 7.4H0v14.622h23.341V7.4H16.8l-.735-2.953zm4.13 2.947a6.564 6.564 0 11-6.564 6.564 6.563 6.563 0 016.564-6.564zm7.7 1.429h3.309v1.921h-3.312V8.821zm-7.7.51a4.625 4.625 0 104.625 4.625 4.625 4.625 0 00-4.625-4.625z",
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement("path", {
        ...
        strokeWidth: "2.25",
        d:
          "M13.3 15.542V1.014A1.009 1.009 0 0012.3 0H.998a1.009 1.009 0 00-1 1.014v14.873a1.681 1.681 0 001.663 1.69h13.634",
        "data-name": "Path 1479",
      }),
      React__default["default"].createElement("path", {
        fill: "none",
        ...
        strokeWidth: "2.25",
        d:
          "M15.295 17.576h0a2.282 2.282 0 01-2.282-2.282V1.605h3.425a1.141 1.141 0 011.141 1.141v12.549a2.282 2.282 0 01-2.282 2.282z",
        "data-name": "Path 1480",
      }),
      React__default["default"].createElement("path", {
        fill: "none",
      ...
      React__default["default"].createElement("path", {
        ...
        strokeLinejoin: "round",
        strokeWidth: "2.25",
        d: "M2.414 13.774h9.125",
        "data-name": "Path 1485",
      }),
      React__default["default"].createElement("path", {
        d:
          "M10.553 12.438H7.511a.761.761 0 01-.761-.761V8.636a.761.761 0 01.761-.761h3.042a.761.761 0 01.761.761v3.042a.761.761 0 01-.761.76z",
        "data-name": "Path 1486",
        transform: "translate(-4.468 -5.272)",
      })
    )
  );
}
...
function TokenomicsSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      d:
        "M14.789 11.112c4.368 0 8.789-1.393 8.789-4.056S19.156 3 14.789 3 6 4.393 6 7.056s4.421 4.056 8.789 4.056z",
      "data-name": "Path 1469",
      transform: "translate(-6 -3)",
    }),
    React__default["default"].createElement("path", {
      d:
        "M6 20.028c0 2.663 4.421 4.056 8.789 4.056s8.789-1.393 8.789-4.056V18c0 2.663-4.421 4.056-8.789 4.056S6 20.663 6 18z",
      "data-name": "Path 1471",
      transform: "translate(-6 -11.104)",
    }),
    React__default["default"].createElement("path", {
      d:
        "M6 26.028c0 2.663 4.421 4.056 8.789 4.056s8.789-1.393 8.789-4.056V24c0 2.663-4.421 4.056-8.789 4.056S6 26.663 6 24z",
      "data-name": "Path 1472",
...
function TrainSportSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      d:
        "M23.622 16.409l-2.107-2.985-10.037 6.963 2.107 2.982-2.007 1.393-5.62-7.955 2.007-1.392 2.107 2.985 10.036-6.962L18 8.453l2.007-1.392 5.621 7.953-2.007 1.393z",
      "data-name": "Path 1475",
...
function VideoSvg(_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement("path", {
      fillRule: "evenodd",
      d:
        "M3.255 6.75v1.628h6.51v.814H2.441A2.441 2.441 0 000 11.633v4.883a2.441 2.441 0 002.441 2.441h9.765a2.441 2.441 0 002.433-2.239l4.891.612v-6.51l-4.891.611a2.441 2.441 0 00-2.433-2.239h-.814V7.564a.814.814 0 00-.814-.814zm11.393 6.32v2.008l3.255.407v-2.822zm-1.628-1.437a.814.814 0 00-.814-.814H2.441a.814.814 0 00-.814.814v4.883a.814.814 0 00.814.814h9.765a.814.814 0 00.814-.814z",
      "data-name": "Path 1473",
