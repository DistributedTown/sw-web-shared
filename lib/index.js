...
var SwMainLayout = function (_a) {
    ...
    var _f = React.useState(false), collapsed = _f[0], onCollapsed = _f[1];
    return (React__default["default"].createElement(antd.Layout, { className: "sw-main-layout" },
        React__default["default"].createElement(Sider, { className: "sw-main-sidebar", collapsible: true, collapsed: collapsed, onCollapse: function () { return onCollapsed(!collapsed); } },
