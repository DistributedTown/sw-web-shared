...
var SwUploadFile = function (_a) {
    var _b = _a.multiple, multiple = _b === void 0 ? false : _b, _c = _a.sx, sx = _c === void 0 ? {
        width: "120px",
        height: "120px",
    } : _c, _d = _a.mode, mode = _d === void 0 ? "light" : _d, _e = _a.initialPreviewUrl, initialPreviewUrl = _e === void 0 ? null : _e, _f = _a.fileChange, fileChange = _f === void 0 ? function (file) { return null; } : _f, _g = _a.defaulUploadIcon, defaulUploadIcon = _g === void 0 ? React__default["default"].createElement(DefaultUploadSvg, null) : _g;
    var _h = React.useState(initialPreviewUrl), preview = _h[0], setPreview = _h[1];
    var _j = useDropzone({
        multiple: multiple,
        disabled: !!preview,
    ...
    , __assign$2({ 
        ...
        React__default["default"].createElement(material.Avatar, { alt: "Avatar", src: preview, imgProps: {
                style: {
                    maxHeight: "100%",
                    maxWidth: "100%",
                    objectFit: "cover",
...
var SwThumbComponent = function (value) {
    return function (props) {
        ...
        return (React__namespace.createElement(material.SliderThumb, __assign$2({}, other),
            children,
            React__namespace.createElement(material.Typography, { className: "sw-thumb-value", component: "span", variant: "subtitle2" }, value || 0)));
    };
};
...
function SwClipboardCopy(_a) {
    ...
    return (React__default["default"].createElement(CopyWrapper, { className: "copy-wrapper ".concat(mode), onClick: handleCopyClick },
        React__default["default"].createElement(material.Typography, { variant: "h4", color: "info.dark", component: "span" }, url),
