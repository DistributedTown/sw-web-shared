...
var UploadWrapper = material.styled("div")(function (_a) {
    var theme = _a.theme;
...
var SwUploadFile = function (_a) {
    ...
    var _f = React.useState(initialPreviewUrl), preview = _f[0], setPreview = _f[1];
    var _g = useDropzone({
        multiple: multiple,
        disabled: !!preview,
    ...
    return (React__default["default"].createElement(UploadWrapper, __assign$2({}, getRootProps({ className: "sw-uploader-wrapper", style: sx })),
        React__default["default"].createElement(material.Avatar, { alt: "Avatar", src: preview, imgProps: {
            ...
            React__default["default"].createElement(DefaultUploadSvg, null)),
