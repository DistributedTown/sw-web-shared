...
var css_248z$b = ".sw-main-box .sw-layout-top {\n  align-items: center;\n  justify-content: flex-end;\n  padding: 0 20px;\n  position: relative;\n  height: 50px; }\n";
...
var SwScrollbar = function (_a) {
    ...
    return (React__namespace.createElement(SimpleBar, __assign({ forceVisible: "y", className: className, style: __assign({ height: '100%', width: '100%' }, (sx || {})) }, rest)));
};
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        React__default["default"].createElement(CustomizedLayout, { sx: {
            ...
            React__default["default"].createElement(Box__default["default"], { component: "main", sx: {
                ...
                React__default["default"].createElement(SwScrollbar, { sx: __assign({ height: '100%' }, (scrollbarStyles || {})) },
...
var SwSidebar = function (_a) {
    ...
    return (React__default["default"].createElement(material.Drawer, { anchor: "left", sx: __assign(__assign({ width: !mobile ? width : '100%', transition: theme.transitions.create("width", {
            ...
            _b))), { flexShrink: 0, '& .MuiDrawer-paper': __assign(__assign({ transition: theme.transitions.create("width", {
                    easing: theme.transitions.easing.sharp,
                    duration: theme.transitions.duration.leavingScreen,
...
var SwButton = function (_a) {
    var _b = _a.label, label = _b === void 0 ? null : _b, _c = _a.children, children = _c === void 0 ? null : _c, _d = _a.className, className = _d === void 0 ? "" : _d, _e = _a.variant, variant = _e === void 0 ? "contained" : _e, _f = _a.color, color = _f === void 0 ? "primary" : _f, rest = __rest(_a, ["label", "children", "className", "variant", "color"]);
...
var SwUploadFile = function (_a) {
    ...
    return (React__default["default"].createElement("div", __assign({}, getRootProps({ className: 'sw-uploader-wrapper', style: sx })),
...
var SwAnimatedRoute = function (_a) {
    ...
    return (React__default["default"].createElement(reactRouterDom.Route, { exact: exact, key: to, path: to }, function (_a) {
        ...
        return (React__default["default"].createElement(CSSTransition$1, { key: to, in: match != null, timeout: { enter: 800, exit: 400 }, classNames: "sw-animated-slide", unmountOnExit: true },
            React__default["default"].createElement("div", { className: "sw-animated-page", style: __assign({ height: "100%" }, (sx || {})) },
                React__default["default"].createElement(Component, __assign({}, rest)))));
    }));
};
...
var css_248z$3 = "@media screen and (max-width: 959px) {\n  .sw-divider.MuiDivider-vertical {\n    margin-left: 28px;\n    margin-right: 28px; }\n  .sw-divider:not(.MuiDivider-vertical) {\n    margin-top: 28px;\n    margin-bottom: 28px; } }\n\n@media screen and (max-width: 599px) {\n  .sw-divider.MuiDivider-vertical {\n    margin-left: 10px;\n    margin-right: 10px; }\n  .sw-divider:not(.MuiDivider-vertical) {\n    margin-top: 10px;\n    margin-bottom: 10px; } }\n";
styleInject(css_248z$3);

var SwDivider = function (_a) {
    var sx = _a.sx, _b = _a.width, width = _b === void 0 ? '1px' : _b, props = __rest(_a, ["sx", "width"]);
    var styles = __assign({}, (sx || {}));
    if (props.orientation !== "vertical") {
        styles = __assign(__assign({}, styles), { width: "100%", height: width, marginTop: "56px", marginBottom: "56px" });
    }
    else {
        styles = __assign(__assign({}, styles), { height: "100%", width: width, marginLeft: "56px", marginRight: "56px" });
    }
    return (React__namespace.createElement(material.Divider, __assign({ className: "sw-divider", color: "white", sx: styles }, props)));
};

var css_248z$2 = ".quote {\n  padding: 20px; }\n  .quote.show-border {\n    border: 3px solid white;\n    background: #0D0D0B; }\n";
...
var SwThumbComponent = function (value) {
    return function (props) {
        ...
        return (React__namespace.createElement(material.SliderThumb, __assign({}, other),
            children,
...
var SwSlider = function (_a) {
    var className = _a.className, _b = _a.mode, mode = _b === void 0 ? 'black' : _b, rest = __rest(_a, ["className", "mode"]);
    var _c = React__namespace.useState(rest.defaultValue), value = _c[0], setValue = _c[1];
    return (React__namespace.createElement(CustomizedSlider, __assign({}, rest, { onChange: function (_, v) { return setValue(v); }, components: { Thumb: SwThumbComponent(value) }, className: "sw-slider " + className + " mode-" + mode })));
};
...
function DitoCreditsSvg(_a) {
    ...
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: __assign({ height: height, width: width }, (sx || {})), className: className, "data-name": "Group 17", viewBox: "0 0 167.785 114.465" },
...
var SwProgressBar = function (_a) {
    var percentage = _a.percentage; _a.className; var _c = _a.variant, variant = _c === void 0 ? "determinate" : _c, rest = __rest(_a, ["percentage", "className", "variant"]);
    return (React__default["default"].createElement("div", { className: "sw-progress-bar" },
        React__default["default"].createElement(NoBorderLinearProgress, __assign({}, rest, { variant: variant, value: percentage })),
