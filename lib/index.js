...
var css_248z$9 = ".sw-main-box .sw-layout-top {\n  align-items: center;\n  justify-content: flex-end;\n  padding: 0 20px; }\n";
...
var SwSidebar = function (_a) {
    ...
    return (React__default["default"].createElement(material.Drawer, { anchor: "left", sx: __assign(__assign({ width: !mobile ? width : '100%', transition: theme.transitions.create("width", {
        ...
        mobile && (React__default["default"].createElement(Tooltip__default["default"], { title: "Close sidebar", placement: "right", color: "white" },
            React__default["default"].createElement(material.IconButton, { className: "sw-sidebar-close-button", color: "secondary", onClick: handleToggle },
        ...
        !mobile && React__default["default"].createElement(DrawerFooter, null,
            React__default["default"].createElement(Tooltip__default["default"], { title: !open ? 'Open' : "Close", placement: "right" },
                React__default["default"].createElement(material.IconButton, { color: "secondary", onClick: handleToggle }, !open ? React__default["default"].createElement(ChevronRightIcon__default["default"], null) : React__default["default"].createElement(ChevronLeftIcon__default["default"], null))))));
};
...
var SwQuote = function (_a) {
    ...
    return (React__namespace.createElement(material.Box, { className: "sw-box-quote" }, mobile ? (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement(material.Typography, { "aria-owns": open ? "mouse-over-popover" : undefined, "aria-haspopup": "true", onMouseEnter: handlePopoverOpen, onMouseLeave: handlePopoverClose, color: "text.primary", component: "div", variant: "subtitle1" }, mobileStartText),
...
var Quote = function (_a) {
    ...
    return (React__namespace.createElement("div", { className: "quote" },
        React__namespace.createElement(material.Typography, { color: "text.primary", component: "div", variant: "subtitle1" }, children)));
};
...
var SwProgressBar = function (_a) {
    var percentage = _a.percentage; _a.className; var _c = _a.variant, variant = _c === void 0 ? "determined" : _c; __rest(_a, ["percentage", "className", "variant"]);
    return (React__default["default"].createElement("div", { className: "sw-progress-bar" },
        React__default["default"].createElement(NoBorderLinearProgress, { variant: variant, value: percentage }),
        React__default["default"].createElement(material.Typography, { className: "sw-progress-bar-label", sx: { color: "secondary.main", textAlign: "center" }, component: "span", variant: "body2" },
            percentage,
            "%")));
};
